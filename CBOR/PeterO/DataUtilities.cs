...
namespace PeterO {
  ...
  public static class DataUtilities {
    ...
    /// <exception cref='System.ArgumentException'>The string is not valid
    /// UTF-8 and <paramref name='replace'/> is false.</exception>
    ...
    /// <exception cref='System.ArgumentNullException'>The parameter
    /// <paramref name='bytes'/> is null.</exception>
    /// <exception cref='System.ArgumentException'>The portion of the byte
    /// array is not valid UTF-8 and <paramref name='replace'/> is
    /// false.</exception>
    ...
    /// <exception cref='System.ArgumentNullException'>The parameter
    /// <paramref name='str'/> is null.</exception>
    /// <exception cref='System.ArgumentException'>The string contains an
