...
namespace PeterO {
 ...
 throw new ArgumentException("Unpaired surrogate code point");
    ...
    /// <summary>Writes a portion of a string in UTF-8 encoding to a data stream.</summary><param name='str'>A string to write.
    ...
    /// plus
    /// <paramref name='length'/>
    /// is greater than the string's length.</exception><exception cref='System.IO.IOException'>An I/O error occurred.</exception>
