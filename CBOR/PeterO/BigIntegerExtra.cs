...
namespace PeterO {
    /// <xmlbegin id="5"/><summary><para><b>This class is largely obsolete. It will be replaced by a new version
  ...
  public sealed partial class BigInteger {
    /// <summary>Gets the arbitrary-precision integer for zero.</summary><value>The arbitrary-precision integer for zero.
    /// </value>
...
"\u0020of this class's ToString method.")]
    ...
    /// <summary>Gets the arbitrary-precision integer for one.</summary><value>The arbitrary-precision integer for one.
    /// </value>
    [CLSCompliant(false)] [Obsolete(
  "Use EInteger from PeterO.Numbers/com.upokecenter.numbers and the output" +
"\u0020of this class's ToString method.")]
    ...
    /// <summary>Returns whether this number's value equals another number's value.</summary><param name='other'>An arbitrary-precision integer.
    /// </param><returns><c>true
    /// </c>
    /// if this number's value equals another number's value; otherwise,
    /// <c>false
    /// </c>
    /// .
    /// </returns>
