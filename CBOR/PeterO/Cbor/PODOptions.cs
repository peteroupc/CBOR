...
namespace PeterO.Cbor {
  ...
  ///
    ...
    ///
  /// <summary>Initializes a new instance of the <see cref='T:PeterO.Cbor.PODOptions'/> class.
  /// </summary>
  ///
  ...
  /// </para>
  /// </summary><value><c>true</c> If the names are converted to camel case; otherwise,
