...
namespace PeterO.Cbor {
  internal sealed class CBORJson {
    ...
    private CBORObject NextJSONNegativeNumber(
      ...
      // Console.WriteLine("--nega=" + sw.ElapsedMilliseconds + " ms");
      ...
      // Console.WriteLine("negb=" + sw.ElapsedMilliseconds + " ms");
      obj = CBORDataUtilities.ParseJSONNumber(str, this.options);
      // Console.WriteLine("str=" + str + " obj=" + (obj));
      // Console.WriteLine("negc=" + sw.ElapsedMilliseconds + " ms");
      if (obj == null) {
