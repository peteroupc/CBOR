...
namespace PeterO.Cbor {
  ...
  public sealed partial class CBORObject {
    ...
    ///   path='docs/doc[@name="M:PeterO.Cbor.CBORObject.op_LessThan(PeterO.Cbor.CBORObject,PeterO.Cbor.CBORObject)"]/*'/>
    public static bool operator <(CBORObject a, CBORObject b) {
      return a == null ? b != null : a.CompareTo(b) < 0;
    }

    /// <include file='../../docs.xml'
    ///   path='docs/doc[@name="M:PeterO.Cbor.CBORObject.op_LessThanOrEqual(PeterO.Cbor.CBORObject,PeterO.Cbor.CBORObject)"]/*'/>
    public static bool operator <=(CBORObject a, CBORObject b) {
      return a == null || a.CompareTo(b) <= 0;
    }

    /// <include file='../../docs.xml'
    ///   path='docs/doc[@name="M:PeterO.Cbor.CBORObject.op_GreaterThan(PeterO.Cbor.CBORObject,PeterO.Cbor.CBORObject)"]/*'/>
    public static bool operator >(CBORObject a, CBORObject b) {
      return a != null && a.CompareTo(b) > 0;
    }

    /// <include file='../../docs.xml'
    ///   path='docs/doc[@name="M:PeterO.Cbor.CBORObject.op_GreaterThanOrEqual(PeterO.Cbor.CBORObject,PeterO.Cbor.CBORObject)"]/*'/>
    public static bool operator >=(CBORObject a, CBORObject b) {
      return a == null ? b == null : a.CompareTo(b) >= 0;
    }
