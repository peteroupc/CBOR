...
if (majorType > 7) {
 ...
 return (decimal)extendedNumber;
    ...
    /// truncated to an integer.</summary><returns>The closest big integer to this object.
    /// </returns><exception cref='System.InvalidOperationException'>This object does not represent a number (for this purpose, infinities and not-a-number or NaN values, but not CBORObject.Null, are considered numbers).</exception><exception cref='System.OverflowException'>This object's value exceeds the range of a 64-bit unsigned integer.</exception>
    [CLSCompliant(false)]
    public ulong AsUInt64() {
      ...
      if (bigint.Sign < 0 ||
bigint.GetSignedBitLengthAsEInteger().CompareTo(64) > 0) {
        throw new OverflowException("This object's value is out of range");
      }
      return (ulong)bigint;
    }
    ...
    /// <c>String
    /// </c>
    /// ) or a plain-old-data type (POCO type) within the control of the
