...
namespace PeterO.Cbor {
  ...
  public sealed class CBORTypeMapper {
    ...
    /// <paramref name='converter'/>
    /// is null.
    /// </exception><exception cref='System.ArgumentException'>Converter doesn't contain a proper ToCBORObject method".
    /// </exception>
    ...
    /// <c>true</c> if the given Java or.NET type name fits the filters given in this mapper,
    /// or
    /// <c>false</c> otherwise.
    /// </returns>
