...
namespace PeterO.Cbor {
  ...
  ///
   ...
   ///
  /// <summary>Initializes a new instance of the <see cref='T:PeterO.Cbor.CBOREncodeOptions'/> class.
  /// </summary>
  ///
   ...
   ///
  /// <summary>Initializes a new instance of the <see cref='T:PeterO.Cbor.CBOREncodeOptions'/> class.
  /// </summary><param name='useIndefLengthStrings'>A value indicating whether to always encode strings with a definite-length
  /// encoding.
  ...
  bool allowDuplicateKeys) :
   ...
   ///
  /// <summary>Initializes a new instance of the <see cref='T:PeterO.Cbor.CBOREncodeOptions'/> class.
  /// </summary><param name='useIndefLengthStrings'>A value indicating whether to encode strings with a definite-length
  ...
  /// objects from a data stream.
  /// </param><param name='ctap2Canonical'>A value indicating whether CBOR objects are written out using the CTAP2
  ...
  /// </summary><value>A value indicating whether to encode strings with an indefinite-length
  ...
  /// </summary><value>A value indicating whether to allow duplicate keys when reading CBOR
  ...
  /// </summary><value><c>true</c> if CBOR objects are written out using the CTAP2 canonical CBOR encoding
  /// form; otherwise,
  /// <c>false</c> .
  /// </value>
  ///
