...
#pragma warning disable CS0618
    ...
    /// <summary>Initializes a new instance of the
    /// <see cref='PeterO.Cbor.JSONOptions'/>
    /// class.</summary>
    ...
    /// parameter:
    /// <c>base64padding=false;replacesurrogates=true</c> . The key can be any one of the following in any combination of case:
    /// <c>base64padding</c> ,
    /// <c>replacesurrogates</c> . Other keys are ignored. If the same key appears more than once, the
    /// value given for the last such key is used. The two keys just given can
    /// have a value of
    /// <c>1</c> ,
    /// <c>true</c> ,
    /// <c>yes</c> , or
    ...
    /// <c>base64padding=Yes</c> and
    /// <c>base64padding=1</c> both set the
    /// <c>Base64Padding</c> property to true.
    /// </param>
