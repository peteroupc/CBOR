...
namespace PeterO.Cbor {
  /// <summary>Exception thrown for errors involving CBOR data.<para>This library
  ///may throw exceptions of this type in certain cases, notably when errors
  ///occur, and may supply messages to those exceptions (accessible through the
  ///<c>Message</c> property in.NET or the <c>getMessage()</c> method in Java).
  ///These messages are intended to be read by humans to help diagnose the error
  ///(or other cause of the exception); they are not intended to be parsed by
  ///computer programs, and the exact text of the messages may change at any time
  ///between versions of this library.</para></summary>
#if NET20 || NET40
[Serializable]
#endif
