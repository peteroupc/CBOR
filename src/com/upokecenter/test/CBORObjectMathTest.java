...
import com.upokecenter.util.*;
  ...
  public class CBORObjectMathTest{
    ...
    public void CBORMultiplyTest() {
      ...
      try { CBORObject.Multiply(CBORObject.FromObject(Double.NaN), CBORObject.FromObject(BigInteger.fromString("-11455275312320262539482205058"))).AsDecimalFraction(); Assert.fail("Should have failed");} catch(ArithmeticException ex) { } catch (Exception ex) { Assert.fail(ex.toString()); }
      ...
      try { CBORObject.Multiply(CBORObject.FromObject(Double.POSITIVE_INFINITY), CBORObject.FromObject(BigInteger.fromString("0694747557297"))).AsDecimalFraction(); Assert.fail("Should have failed");} catch(ArithmeticException ex) { } catch (Exception ex) { Assert.fail(ex.toString()); }
      ...
      try { CBORObject.Multiply(CBORObject.FromObject(Double.NEGATIVE_INFINITY), CBORObject.FromObject(3.0601084310878607E-15d)).AsDecimalFraction(); Assert.fail("Should have failed");} catch(ArithmeticException ex) { } catch (Exception ex) { Assert.fail(ex.toString()); }
      try { CBORObject.Multiply(CBORObject.FromObject(Double.NEGATIVE_INFINITY), CBORObject.FromObject(2.82955689133123E-11d)).AsDecimalFraction(); Assert.fail("Should have failed");} catch(ArithmeticException ex) { } catch (Exception ex) { Assert.fail(ex.toString()); }
      try { CBORObject.Multiply(CBORObject.FromObject(Double.NEGATIVE_INFINITY), CBORObject.FromObject(0.027867362f)).AsDecimalFraction(); Assert.fail("Should have failed");} catch(ArithmeticException ex) { } catch (Exception ex) { Assert.fail(ex.toString()); }
      try { CBORObject.Multiply(CBORObject.FromObject(Float.NaN), CBORObject.FromObject(-3351188881870481154L)).AsDecimalFraction(); Assert.fail("Should have failed");} catch(ArithmeticException ex) { } catch (Exception ex) { Assert.fail(ex.toString()); }
      try { CBORObject.Multiply(CBORObject.FromObject(Float.NaN), CBORObject.FromObject(DecimalFraction.FromString("-289"))).AsDecimalFraction(); Assert.fail("Should have failed");} catch(ArithmeticException ex) { } catch (Exception ex) { Assert.fail(ex.toString()); }
      try { CBORObject.Multiply(CBORObject.FromObject(Float.NaN), CBORObject.FromObject(DecimalFraction.FromString("-734789"))).AsDecimalFraction(); Assert.fail("Should have failed");} catch(ArithmeticException ex) { } catch (Exception ex) { Assert.fail(ex.toString()); }
      try { CBORObject.Multiply(CBORObject.FromObject(Float.NaN), CBORObject.FromObject(7000734143326731874L)).AsDecimalFraction(); Assert.fail("Should have failed");} catch(ArithmeticException ex) { } catch (Exception ex) { Assert.fail(ex.toString()); }
      try { CBORObject.Multiply(CBORObject.FromObject(Float.NaN), CBORObject.FromObject(-3716023503170226149L)).AsDecimalFraction(); Assert.fail("Should have failed");} catch(ArithmeticException ex) { } catch (Exception ex) { Assert.fail(ex.toString()); }
      try { CBORObject.Multiply(CBORObject.FromObject(Float.POSITIVE_INFINITY), CBORObject.FromObject(1.5166079335666195E-13d)).AsDecimalFraction(); Assert.fail("Should have failed");} catch(ArithmeticException ex) { } catch (Exception ex) { Assert.fail(ex.toString()); }
      ...
      try { CBORObject.Multiply(CBORObject.FromObject(Float.POSITIVE_INFINITY), CBORObject.FromObject(BigInteger.fromString("-57698063111489"))).AsDecimalFraction(); Assert.fail("Should have failed");} catch(ArithmeticException ex) { } catch (Exception ex) { Assert.fail(ex.toString()); }
      ...
      try { CBORObject.Multiply(CBORObject.FromObject(Float.NEGATIVE_INFINITY), CBORObject.FromObject(BigInteger.fromString("6741304989218497671449227825882685277187"))).AsDecimalFraction(); Assert.fail("Should have failed");} catch(ArithmeticException ex) { } catch (Exception ex) { Assert.fail(ex.toString()); }
      try { CBORObject.Multiply(CBORObject.FromObject(Float.NEGATIVE_INFINITY), CBORObject.FromObject(BigInteger.fromString("16890648775547279842225596545"))).AsDecimalFraction(); Assert.fail("Should have failed");} catch(ArithmeticException ex) { } catch (Exception ex) { Assert.fail(ex.toString()); }
