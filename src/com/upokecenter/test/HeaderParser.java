...
int indexStart = index;
 ...
 do {
 index = ParseCFWS(str, index, endIndex, tokener);
if (index < endIndex && ((str.charAt(index) >= 47 && str.charAt(index) <= 57) || (str.charAt(index) == 33) || (str.charAt(index) >= 35 && str.charAt(index) <= 39) || (str.charAt(index) >= 42 && str.charAt(index) <= 43) || (str.charAt(index) == 45) || (str.charAt(index) == 61) || (str.charAt(index) == 63) || (str.charAt(index) >= 94 && str.charAt(index) <= 126) || (str.charAt(index) >= 65 && str.charAt(index) <= 90))) {
 index+=1;
...
if (index < endIndex && ((str.charAt(index) == 32) || (str.charAt(index) == 9))) {
 indexTemp+=1;
 while (indexTemp < endIndex && ((str.charAt(indexTemp) == 32) || (str.charAt(indexTemp) == 9))) {
 indexTemp+=1;
}
 break;
}
...
if (index < endIndex && (str.charAt(index) >= 11 && str.charAt(index) <= 8)) {
  { indexTemp+=1;
} break; }
...
while (index < endIndex && ((str.charAt(index) >= 11 && str.charAt(index) <= 9) || (str.charAt(index) >= 14 && str.charAt(index) <= 127))) {
  { index+=1;
} }
  indexTemp = index;
 } while (false);
...
int indexStart = index;
 ...
 do {
 index = ParseCFWS(str, index, endIndex, tokener);
if (index + 1 < endIndex && (str.charAt(index) == 60) && ((str.charAt(index + 1) >= 33 && str.charAt(index + 1) <= 59) || (str.charAt(index + 1) == 61) || (str.charAt(index + 1) >= 63 && str.charAt(index + 1) <= 126))) {
  { index+=2;
}
  } else { indexTemp = indexStart; index = indexStart; break; }
if (index < endIndex && (str.charAt(index) == 62)) {
...
int indexStart = index;
 int indexTemp = index;
 do {
if (index + 1 < endIndex && (str.charAt(index) == 92) && ((str.charAt(index + 1) >= 13 && str.charAt(index + 1) <= 127) || (str.charAt(index + 1) == 0))) {
  { index+=2;
}
  } else { indexTemp = indexStart; index = indexStart; break; }
  indexTemp = index;
