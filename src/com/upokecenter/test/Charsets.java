...
private Charsets() {
    ...
    public static final ICharset Ascii = new AsciiEncoding();
    public static final ICharset Utf8 = new Utf8Encoding();
    ...
    /**
     * Not documented yet.
     * @param transform A Message.ITransform object.
      ...
      public String GetString(Message.ITransform transform) {
        ...
        while (true) {
          ...
          if (b < 0x80) {
            ...
            builder.append((char)this.map.get(b & 0x7f));
          }
        }
        return builder.toString();
      }
