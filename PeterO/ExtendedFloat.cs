...
namespace PeterO {
  ...
  ArgumentException("Diagnostic information must be 0 or greater, was: " +
    ...
    /// 32-bit or 64-bit floating point number (float or double). <para>The
    /// format of the string generally consists of:</para>
    /// <list
    ...
    /// digit.</item>
    /// <item>Optionally, E+ (positive exponent) or E-
    /// (negative exponent) plus one or more digits specifying the
    /// exponent.</item>
    /// </list>
    /// <para>The string can also be "-INF" ,
    /// "-Infinity" , "Infinity" , "INF", quiet NaN ("qNaN") followed by
    /// any number of digits, or signaling NaN ("sNaN") followed by any
    ...
    /// part. The format of the return value follows the format of the
