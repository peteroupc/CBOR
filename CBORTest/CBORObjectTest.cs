...
("allowduplicatekeys=false");
        ...
        {
            PODOptions valueCcTF = new(true, false);
            PODOptions valueCcFF = new(false, false);
            PODOptions valueCcFT = new(false, true);
            PODOptions valueCcTT = new(true, true);
            CBORObjectTest.CheckPropertyNames(
              ao,
              valueCcTF,
              "PropA",
        ...
        public void TestEncodeFloat64()
        {
            try
            {
                ...
                CBOREncodeOptions options = new("float64=true");
...
#pragma warning restore CA1034
        ...
        0xff, 0xe8,
            ...
            JSONOptions options = new("base64padding=1");
            o = ToObjectTest.TestToFromObjectRoundTrip(new byte[] {
        0x9a, 0xd6,
        0xff, 0xe8,
      });
        ...
        public void TestRead()
        {
            ...
            try
            {
                using DelayingStream ms2 = new(new byte[] { 0 });
                try
                {
        ...
        public void TestReadJSON()
        {
            try
            {
                using (DelayingStream ms2 = new(new byte[] { 0x30 }))
                {
                    try
                    {
                ...
                using (DelayingStream ms = new(new byte[] {
          0xef, 0xbb,
          0xbf, 0x7b, 0x7d,
        }))
                {
                ...
                using (DelayingStream ms2 = new(new byte[] {
          0x20, 0xef,
          0xbb, 0xbf, 0x7b, 0x7d,
        }))
                {
                ...
                using (DelayingStream ms2a = new(new byte[] {
          0x7b, 0x05,
          0x7d,
        }))
                {
                ...
                using (DelayingStream ms2b = new(new byte[] {
          0x05, 0x7b,
          0x7d,
        }))
                {
                ...
                // two BOMs
                using (DelayingStream ms3 = new(new byte[] {
          0xef, 0xbb,
          0xbf, 0xef, 0xbb, 0xbf, 0x7b, 0x7d,
                ...
                using (DelayingStream msjson = new(new byte[] {
          0, 0, 0xfe,
          0xff, 0,
          0,
          0,
          ...
          0xdc, 0x22, 0,
                ...
                using (DelayingStream msjson = new(new byte[] { 0xfc }))
                {
                    try
                    {
                        CBORObject.ReadJSON(msjson);
                ...
                using (DelayingStream msjson = new(new byte[] { 0, 0 }))
                {
                    try
                    {
                        CBORObject.ReadJSON(msjson);
        ...
        {
            using DelayingStream msjson = new(msbytes);
            try
            {
                CBORObject.ReadJSON(msjson);
                Assert.Fail("Should have failed");
        ...
        {
            CBORObject o;
            JSONOptions options = new(string.Empty);
            o = CBORObject.FromObjectAndTag(
        ...
        public void TestWriteExtra()
        {
          ...
          int.MaxValue,
                ...
                CBORObject cbor = null;
                {
                    ...
                    CBORObject cborTemp2 =
                      ToObjectTest.TestToFromObjectRoundTrip(cbor);
                    TestCommon.CompareTestEqualAndConsistent(cborTemp1, cborTemp2);
                    try
                    {
                ...
                object aobj = null;
                {
                    ...
                    CBORObject cborTemp2 =
                      ToObjectTest.TestToFromObjectRoundTrip(aobj);
                    TestCommon.CompareTestEqualAndConsistent(cborTemp1, cborTemp2);
                    try
                    {
        ...
        public void TestWriteValue()
        {
            try
            {
                ...
                try
                {
                    CBORObject.WriteValue(ms, 7, int.MaxValue);
                    Assert.Fail("Should have failed");
                }
                catch (ArgumentException)
                {
                ...
                try
                {
                    CBORObject.WriteValue(ms, 7, long.MaxValue);
                    Assert.Fail("Should have failed");
                }
                catch (ArgumentException)
                {
                ...
                for (int i = 0; i <= 7; ++i)
                {
                    ...
                    try
                    {
                        CBORObject.WriteValue(ms, i, int.MinValue);
                        Assert.Fail("Should have failed");
                    }
                    catch (ArgumentException)
                    {
                    ...
                    try
                    {
                        CBORObject.WriteValue(ms, i, long.MinValue);
                        Assert.Fail("Should have failed");
                    }
                    catch (ArgumentException)
                    {
                ...
                for (int i = 0; i <= 6; ++i)
                {
                    try
                    {
                        CBORObject.WriteValue(ms, i, int.MaxValue);
                    }
                    catch (Exception ex)
                    {
                        Assert.Fail(ex.ToString());
                    ...
                    try
                    {
                        CBORObject.WriteValue(ms, i, long.MaxValue);
                    }
                    catch (Exception ex)
                    {
                        Assert.Fail(ex.ToString());
        ...
        public void TestKeepKeyOrder()
        {
            ...
            CBORObject cbor;
            List<CBORObject> list = new();
            CBOREncodeOptions options = new("keepkeyorder=true");
            ...
            // JSON
            JSONOptions joptions = new("keepkeyorder=true");
        ...
        public static void TestDateTimeTag1One(string str, EInteger ei)
        {
            ...
            DateTime dtx = (DateTime)cbornum.ToObject(typeof(DateTime));
            ToObjectTest.TestToFromObjectRoundTrip(dtx);
            cbornum = CBORObject.FromObjectAndTag(ei, 1);
            DateTime dtx2 = (DateTime)cbornum.ToObject(typeof(DateTime));
        ...
        public static void AssertJSONDouble(
          ...
          double dbl)
        {
            JSONOptions opt = new("numberconversion=" + numconv);
            CBORObject[] cbors = {
        ...
        {
            JSONOptions op = new("numberconversion=double");
            Assert.AreEqual(
        ...
        {
            JSONOptions jsonop = new("numberconversion=full");
        ...
        {
            JSONOptions jsonop = new("numberconversion=intorfloatfromdouble");
            string manysevens = TestCommon.Repeat("7", 1000000);
        ...
        {
            JSONOptions jsonop = new("numberconversion=intorfloat");
        ...
        {
            {
                CBOREncodeOptions options = new("allowduplicatekeys=1;keepkeyorder=1");
                byte[] bytes = new byte[] {
  ...
  0xda,
  0xb6,
  0xda, 0x50, 0x56, 0x1a, 0x50,
  0xe3, 0x2c, 0x7a, 0x16,
  0xfa, 0x50, 0x32, 0x73, 0x07,
  0xfa, 0xb9, 0x2d, 0x73, 0xce, 0x38, 0xd0,
};
  ...
  0x9f,
  0xbf, 0x39, 0x20,
  0x8f, 0x4a, 0x1f, 0x46, 0x26, 0x0b, 0x3e, 0x72, 0x2c, 0x7f, 0x11,
  0x2e, 0x39,
  0x9d,
  0xba, 0x1a, 0x11,
  0x8d,
  ...
  0xd8, 0x3b,
  0x99, 0x00, 0x02, 0x3b, 0x05,
  0xbb,
  0xea,
  0x8e, 0x4b,
  0xd3, 0x5e, 0x22,
  0x9f, 0x59, 0x00, 0x00,
  0xbb, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x01, 0x41, 0x20,
  0xbf, 0x1a, 0x00, 0x00, 0x00, 0x61,
  0xb9, 0x00, 0x01, 0x1a, 0x00, 0x00, 0x00, 0x0e,
  ...
  0xb9, 0x00, 0x02, 0x39,
  0xee,
  0xa0, 0xa0, 0x1a, 0x0e, 0xd9, 0xec, 0xca,
  0xf2,
};
                CBORTestCommon.AssertRoundTrip(CBORObject.DecodeFromBytes(bytes, options));
            }
  ...
  0xf3,
  0xcf,
  0xb7, 0xf8, 0x76, 0x18, 0xda, 0x39, 0x60, 0xf4,
  0xff,
};
                CBORTestCommon.AssertRoundTrip(CBORObject.DecodeFromBytes(bytes, options));
            }
  ...
  0xb5, 0x72,
  0xcf,
  0xf8, 0x31, 0x3b, 0x06, 0x78,
  0xdb, 0x44, 0x7d, 0xba, 0xbd, 0x7d, 0x39, 0x98,
  0xb9,
};
                CBORTestCommon.AssertRoundTrip(CBORObject.DecodeFromBytes(bytes, options));
            }
            {
                CBOREncodeOptions options = new("allowduplicatekeys=1");
                byte[] bytes = new byte[] {
  0xbf, 0x0d,
  0xdb, 0x7f, 0x53,
  0xd5, 0x1e,
  ...
  0xb2,
  0xc2,
  0xb8, 0x02, 0x7f, 0x7a, 0x00, 0x00, 0x00, 0x09,
  0xf0,
  0xb8,
  0xbf,
  0xbf, 0x00,
  ...
  0x84,
  0xa1,
  0xff, 0x1a, 0x00, 0x46, 0x31,
  0xdf, 0x7f, 0x69, 0x05, 0x47, 0x76, 0x4f, 0x01,
  0xf4,
  0x80,
  0x80,
  0x80, 0xff, 0x3a, 0x0a, 0xaa, 0xf2, 0x00,
  0xff,
};
                CBORTestCommon.AssertRoundTrip(CBORObject.DecodeFromBytes(bytes, options));
            }
  ...
  0xa1,
  0xae, 0x1c,
  0xff, 0x17, 0x7f, 0x69, 0x05, 0x47, 0x76, 0x4f, 0x01,
  0xec,
  0x90,
  0xb2, 0x0a, 0xff, 0xfa, 0x12, 0x49, 0x20, 0x61,
  0xff,
};
                CBORTestCommon.AssertRoundTrip(CBORObject.DecodeFromBytes(bytes, options));
            }
  ...
  0x80,
  0xf8,
  0xc4, 0x7f, 0x67, 0x73, 0x2b, 0x51, 0x31, 0x5d, 0x26, 0x67,
  0xff, 0x5f, 0x5b, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x08,
  0xc7,
  0xb9, 0x6b,
  0xb0,
  0xb6,
  0xbe, 0x6d,
  0x9e, 0x41, 0x34, 0x5a, 0x00, 0x00, 0x00, 0x02,
  0xc4, 0x4a,
  0xff, 0x67,
  0xe1,
  0x99,
  0x92,
  0xf0,
  0xb5, 0xa4, 0xa2, 0x3a, 0x77, 0x11, 0x4c, 0x6f,
  0xff,
};
                CBORTestCommon.AssertRoundTrip(CBORObject.DecodeFromBytes(bytes, options));
            }
  ...
  0xbf,
  0xf8, 0x25,
  0xfb, 0x01, 0x54, 0x4a, 0x78, 0x13,
  0xff, 0x12,
  0x91,
  0xff,
  0xbf, 0x78, 0x04, 0x7a, 0x43, 0x30, 0x04, 0x41, 0x55, 0x7f, 0x7a,
  0x00, 0x00, 0x00, 0x03,
  0xda,
  0xb3, 0x64, 0x7b, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x01, 0x58,
  0xff, 0x39, 0xa2, 0x48, 0xff, 0xff,
};
                CBORTestCommon.AssertRoundTrip(CBORObject.DecodeFromBytes(bytes, options));
            }
            {
  ...
  0x96, 0x10,
  0x9b, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x01,
  0xbf, 0x6f, 0x22, 0x65, 0x65,
  0xf1,
  0x86,
  0x9d,
  0xad, 0x22, 0x42,
  0xc5,
  0xb1, 0x62, 0x58, 0x01, 0x5e,
  0xda, 0x47, 0x47,
  0x87,
  0x94,
  0xed, 0x7f, 0x6c,
  ...
  0x9c,
  0xbc,
  0x96, 0x2f, 0x47, 0x7c, 0x00, 0x50, 0x67, 0x67, 0x10, 0x78, 0x03,
  0xc3,
  0x90, 0x17,
  0xff, 0x19,
  0xd2,
  0xe7,
  0x99, 0x00, 0x01, 0x1b, 0x2a, 0x6e, 0x6f, 0x67, 0x4b, 0x18, 0x60,
  0x51, 0x1b, 0x46,
  0x9f, 0xd3, 0xb7, 0xf4, 0x74, 0xad, 0x6c,
  0xff,
};
                CBORTestCommon.AssertRoundTrip(CBORObject.DecodeFromBytes(bytes, options));
            }
  ...
  0x99, 0x00, 0x01,
  0xb9, 0x00, 0x01,
  0xbf, 0x7f, 0x61, 0x5d, 0x7a, 0x00, 0x00, 0x00, 0x06, 0x00, 0x00,
  0x20, 0x5a, 0x66, 0x1c, 0x7a, 0x00, 0x00, 0x00, 0x02, 0x7d, 0x7f, 0x60,
  0x78, 0x01, 0x43,
  0xff, 0x1a,
  0xca, 0x5c,
  0x83, 0x47, 0x7f, 0x79, 0x00, 0x0a,
  0xcc,
  0x88, 0x00, 0x73, 0x5f, 0x00, 0x26, 0x08, 0x72, 0x60,
  0xff, 0x00,
  0xff, 0x1b,
  0xbb, 0x19, 0xbf, 0x9f, 0x55, 0xee, 0x56, 0x09,
};
                CBORTestCommon.AssertRoundTrip(CBORObject.DecodeFromBytes(bytes, options));
            }
        }
  ...
  0xb2,
  0xc2,
  0xa2, 0x69, 0x05, 0x47, 0x76, 0x4f, 0x01,
  0xf4,
  0x80,
  0x80,
  0x80, 0x3a, 0x0a,
  ...
  0xbf,
  0xbf, 0x00,
  0xf0, 0x9d, 0x84, 0xa1, 0x1a, 0x00, 0x46, 0x31,
  0xdf,
};
  ...
  0x84,
  0xa1,
  0xff, 0, 0x7f, 0x69, 0x05, 0x47, 0x76, 0x4f, 0x01,
  0xf4,
  0x80,
  0x80,
  0x80, 0xff, 0,
