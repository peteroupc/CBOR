...
int indexStart = index;
 ...
 do {
 index = ParseCFWS(str, index, endIndex, tokener);
if (index < endIndex && ((str[index] >= 47 && str[index] <= 57) || (str[index] == 33) || (str[index] >= 35 && str[index] <= 39) || (str[index] >= 42 && str[index] <= 43) || (str[index] == 45) || (str[index] == 61) || (str[index] == 63) || (str[index] >= 94 && str[index] <= 126) || (str[index] >= 65 && str[index] <= 90))) {
 index+=1;
 while (index < endIndex && ((str[index] >= 47 && str[index] <= 57) || (str[index] == 33) || (str[index] >= 35 && str[index] <= 39) || (str[index] >= 42 && str[index] <= 43) || (str[index] == 45) || (str[index] == 61) || (str[index] == 63) || (str[index] >= 94 && str[index] <= 126) || (str[index] >= 65 && str[index] <= 90))) {
 index+=1;
}
} else { indexTemp = indexStart; index = indexStart; break; }
 index = ParseCFWS(str, index, endIndex, tokener);
...
if (index < endIndex && ((str[index] == 32) || (str[index] == 9))) {
 indexTemp+=1;
 while (indexTemp < endIndex && ((str[indexTemp] == 32) || (str[indexTemp] == 9))) {
 indexTemp+=1;
}
 break;
}
...
if (index < endIndex && (str[index] >= 11 && str[index] <= 8)) {
  { indexTemp+=1;
} break; }
...
for (int i2 = 0;; ++i2) {
  ...
  if (indexTemp3 == index) {
  { if (i2< 1) { indexTemp2 = indexStart2;
} } break; }
}
...
int indexStart = index;
 ...
 do {
 index = ParseCFWS(str, index, endIndex, tokener);
if (index < endIndex && ((str[index] == 33) || (str[index] >= 35 && str[index] <= 36) || (str[index] >= 42 && str[index] <= 43) || (str[index] >= 45 && str[index] <= 46) || (str[index] >= 65 && str[index] <= 90) || (str[index] >= 48 && str[index] <= 57) || (str[index] >= 94 && str[index] <= 126) || (str[index] >= 38 && str[index] <= 39) || (str[index] == 63))) {
 index+=1;
 while (index < endIndex && ((str[index] == 33) || (str[index] >= 35 && str[index] <= 36) || (str[index] >= 42 && str[index] <= 43) || (str[index] >= 45 && str[index] <= 46) || (str[index] >= 65 && str[index] <= 90) || (str[index] >= 48 && str[index] <= 57) || (str[index] >= 94 && str[index] <= 126) || (str[index] >= 38 && str[index] <= 39) || (str[index] == 63))) {
 index+=1;
}
} else { indexTemp = indexStart; index = indexStart; break; }
 while (true) {
...
while (index < endIndex && ((str[index] >= 11 && str[index] <= 9) || (str[index] >= 14 && str[index] <= 127))) {
  { index+=1;
} }
  indexTemp = index;
 } while (false);
...
int indexStart = index;
 ...
 do {
 index = ParseCFWS(str, index, endIndex, tokener);
if (index + 1 < endIndex && (str[index] == 60) && ((str[index + 1] >= 33 && str[index + 1] <= 59) || (str[index + 1] == 61) || (str[index + 1] >= 63 && str[index + 1] <= 126))) {
  { index+=2;
}
  } else { indexTemp = indexStart; index = indexStart; break; }
if (index < endIndex && (str[index] == 62)) {
...
int indexStart = index;
 int indexTemp = index;
 do {
if (index + 1 < endIndex && (str[index] == 92) && ((str[index + 1] >= 13 && str[index + 1] <= 127) || (str[index + 1] == 0))) {
  { index+=2;
}
  } else { indexTemp = indexStart; index = indexStart; break; }
  indexTemp = index;
...
if (index < endIndex && ((str[index] == 33) || (str[index] >= 35 && str[index] <= 36) || (str[index] >= 42 && str[index] <= 43) || (str[index] >= 45 && str[index] <= 46) || (str[index] >= 65 && str[index] <= 90) || (str[index] >= 48 && str[index] <= 57) || (str[index] >= 94 && str[index] <= 126) || (str[index] >= 38 && str[index] <= 39) || (str[index] == 63))) {
 indexTemp+=1;
 while (indexTemp < endIndex && ((str[indexTemp] == 33) || (str[indexTemp] >= 35 && str[indexTemp] <= 36) || (str[indexTemp] >= 42 && str[indexTemp] <= 43) || (str[indexTemp] >= 45 && str[indexTemp] <= 46) || (str[indexTemp] >= 65 && str[indexTemp] <= 90) || (str[indexTemp] >= 48 && str[indexTemp] <= 57) || (str[indexTemp] >= 94 && str[indexTemp] <= 126) || (str[indexTemp] >= 38 && str[indexTemp] <= 39) || (str[indexTemp] == 63))) {
 indexTemp+=1;
}
 break;
}
