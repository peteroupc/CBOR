...
[TestMethod]
    public void TestJSON() {
      ...
      try { CBORObject.FromJSONString("[\"\\d800\"]"); Assert.Fail("Should have failed");} catch (CBORException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }
      try { CBORObject.FromJSONString("[1,2,"); Assert.Fail("Should have failed");} catch (CBORException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }
      try { CBORObject.FromJSONString("[1,2,3"); Assert.Fail("Should have failed");} catch (CBORException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }
      try { CBORObject.FromJSONString("[\""); Assert.Fail("Should have failed");} catch (CBORException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }
      Assert.AreEqual(3, o.Count);
      Assert.AreEqual(1, o[0].AsInt32());
      Assert.AreEqual(2, o[1].AsInt32());
      Assert.AreEqual(3, o[2].AsInt32());
...
[TestMethod]
    public void TestDecFracOverflow() {
      ...
      try { CBORObject.FromObject(Single.NegativeInfinity).AsDecimalFraction(); Assert.Fail("Should have failed");} catch (OverflowException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }
      try { CBORObject.FromObject(Single.NaN).AsDecimalFraction(); Assert.Fail("Should have failed");} catch (OverflowException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }
      try { CBORObject.FromObject(Double.PositiveInfinity).AsDecimalFraction(); Assert.Fail("Should have failed");} catch (OverflowException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }
      try { CBORObject.FromObject(Double.NegativeInfinity).AsDecimalFraction(); Assert.Fail("Should have failed");} catch (OverflowException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }
      try { CBORObject.FromObject(Double.NaN).AsDecimalFraction(); Assert.Fail("Should have failed");} catch (OverflowException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }
      ...
      try { CBORObject.FromObject(Double.PositiveInfinity).AsBigFloat(); Assert.Fail("Should have failed");} catch (OverflowException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }
      try { CBORObject.FromObject(Double.NegativeInfinity).AsBigFloat(); Assert.Fail("Should have failed");} catch (OverflowException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }
      try { CBORObject.FromObject(Double.NaN).AsBigFloat(); Assert.Fail("Should have failed");} catch (OverflowException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }
    }
    /// <summary>
    /// </summary>
    /// <returns>
...
[TestMethod]
    public void TestFPToBigInteger() {
      ...
      try { CBORObject.FromObject(Single.PositiveInfinity).AsBigInteger(); Assert.Fail("Should have failed");} catch (OverflowException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }
      try { CBORObject.FromObject(Single.NegativeInfinity).AsBigInteger(); Assert.Fail("Should have failed");} catch (OverflowException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }
      try { CBORObject.FromObject(Single.NaN).AsBigInteger(); Assert.Fail("Should have failed");} catch (OverflowException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }
      try { CBORObject.FromObject(Double.PositiveInfinity).AsBigInteger(); Assert.Fail("Should have failed");} catch (OverflowException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }
      try { CBORObject.FromObject(Double.NegativeInfinity).AsBigInteger(); Assert.Fail("Should have failed");} catch (OverflowException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }
      try { CBORObject.FromObject(Double.NaN).AsBigInteger(); Assert.Fail("Should have failed");} catch (OverflowException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }
    }
    /// <summary>
    /// </summary>
    /// <returns>
...
public void TestDivideScale() {
  Assert.AreEqual("1E+45", DecimalFraction.FromString("-45291999767448722989E-135").Divide(DecimalFraction.FromString("-1435346506662653"), 45, new PrecisionContext(Rounding.Ceiling)).ToString());
  Assert.AreEqual("-.076124690795650590453618512277403496502", DecimalFraction.FromString("-269865389E+321").Divide(DecimalFraction.FromString("1795738"), -39, new PrecisionContext(Rounding.Floor)).ToString());

  Assert.AreEqual("-1E-30", DecimalFraction.FromString("1007112E-22").Divide(DecimalFraction.FromString("-39490310826.6932439729E+298"), -30, new PrecisionContext(Rounding.Up)).ToString());

  Assert.AreEqual("0E+11", DecimalFraction.FromString("7386483598E-224").Divide(DecimalFraction.FromString("-4390352444753"), 11, new PrecisionContext(Rounding.Down)).ToString());

  {
    ...
    Assert.AreEqual(PrecisionContext.FlagInexact, ctx.Flags & PrecisionContext.FlagInexact);
  }
  Assert.AreEqual("-1E+18", DecimalFraction.FromString("-26669453070149435").Divide(DecimalFraction.FromString("49339084389861E+265"), 18, new PrecisionContext(Rounding.Floor)).ToString());

  Assert.AreEqual("7.103E-34", DecimalFraction.FromString("-4542243282240.41931057893769451").Divide(DecimalFraction.FromString("-639555.15865952707790717004E+40"), -37, new PrecisionContext(Rounding.Ceiling)).ToString());

  Assert.AreEqual("0E-7", DecimalFraction.FromString("3935634526184971598.078256150").Divide(DecimalFraction.FromString("5407243E+288"), -7, new PrecisionContext(Rounding.HalfDown)).ToString());

  Assert.AreEqual("-1E+15", DecimalFraction.FromString("1128").Divide(DecimalFraction.FromString("-30527367869582.751781E+324"), 15, new PrecisionContext(Rounding.Floor)).ToString());
  Assert.AreEqual("0E-651", DecimalFraction.FromString("-78113790E-328").DivideToIntegerNaturalScale(DecimalFraction.FromString("74436533544.0E+324"), new PrecisionContext(46, Rounding.Unnecessary)).ToString());

  try { DecimalFraction.FromString("-302463158127322.6E-305").Divide(DecimalFraction.FromString("630126062.01930394"), null); Assert.Fail("Should have failed"); } catch (ArithmeticException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }

  Assert.AreEqual("0E-182", DecimalFraction.FromString("-188259486952195939E-182").DivideToIntegerNaturalScale(DecimalFraction.FromString("-9"), new PrecisionContext(25, Rounding.Unnecessary)).ToString());

  try { DecimalFraction.FromString("-24589685066381400E+338").Divide(DecimalFraction.FromString("-32578992751974430297E-32"), null); Assert.Fail("Should have failed"); } catch (ArithmeticException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }

  try { DecimalFraction.FromString("-951929522728411654E-144").Divide(DecimalFraction.FromString("707733291E-139"), null); Assert.Fail("Should have failed"); } catch (ArithmeticException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }

  Assert.AreEqual("2.4664674706811481948269592838078885E+149", DecimalFraction.FromString("31214454569707094E-197").Divide(DecimalFraction.FromString("126555306083.508987740853746E-341"), new PrecisionContext(35, Rounding.HalfDown)).ToString());

  Assert.AreEqual("1E+31", DecimalFraction.FromString("-80619811028609627942.659E-58").Divide(DecimalFraction.FromString("-2192167.6569230012206"), 31, new PrecisionContext(Rounding.Ceiling)).ToString());

  Assert.AreEqual("0E+10", DecimalFraction.FromString("939.15203").DivideToIntegerNaturalScale(DecimalFraction.FromString("2385531592.188194898747647"), new PrecisionContext(44, Rounding.Unnecessary)).ToString());

  try { DecimalFraction.FromString("181.257221710870584E+273").DivideToIntegerNaturalScale(DecimalFraction.FromString("-518114882"), new PrecisionContext(26, Rounding.Unnecessary)); Assert.Fail("Should have failed"); } catch (ArithmeticException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }

  try { DecimalFraction.FromString("-74.5515151249").Divide(DecimalFraction.FromString("19760406509587061437.37690890330776422"), null); Assert.Fail("Should have failed"); } catch (ArithmeticException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }

  try { DecimalFraction.FromString("-299649E-145").Divide(DecimalFraction.FromString("-3296112203345202967.644501270E+299"), -7, new PrecisionContext(Rounding.Unnecessary)); Assert.Fail("Should have failed"); } catch (ArithmeticException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }

  try { DecimalFraction.FromString("6171505998846485E-166").Divide(DecimalFraction.FromString("1126829906715E-259"), null); Assert.Fail("Should have failed"); } catch (ArithmeticException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }

  Assert.AreEqual("0E+7", DecimalFraction.FromString("45383867142").DivideToIntegerNaturalScale(DecimalFraction.FromString("-2812913313744064.1210296"), new PrecisionContext(10, Rounding.Unnecessary)).ToString());

  try { DecimalFraction.FromString("7160786358320330424E+323").Divide(DecimalFraction.FromString("555494.85940316873300743388"), null); Assert.Fail("Should have failed"); } catch (ArithmeticException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }

  try { DecimalFraction.FromString("-7479249576360588316.48506514").Divide(DecimalFraction.FromString("1738944089.2538945979"), null); Assert.Fail("Should have failed"); } catch (ArithmeticException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }

  Assert.AreEqual("5.351688914683185001036110847622345844884801777E-57", DecimalFraction.FromString("-429556332.16E-58").Divide(DecimalFraction.FromString("-8026556.4573726598"), new PrecisionContext(46, Rounding.HalfUp)).ToString());

  Assert.AreEqual("-1.16942901899751144664915078774183951053497372202372222006960620984426667979662440441664399599494577288562604030E+119", DecimalFraction.FromString("-9E+123").Divide(DecimalFraction.FromString("76960.63509451147"), 9, new PrecisionContext(Rounding.HalfEven)).ToString());

  try { DecimalFraction.FromString("33487E+202").Divide(DecimalFraction.FromString("20957697750E+16"), null); Assert.Fail("Should have failed"); } catch (ArithmeticException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }

  Assert.AreEqual("0E-23", DecimalFraction.FromString("67503804436319664222").Divide(DecimalFraction.FromString("-4679857327.02930083042905249E+290"), -23, new PrecisionContext(Rounding.HalfUp)).ToString());

  try { DecimalFraction.FromString("-944.87409988703E+102").DivideToIntegerNaturalScale(DecimalFraction.FromString("-2104618710"), new PrecisionContext(12, Rounding.Unnecessary)); Assert.Fail("Should have failed"); } catch (ArithmeticException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }

  try { DecimalFraction.FromString("6360575191737455.42474031E+119").DivideToIntegerNaturalScale(DecimalFraction.FromString("-212691297025225.1466"), new PrecisionContext(49, Rounding.Unnecessary)); Assert.Fail("Should have failed"); } catch (ArithmeticException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }

  Assert.AreEqual("0.00", DecimalFraction.FromString("746819323286256E-345").Divide(DecimalFraction.FromString("1069371617278763.530E-325"), -2, new PrecisionContext(Rounding.HalfEven)).ToString());

  Assert.AreEqual("0E-27", DecimalFraction.FromString("-3633122765089.310291E+69").Divide(DecimalFraction.FromString("44515944787E+246"), -27, new PrecisionContext(Rounding.HalfDown)).ToString());

  try { DecimalFraction.FromString("4617.80").Divide(DecimalFraction.FromString("4100262.5"), null); Assert.Fail("Should have failed"); } catch (ArithmeticException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }

  Assert.AreEqual("-1.094807582668295802747769891703390325E-261", DecimalFraction.FromString("-593013935.21196654773773E-252").Divide(DecimalFraction.FromString("541660420150412479"), new PrecisionContext(37, Rounding.HalfEven)).ToString());

  Assert.AreEqual("0E-205", DecimalFraction.FromString("6952007351.767205866E-199").DivideToIntegerNaturalScale(DecimalFraction.FromString("-527157272985963049.004"), new PrecisionContext(28, Rounding.Unnecessary)).ToString());

  Assert.AreEqual("0E+4", DecimalFraction.FromString("574568E-10").DivideToIntegerNaturalScale(DecimalFraction.FromString("67142816.45116023331755"), new PrecisionContext(51, Rounding.Unnecessary)).ToString());

  try { DecimalFraction.FromString("3571772918909605233").DivideToIntegerNaturalScale(DecimalFraction.FromString("-5494400432458534696.440134708175E-241"), new PrecisionContext(21, Rounding.Unnecessary)); Assert.Fail("Should have failed"); } catch (ArithmeticException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }

  try { DecimalFraction.FromString("75361998972586985004").Divide(DecimalFraction.FromString("85533795088144284.4934600702927"), 22, new PrecisionContext(Rounding.Unnecessary)); Assert.Fail("Should have failed"); } catch (ArithmeticException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }

  try { DecimalFraction.FromString("30250752141437").Divide(DecimalFraction.FromString("-30.885E+33"), null); Assert.Fail("Should have failed"); } catch (ArithmeticException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }

  try { DecimalFraction.FromString("179507852310663261.06465759999032E-1").Divide(DecimalFraction.FromString("530178517368206.82"), null); Assert.Fail("Should have failed"); } catch (ArithmeticException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }

  Assert.AreEqual("5.54303786109766000632320465594172E-190", DecimalFraction.FromString("-5E-172").Divide(DecimalFraction.FromString("-902032445978977141.5421976187963514"), new PrecisionContext(33, Rounding.HalfUp)).ToString());

  Assert.AreEqual("8", DecimalFraction.FromString("3983").DivideToIntegerNaturalScale(DecimalFraction.FromString("458.352631483833874"), new PrecisionContext(48, Rounding.Unnecessary)).ToString());

  try { DecimalFraction.FromString("9959122662069122E-279").Divide(DecimalFraction.FromString("74E-24"), null); Assert.Fail("Should have failed"); } catch (ArithmeticException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }

  try { DecimalFraction.FromString("180509014672851.4485744097149244545E-176").Divide(DecimalFraction.FromString("-73216204E+290"), null); Assert.Fail("Should have failed"); } catch (ArithmeticException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }

  Assert.AreEqual("33282", DecimalFraction.FromString("275664").DivideToIntegerNaturalScale(DecimalFraction.FromString("82824703.1995782E-7"), new PrecisionContext(36, Rounding.Unnecessary)).ToString());

  try { DecimalFraction.FromString("6791.85807E+299").DivideToIntegerNaturalScale(DecimalFraction.FromString("-12239625E-4"), new PrecisionContext(39, Rounding.Unnecessary)); Assert.Fail("Should have failed"); } catch (ArithmeticException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }

  try { DecimalFraction.FromString("513380.6750517361").Divide(DecimalFraction.FromString("-38725348318085588E-148"), null); Assert.Fail("Should have failed"); } catch (ArithmeticException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }

  Assert.AreEqual("1.0650442351130979580553937E-57", DecimalFraction.FromString("-66.076782156134E-52").Divide(DecimalFraction.FromString("-6204135"), new PrecisionContext(26, Rounding.Down)).ToString());

  Assert.AreEqual("0E-554", DecimalFraction.FromString("299417E-322").DivideToIntegerNaturalScale(DecimalFraction.FromString("360397563.048532E+238"), new PrecisionContext(39, Rounding.Unnecessary)).ToString());

  try { DecimalFraction.FromString("-22.79155E-93").Divide(DecimalFraction.FromString("4005.81"), null); Assert.Fail("Should have failed"); } catch (ArithmeticException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }

  Assert.AreEqual("5.40746471888320493E+80", DecimalFraction.FromString("-1168012379.27877226472653").Divide(DecimalFraction.FromString("-2160E-75"), new PrecisionContext(18, Rounding.Up)).ToString());

  Assert.AreEqual("0", DecimalFraction.FromString("-244979587").DivideToIntegerNaturalScale(DecimalFraction.FromString("547487243824815"), new PrecisionContext(30, Rounding.Unnecessary)).ToString());

  try { DecimalFraction.FromString("47092551017281E-299").Divide(DecimalFraction.FromString("-92372481E-346"), new PrecisionContext(4, Rounding.Unnecessary)); Assert.Fail("Should have failed"); } catch (ArithmeticException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }

  Assert.AreEqual("0E-44", DecimalFraction.FromString("-1567692241753E+126").DivideToIntegerNaturalScale(DecimalFraction.FromString("-86429174400373154E+170"), new PrecisionContext(33, Rounding.Unnecessary)).ToString());

  try { DecimalFraction.FromString("252137169288968E-112").Divide(DecimalFraction.FromString("53544930948716814238"), null); Assert.Fail("Should have failed"); } catch (ArithmeticException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }

  Assert.AreEqual("-1.26434943840005411048297349575202103E-33", DecimalFraction.FromString("38254352476552884585.4972759209644625E-39").Divide(DecimalFraction.FromString("-30256154916287.300508"), new PrecisionContext(36, Rounding.HalfDown)).ToString());

  try { DecimalFraction.FromString("-10018120405693838844.593079922896796240E+185").Divide(DecimalFraction.FromString("-9221272449661242228.2944199320905604"), null); Assert.Fail("Should have failed"); } catch (ArithmeticException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }

  try { DecimalFraction.FromString("84.6368525111601242456E-349").Divide(DecimalFraction.FromString("-63170620798.8742263E-97"), null); Assert.Fail("Should have failed"); } catch (ArithmeticException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }

  Assert.AreEqual("0E-197", DecimalFraction.FromString("8542993019842643374.08414854E-200").DivideToIntegerNaturalScale(DecimalFraction.FromString("-398693716506268.37006039427"), new PrecisionContext(30, Rounding.Unnecessary)).ToString());

  Assert.AreEqual("-562720.011563708834180397862465", DecimalFraction.FromString("-4136895811582693.465669419107").Divide(DecimalFraction.FromString("73516059968916375E-7"), -24, new PrecisionContext(Rounding.Ceiling)).ToString());

  Assert.AreEqual("-1.92515056386644381397720431008316639349238147E-175", DecimalFraction.FromString("317130052385.719289476464866").Divide(DecimalFraction.FromString("-1647.3E+183"), new PrecisionContext(45, Rounding.HalfUp)).ToString());

  try { DecimalFraction.FromString("-61925E-81").DivideToIntegerNaturalScale(DecimalFraction.FromString("-9.6022742502734013486E-131"), new PrecisionContext(36, Rounding.Unnecessary)); Assert.Fail("Should have failed"); } catch (ArithmeticException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }

  Assert.AreEqual("9.471642767241675800097857665E-320", DecimalFraction.FromString("-40769.189E-20").Divide(DecimalFraction.FromString("-4304341918489897870E+285"), new PrecisionContext(28, Rounding.HalfDown)).ToString());

  Assert.AreEqual("0E-558", DecimalFraction.FromString("110691193854.481868307770756010E-228").DivideToIntegerNaturalScale(DecimalFraction.FromString("-6133129221.221037203E+321"), new PrecisionContext(11, Rounding.Unnecessary)).ToString());

  Assert.AreEqual("-8.13978742437132531022104534262E-20", DecimalFraction.FromString("3.8588208649488E-10").Divide(DecimalFraction.FromString("-4740689976"), new PrecisionContext(30, Rounding.HalfEven)).ToString());

  Assert.AreEqual("0.00", DecimalFraction.FromString("47E-159").Divide(DecimalFraction.FromString("33856869132226.82579485518918602"), -2, new PrecisionContext(Rounding.HalfUp)).ToString());

  Assert.AreEqual("0E-248", DecimalFraction.FromString("-18654720267").DivideToIntegerNaturalScale(DecimalFraction.FromString("151.3738312817271376E+264"), new PrecisionContext(37, Rounding.Unnecessary)).ToString());

  Assert.AreEqual("-7.14014935925752", DecimalFraction.FromString("-386813002.5387923786096306E+43").Divide(DecimalFraction.FromString("5417.43572965E+47"), -14, new PrecisionContext(Rounding.Floor)).ToString());

  Assert.AreEqual("-161602.6944444444", DecimalFraction.FromString("5817697").Divide(DecimalFraction.FromString("-36"), new PrecisionContext(16, Rounding.HalfEven)).ToString());

  Assert.AreEqual("1E-35", DecimalFraction.FromString("-9554E-176").Divide(DecimalFraction.FromString("-1970741060.05498853E+225"), -35, new PrecisionContext(Rounding.Ceiling)).ToString());

  try { DecimalFraction.FromString("11732111.828296E-302").Divide(DecimalFraction.FromString("2635432.2302"), null); Assert.Fail("Should have failed"); } catch (ArithmeticException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }

  try { DecimalFraction.FromString("-9872156579438658159.06517552119E-175").Divide(DecimalFraction.FromString("-388037983E-119"), null); Assert.Fail("Should have failed"); } catch (ArithmeticException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }

  Assert.AreEqual("0E-36", DecimalFraction.FromString("-9695.9213287805152E-165").Divide(DecimalFraction.FromString("-600884381578445446.072182285481719898"), -36, new PrecisionContext(Rounding.Down)).ToString());

  try { DecimalFraction.FromString("792859429755863E+329").DivideToIntegerNaturalScale(DecimalFraction.FromString("-57.2011677257905"), new PrecisionContext(12, Rounding.Unnecessary)); Assert.Fail("Should have failed"); } catch (ArithmeticException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }

  Assert.AreEqual("-1.099986892257671442046483049595111E-53", DecimalFraction.FromString("8299576E-312").Divide(DecimalFraction.FromString("-7545159E-259"), new PrecisionContext(34, Rounding.HalfUp)).ToString());

  Assert.AreEqual("-1E-21", DecimalFraction.FromString("-64275475779303278076.795414E-339").Divide(DecimalFraction.FromString("9E+21"), -21, new PrecisionContext(Rounding.Floor)).ToString());

  Assert.AreEqual("-8.72E+114", DecimalFraction.FromString("8700404238927.44655079629593732219E+117").Divide(DecimalFraction.FromString("-998318293729849"), new PrecisionContext(3, Rounding.HalfUp)).ToString());

  Assert.AreEqual("0E+30", DecimalFraction.FromString("181.6001120200947541").Divide(DecimalFraction.FromString("1308.5"), 30, new PrecisionContext(Rounding.HalfUp)).ToString());

  Assert.AreEqual("2.74413627630991195643204884891493E-267", DecimalFraction.FromString("199537125195598938E-279").Divide(DecimalFraction.FromString("72714"), new PrecisionContext(33, Rounding.Up)).ToString());

  try { DecimalFraction.FromString("5.32636383486554091E-64").DivideToIntegerNaturalScale(DecimalFraction.FromString("1946161134952375211.68157529090261043945E-254"), new PrecisionContext(27, Rounding.Unnecessary)); Assert.Fail("Should have failed"); } catch (ArithmeticException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }

  Assert.AreEqual("-1.071523014369E-231", DecimalFraction.FromString("-46008307").Divide(DecimalFraction.FromString("4293730175E+229"), new PrecisionContext(13, Rounding.Up)).ToString());

  try { DecimalFraction.FromString("-1030215899492980.76300E-257").Divide(DecimalFraction.FromString("401071770627.050"), null); Assert.Fail("Should have failed"); } catch (ArithmeticException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }

  Assert.AreEqual("0E-25", DecimalFraction.FromString("-2024E-25").DivideToIntegerNaturalScale(DecimalFraction.FromString("716"), new PrecisionContext(27, Rounding.Unnecessary)).ToString());

  try { DecimalFraction.FromString("-630908.5574805058048341").Divide(DecimalFraction.FromString("336830903652.6012324368876E+117"), null); Assert.Fail("Should have failed"); } catch (ArithmeticException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }

  Assert.AreEqual("0E-322", DecimalFraction.FromString("-97.477526").DivideToIntegerNaturalScale(DecimalFraction.FromString("-8034230440866128.5973345E+323"), new PrecisionContext(44, Rounding.Unnecessary)).ToString());

  try { DecimalFraction.FromString("-58050E-48").Divide(DecimalFraction.FromString("635891"), null); Assert.Fail("Should have failed"); } catch (ArithmeticException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }

  try { DecimalFraction.FromString("59").Divide(DecimalFraction.FromString("-7790000E+189"), null); Assert.Fail("Should have failed"); } catch (ArithmeticException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }

  Assert.AreEqual("812341411", DecimalFraction.FromString("735696911884006.471").DivideToIntegerNaturalScale(DecimalFraction.FromString("905649.8918183138461166"), new PrecisionContext(35, Rounding.Unnecessary)).ToString());

  Assert.AreEqual("1.404416935E+458", DecimalFraction.FromString("-280883387E+156").Divide(DecimalFraction.FromString("-2E-294"), null).ToString());

  Assert.AreEqual("0E-8", DecimalFraction.FromString("61763005").Divide(DecimalFraction.FromString("6.840543906570230479E+23"), -8, new PrecisionContext(Rounding.HalfDown)).ToString());

  Assert.AreEqual("0", DecimalFraction.FromString("272696245").DivideToIntegerNaturalScale(DecimalFraction.FromString("4167262972"), new PrecisionContext(34, Rounding.Unnecessary)).ToString());

  try { DecimalFraction.FromString("-5.318431787930").Divide(DecimalFraction.FromString("18.0922196782880E+173"), null); Assert.Fail("Should have failed"); } catch (ArithmeticException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }

  try { DecimalFraction.FromString("-25029553952265806824").Divide(DecimalFraction.FromString("-4650955.4288747309E-332"), null); Assert.Fail("Should have failed"); } catch (ArithmeticException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }

  Assert.AreEqual("1.209958059483669669367419858084645966483820E+269", DecimalFraction.FromString("-48807445498E+263").Divide(DecimalFraction.FromString("-40338.13"), new PrecisionContext(43, Rounding.Floor)).ToString());

  Assert.AreEqual("-1084309684953072", DecimalFraction.FromString("3366182.278269945205142464E+226").DivideToIntegerNaturalScale(DecimalFraction.FromString("-31044473041072485E+201"), new PrecisionContext(39, Rounding.Unnecessary)).ToString());

  Assert.AreEqual("0E+16", DecimalFraction.FromString("-89").Divide(DecimalFraction.FromString("879005900719277E+141"), 16, new PrecisionContext(Rounding.HalfDown)).ToString());

  try { DecimalFraction.FromString("35314192982809373.4809473985883000E+54").Divide(DecimalFraction.FromString("-34322E+211"), null); Assert.Fail("Should have failed"); } catch (ArithmeticException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }

  try { DecimalFraction.FromString("-921738465.5169940E+239").DivideToIntegerNaturalScale(DecimalFraction.FromString("303336341.676178"), new PrecisionContext(15, Rounding.Unnecessary)); Assert.Fail("Should have failed"); } catch (ArithmeticException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }

  try { DecimalFraction.FromString("-197922945317131.8591762566628607623").DivideToIntegerNaturalScale(DecimalFraction.FromString("-776478213387219447E-295"), new PrecisionContext(12, Rounding.Unnecessary)); Assert.Fail("Should have failed"); } catch (ArithmeticException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }

  try { DecimalFraction.FromString("21811E-325").Divide(DecimalFraction.FromString("188497.92882983500801153024"), null); Assert.Fail("Should have failed"); } catch (ArithmeticException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }

  Assert.AreEqual("1.273936312390747133932918333070524119069563372351215E+103", DecimalFraction.FromString("-1056632E+294").Divide(DecimalFraction.FromString("-8294229387472.74961E+184"), new PrecisionContext(52, Rounding.HalfEven)).ToString());

  Assert.AreEqual("13.1322002285816860055", DecimalFraction.FromString("864890582").Divide(DecimalFraction.FromString("65860295.072078"), new PrecisionContext(21, Rounding.Down)).ToString());

  try { DecimalFraction.FromString("-455536.3092216E-243").Divide(DecimalFraction.FromString("-8797862592E+157"), null); Assert.Fail("Should have failed"); } catch (ArithmeticException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }

  Assert.AreEqual("0.011838670955277357252864195685410364761844313306867", DecimalFraction.FromString("75314442275251").Divide(DecimalFraction.FromString("6361731190922058"), new PrecisionContext(50, Rounding.Ceiling)).ToString());

  try { DecimalFraction.FromString("90295127071862289094.429565E-155").Divide(DecimalFraction.FromString("36409431365607402277"), null); Assert.Fail("Should have failed"); } catch (ArithmeticException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }

  Assert.AreEqual("1.189572486448841949063732184087519551939E-297", DecimalFraction.FromString("-7502554469854670604.954728113106284246").Divide(DecimalFraction.FromString("-6306933.41962841457E+309"), new PrecisionContext(40, Rounding.Floor)).ToString());

  Assert.AreEqual("5.103834265173766759360033838531E+439", DecimalFraction.FromString("-77504939871770434E+215").Divide(DecimalFraction.FromString("-151856302232673843E-225"), new PrecisionContext(31, Rounding.Up)).ToString());

  Assert.AreEqual("-3.847697E-144", DecimalFraction.FromString("-689117904251.99167").Divide(DecimalFraction.FromString("1790987681793E+143"), new PrecisionContext(7, Rounding.Ceiling)).ToString());

  try { DecimalFraction.FromString("-13.126285646442465042E-269").Divide(DecimalFraction.FromString("-782E+302"), -47, new PrecisionContext(Rounding.Unnecessary)); Assert.Fail("Should have failed"); } catch (ArithmeticException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }

  try { DecimalFraction.FromString("-7.6342878608").Divide(DecimalFraction.FromString("59572941893693189E+155"), null); Assert.Fail("Should have failed"); } catch (ArithmeticException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }

  try { DecimalFraction.FromString("476.14306653651827").Divide(DecimalFraction.FromString("944777055594948400"), null); Assert.Fail("Should have failed"); } catch (ArithmeticException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }

  try { DecimalFraction.FromString("4E-293").Divide(DecimalFraction.FromString("-80272880"), 42, new PrecisionContext(Rounding.Unnecessary)); Assert.Fail("Should have failed"); } catch (ArithmeticException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }

  Assert.AreEqual("-7.3498641642285931908929501518008397417543056576229518759350250187049930816019784800071753246704836409832364563493466969120785448500479054544513460583204054013002E+172", DecimalFraction.FromString("57109212524090E+173").Divide(DecimalFraction.FromString("-77701044873778.169353469257"), 12, new PrecisionContext(Rounding.HalfUp)).ToString());

  try { DecimalFraction.FromString("-9061098855517395280E-33").Divide(DecimalFraction.FromString("2808899"), null); Assert.Fail("Should have failed"); } catch (ArithmeticException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }

  Assert.AreEqual("0E+47", DecimalFraction.FromString("8196568801311818230.834372E-308").Divide(DecimalFraction.FromString("49E+12"), 47, new PrecisionContext(Rounding.HalfUp)).ToString());

  try { DecimalFraction.FromString("-49660760135509070E+253").Divide(DecimalFraction.FromString("-18472.81334100301E+95"), null); Assert.Fail("Should have failed"); } catch (ArithmeticException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }

  try { DecimalFraction.FromString("-788.91659749290182236934").Divide(DecimalFraction.FromString("34670332192.69985065589611E-285"), null); Assert.Fail("Should have failed"); } catch (ArithmeticException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }

  try { DecimalFraction.FromString("-82567442580377E+107").Divide(DecimalFraction.FromString("558619520921686782"), null); Assert.Fail("Should have failed"); } catch (ArithmeticException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }

  Assert.AreEqual("-.18324988858982276205682339455", DecimalFraction.FromString("5571.9452").Divide(DecimalFraction.FromString("-8562952E-294"), -29, new PrecisionContext(Rounding.HalfUp)).ToString());

  try { DecimalFraction.FromString("-432E+186").DivideToIntegerNaturalScale(DecimalFraction.FromString("-56605217127949161.59659785E-280"), new PrecisionContext(10, Rounding.Unnecessary)); Assert.Fail("Should have failed"); } catch (ArithmeticException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }

  Assert.AreEqual("2.338018090867071094528E-7", DecimalFraction.FromString("52983250").Divide(DecimalFraction.FromString("226616082257732.978241927877"), new PrecisionContext(22, Rounding.HalfEven)).ToString());

  try { DecimalFraction.FromString("-380161995.0213752E-99").Divide(DecimalFraction.FromString("4288662278130.2487675861539E-2"), null); Assert.Fail("Should have failed"); } catch (ArithmeticException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }

  try { DecimalFraction.FromString("9369810481978852.56").DivideToIntegerNaturalScale(DecimalFraction.FromString("338766285.72206E-205"), new PrecisionContext(46, Rounding.Unnecessary)); Assert.Fail("Should have failed"); } catch (ArithmeticException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }

  try { DecimalFraction.FromString("-24856144196E+140").Divide(DecimalFraction.FromString("3774790672874623"), null); Assert.Fail("Should have failed"); } catch (ArithmeticException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }

  try { DecimalFraction.FromString("8915016381E+225").DivideToIntegerNaturalScale(DecimalFraction.FromString("-6472812"), new PrecisionContext(32, Rounding.Unnecessary)); Assert.Fail("Should have failed"); } catch (ArithmeticException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }

  Assert.AreEqual("1.25324780E+19", DecimalFraction.FromString("17502805503307E+20").Divide(DecimalFraction.FromString("139659575968309.2731726057938279111"), 11, new PrecisionContext(Rounding.Ceiling)).ToString());

  try { DecimalFraction.FromString("-11474769").Divide(DecimalFraction.FromString("-59226234659277448247.556436528492E-225"), null); Assert.Fail("Should have failed"); } catch (ArithmeticException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }

  Assert.AreEqual("0", DecimalFraction.FromString("69").DivideToIntegerNaturalScale(DecimalFraction.FromString("4377231537"), new PrecisionContext(21, Rounding.Unnecessary)).ToString());

  try { DecimalFraction.FromString("5E+50").Divide(DecimalFraction.FromString("6.966031951"), null); Assert.Fail("Should have failed"); } catch (ArithmeticException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }

  try { DecimalFraction.FromString("-50273337224051563145").DivideToIntegerNaturalScale(DecimalFraction.FromString("1896538.96599506269690431E-306"), new PrecisionContext(25, Rounding.Unnecessary)); Assert.Fail("Should have failed"); } catch (ArithmeticException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }

  Assert.AreEqual("1.457375480969746E+431", DecimalFraction.FromString("82035665.82378698525760E+196").Divide(DecimalFraction.FromString("5629E-231"), new PrecisionContext(16, Rounding.HalfDown)).ToString());

  Assert.AreEqual("0E-18", DecimalFraction.FromString("57007").Divide(DecimalFraction.FromString("-3239E+137"), -18, new PrecisionContext(Rounding.HalfEven)).ToString());

  try { DecimalFraction.FromString("-51304279450020989").Divide(DecimalFraction.FromString("98772338.09717945208572550877E-192"), null); Assert.Fail("Should have failed"); } catch (ArithmeticException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }

  try { DecimalFraction.FromString("-484702639.92309995631").Divide(DecimalFraction.FromString("3622414027656944165"), null); Assert.Fail("Should have failed"); } catch (ArithmeticException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }

  Assert.AreEqual("0.000107968498021899999170506", DecimalFraction.FromString("775091633299").Divide(DecimalFraction.FromString("7178868350486665"), new PrecisionContext(24, Rounding.HalfDown)).ToString());

  try { DecimalFraction.FromString("5245998168716679.04796917581465905875").Divide(DecimalFraction.FromString("48.47957634639464945103"), null); Assert.Fail("Should have failed"); } catch (ArithmeticException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }

  Assert.AreEqual("0E-15", DecimalFraction.FromString("72093027488E-260").Divide(DecimalFraction.FromString("-6878471091589976089.8923"), -15, new PrecisionContext(Rounding.Ceiling)).ToString());

  try { DecimalFraction.FromString("-677128192623140177.77E+156").DivideToIntegerNaturalScale(DecimalFraction.FromString("644101263521075826E+132"), new PrecisionContext(17, Rounding.Unnecessary)); Assert.Fail("Should have failed"); } catch (ArithmeticException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }

  try { DecimalFraction.FromString("-8670280703232.0037255244478678E+254").DivideToIntegerNaturalScale(DecimalFraction.FromString("-2608021874834.25560"), new PrecisionContext(11, Rounding.Unnecessary)); Assert.Fail("Should have failed"); } catch (ArithmeticException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }

  Assert.AreEqual("0E-139", DecimalFraction.FromString("7110190E-152").DivideToIntegerNaturalScale(DecimalFraction.FromString("-3863633968976.3441124404082"), new PrecisionContext(30, Rounding.Unnecessary)).ToString());

  Assert.AreEqual("-2.5504104178353979942125567909267060862896952489022E-51", DecimalFraction.FromString("8111447633521032927E+18").Divide(DecimalFraction.FromString("-3180447969E+78"), new PrecisionContext(50, Rounding.HalfEven)).ToString());

  try { DecimalFraction.FromString("-343537037E-96").Divide(DecimalFraction.FromString("-56378813039E-33"), null); Assert.Fail("Should have failed"); } catch (ArithmeticException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }

  try { DecimalFraction.FromString("71982928.77398423001395E-71").Divide(DecimalFraction.FromString("41820021240627.95713298953665181E-160"), null); Assert.Fail("Should have failed"); } catch (ArithmeticException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }

  try { DecimalFraction.FromString("82999698245").Divide(DecimalFraction.FromString("-50252475"), null); Assert.Fail("Should have failed"); } catch (ArithmeticException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }

  try { DecimalFraction.FromString("-3063371E-244").Divide(DecimalFraction.FromString("-3347231"), null); Assert.Fail("Should have failed"); } catch (ArithmeticException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }

  Assert.AreEqual("1.06366262330E-166", DecimalFraction.FromString("-917E-160").Divide(DecimalFraction.FromString("-862115467.74"), new PrecisionContext(12, Rounding.HalfDown)).ToString());

  Assert.AreEqual("991", DecimalFraction.FromString("8919").Divide(DecimalFraction.FromString("9"), new PrecisionContext(28, Rounding.Ceiling)).ToString());

  Assert.AreEqual("0E-216", DecimalFraction.FromString("-806049E-187").DivideToIntegerNaturalScale(DecimalFraction.FromString("1252967E+29"), new PrecisionContext(21, Rounding.Unnecessary)).ToString());

  Assert.AreEqual("0E+36", DecimalFraction.FromString("-85426").Divide(DecimalFraction.FromString("3.787609773547278380"), 36, new PrecisionContext(Rounding.Ceiling)).ToString());

  try { DecimalFraction.FromString("3631.40410907978621861160").Divide(DecimalFraction.FromString("399.8834771"), 20, new PrecisionContext(Rounding.Unnecessary)); Assert.Fail("Should have failed"); } catch (ArithmeticException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }

  try { DecimalFraction.FromString("-1668090E-25").Divide(DecimalFraction.FromString("-74382047004225777535.05245766332137"), null); Assert.Fail("Should have failed"); } catch (ArithmeticException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }

  try { DecimalFraction.FromString("-440.6997213E+238").Divide(DecimalFraction.FromString("767"), null); Assert.Fail("Should have failed"); } catch (ArithmeticException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }

  try { DecimalFraction.FromString("-913344395E+32").Divide(DecimalFraction.FromString("-7907615478.15941962320895728"), null); Assert.Fail("Should have failed"); } catch (ArithmeticException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }

  try { DecimalFraction.FromString("22422516115.1").Divide(DecimalFraction.FromString("-455999123.04898783888774619794E-281"), null); Assert.Fail("Should have failed"); } catch (ArithmeticException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }

  try { DecimalFraction.FromString("-9526786853238391.7600081943901E+16").Divide(DecimalFraction.FromString("-4533683900E-258"), null); Assert.Fail("Should have failed"); } catch (ArithmeticException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }

  try { DecimalFraction.FromString("99575E-334").Divide(DecimalFraction.FromString("328"), null); Assert.Fail("Should have failed"); } catch (ArithmeticException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }

  Assert.AreEqual("-11409.805676074", DecimalFraction.FromString("680086893297280600").Divide(DecimalFraction.FromString("-59605475553665.22926774"), -9, new PrecisionContext(Rounding.Up)).ToString());

  try { DecimalFraction.FromString("613031672126.274527247").DivideToIntegerNaturalScale(DecimalFraction.FromString("8418440789465.9844221801299E-213"), new PrecisionContext(7, Rounding.Unnecessary)); Assert.Fail("Should have failed"); } catch (ArithmeticException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }

  Assert.AreEqual("1E+20", DecimalFraction.FromString("-753692040975.9952671508").Divide(DecimalFraction.FromString("-1"), 20, new PrecisionContext(Rounding.Up)).ToString());

  try { DecimalFraction.FromString("-69.92614").Divide(DecimalFraction.FromString("-71308662.24325405763262"), null); Assert.Fail("Should have failed"); } catch (ArithmeticException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }

  try { DecimalFraction.FromString("4.316507318").Divide(DecimalFraction.FromString("60"), null); Assert.Fail("Should have failed"); } catch (ArithmeticException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }

  try { DecimalFraction.FromString("416483").DivideToIntegerNaturalScale(DecimalFraction.FromString("46062603989812603137E-145"), new PrecisionContext(10, Rounding.Unnecessary)); Assert.Fail("Should have failed"); } catch (ArithmeticException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }

  try { DecimalFraction.FromString("5694459273135413658E+166").Divide(DecimalFraction.FromString("41592671262542656671.8266849"), new PrecisionContext(32, Rounding.Unnecessary)); Assert.Fail("Should have failed"); } catch (ArithmeticException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }

  Assert.AreEqual("0E-7", DecimalFraction.FromString("-43823437500504872E-27").DivideToIntegerNaturalScale(DecimalFraction.FromString("-9.23853493040223050364"), new PrecisionContext(52, Rounding.Unnecessary)).ToString());

  try { DecimalFraction.FromString("-7142156904666803191.461447640193E-159").Divide(DecimalFraction.FromString("291068624855.522214579014540"), null); Assert.Fail("Should have failed"); } catch (ArithmeticException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }

  Assert.AreEqual("3.8844517748861850512599138E+349", DecimalFraction.FromString("-2191978545011511.44407840").Divide(DecimalFraction.FromString("-5642954712897E-347"), new PrecisionContext(26, Rounding.HalfDown)).ToString());

  try { DecimalFraction.FromString("-470772819.4921276459861729").DivideToIntegerNaturalScale(DecimalFraction.FromString("-9099555984462887.27428470984847107E-133"), new PrecisionContext(15, Rounding.Unnecessary)); Assert.Fail("Should have failed"); } catch (ArithmeticException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }

  try { DecimalFraction.FromString("-604725183799525.2139").DivideToIntegerNaturalScale(DecimalFraction.FromString("33E-97"), new PrecisionContext(48, Rounding.Unnecessary)); Assert.Fail("Should have failed"); } catch (ArithmeticException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }

  try { DecimalFraction.FromString("-4818681215129").DivideToIntegerNaturalScale(DecimalFraction.FromString("1094930642018045627.728E-103"), new PrecisionContext(37, Rounding.Unnecessary)); Assert.Fail("Should have failed"); } catch (ArithmeticException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }

  try { DecimalFraction.FromString("6.16119629822222124E+331").Divide(DecimalFraction.FromString("-949"), new PrecisionContext(36, Rounding.Unnecessary)); Assert.Fail("Should have failed"); } catch (ArithmeticException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }

  Assert.AreEqual("1E+7", DecimalFraction.FromString("32854194263457E-318").Divide(DecimalFraction.FromString("82235533196709441686.9"), 7, new PrecisionContext(Rounding.Up)).ToString());

  try { DecimalFraction.FromString("39431264446185.900427727523E-247").Divide(DecimalFraction.FromString("-776438053757"), null); Assert.Fail("Should have failed"); } catch (ArithmeticException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }

  Assert.AreEqual("-5.5493184699192900858842528811468950656E-175", DecimalFraction.FromString("897716.7E-171").Divide(DecimalFraction.FromString("-1617706219"), new PrecisionContext(38, Rounding.Floor)).ToString());

  try { DecimalFraction.FromString("-847849856646026.0875160E+216").Divide(DecimalFraction.FromString("-7142"), null); Assert.Fail("Should have failed"); } catch (ArithmeticException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }

  try { DecimalFraction.FromString("-183941458466061.3303328496939648E+283").Divide(DecimalFraction.FromString("32001117415442E+289"), null); Assert.Fail("Should have failed"); } catch (ArithmeticException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }

  try { DecimalFraction.FromString("73341593324178093592").Divide(DecimalFraction.FromString("-4818E-330"), null); Assert.Fail("Should have failed"); } catch (ArithmeticException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }

  try { DecimalFraction.FromString("-82205448043527.813947317567089388").Divide(DecimalFraction.FromString("-1217.35907082"), null); Assert.Fail("Should have failed"); } catch (ArithmeticException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }

  try { DecimalFraction.FromString("596247214315421E+344").Divide(DecimalFraction.FromString("27189044435669.92361807460954828041"), null); Assert.Fail("Should have failed"); } catch (ArithmeticException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }

  try { DecimalFraction.FromString("50338123017058129.93697498896").Divide(DecimalFraction.FromString("-310747175.9884088152E+272"), null); Assert.Fail("Should have failed"); } catch (ArithmeticException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }

  try { DecimalFraction.FromString("26258126359766700205E-2").DivideToIntegerNaturalScale(DecimalFraction.FromString("14053.05424545318"), new PrecisionContext(11, Rounding.Unnecessary)); Assert.Fail("Should have failed"); } catch (ArithmeticException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }

  Assert.AreEqual("0E+21", DecimalFraction.FromString("-9372491285204058874.15050383926").Divide(DecimalFraction.FromString("-1064.5492883917462622"), 21, new PrecisionContext(Rounding.Floor)).ToString());

  Assert.AreEqual("591957.000000000", DecimalFraction.FromString("6349570715848.26265264367894382").DivideToIntegerNaturalScale(DecimalFraction.FromString("10726395.981525"), new PrecisionContext(15, Rounding.Unnecessary)).ToString());

  Assert.AreEqual("-901.64017461185", DecimalFraction.FromString("-75771487805").Divide(DecimalFraction.FromString("84037390.9"), -11, new PrecisionContext(Rounding.HalfUp)).ToString());

  try { DecimalFraction.FromString("6.3597204588E+147").Divide(DecimalFraction.FromString("-6311510937.258839007"), null); Assert.Fail("Should have failed"); } catch (ArithmeticException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }

  try { DecimalFraction.FromString("-97602147891.8E-294").Divide(DecimalFraction.FromString("455252533E+242"), new PrecisionContext(14, Rounding.Unnecessary)); Assert.Fail("Should have failed"); } catch (ArithmeticException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }

  try { DecimalFraction.FromString("-55674").Divide(DecimalFraction.FromString("-2291"), null); Assert.Fail("Should have failed"); } catch (ArithmeticException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }

  try { DecimalFraction.FromString("-761139E+106").DivideToIntegerNaturalScale(DecimalFraction.FromString("1600974326302200.302143398068033"), new PrecisionContext(37, Rounding.Unnecessary)); Assert.Fail("Should have failed"); } catch (ArithmeticException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }

  Assert.AreEqual("0E+38", DecimalFraction.FromString("-29203640350E-112").Divide(DecimalFraction.FromString("545119676790686E+99"), 38, new PrecisionContext(Rounding.HalfDown)).ToString());

  Assert.AreEqual("-1.75540290124E-289", DecimalFraction.FromString("411633763.9572983722009663139").Divide(DecimalFraction.FromString("-23449531937515322113.25205633020E+278"), new PrecisionContext(12, Rounding.HalfUp)).ToString());

  Assert.AreEqual("0E-119", DecimalFraction.FromString("-92837744005084.1519044428600E-112").DivideToIntegerNaturalScale(DecimalFraction.FromString("1899.542363"), new PrecisionContext(33, Rounding.Unnecessary)).ToString());

  try { DecimalFraction.FromString("-452960015").Divide(DecimalFraction.FromString("-7940279228898798E+243"), null); Assert.Fail("Should have failed"); } catch (ArithmeticException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }

  Assert.AreEqual("0E-297", DecimalFraction.FromString("-881449").DivideToIntegerNaturalScale(DecimalFraction.FromString("8844154675261E+297"), new PrecisionContext(19, Rounding.Unnecessary)).ToString());

  Assert.AreEqual("0.0001067385419676", DecimalFraction.FromString("-427").Divide(DecimalFraction.FromString("-4000429.386882370"), new PrecisionContext(13, Rounding.HalfDown)).ToString());

  try { DecimalFraction.FromString("4259").Divide(DecimalFraction.FromString("-2205729973.0856861397052"), null); Assert.Fail("Should have failed"); } catch (ArithmeticException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }

  try { DecimalFraction.FromString("-76534210505.2599466178E-149").Divide(DecimalFraction.FromString("-92976146"), null); Assert.Fail("Should have failed"); } catch (ArithmeticException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }

  try { DecimalFraction.FromString("636093.1817").Divide(DecimalFraction.FromString("7605203325621"), null); Assert.Fail("Should have failed"); } catch (ArithmeticException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }

  try { DecimalFraction.FromString("-2341408844534351224.22165").Divide(DecimalFraction.FromString("69078859919204550E+189"), null); Assert.Fail("Should have failed"); } catch (ArithmeticException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }

  Assert.AreEqual("-2.01088252061567331633412814386752791517674573107E-204", DecimalFraction.FromString("9014496564199802").Divide(DecimalFraction.FromString("-448285589624590662E+202"), new PrecisionContext(48, Rounding.HalfEven)).ToString());

  try { DecimalFraction.FromString("-5144066737291").Divide(DecimalFraction.FromString("7084466356E-344"), null); Assert.Fail("Should have failed"); } catch (ArithmeticException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }

  try { DecimalFraction.FromString("2240222E+259").Divide(DecimalFraction.FromString("93966956"), null); Assert.Fail("Should have failed"); } catch (ArithmeticException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }

  try { DecimalFraction.FromString("-33").Divide(DecimalFraction.FromString("-1761712364439.6962077971303"), null); Assert.Fail("Should have failed"); } catch (ArithmeticException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }

  Assert.AreEqual("-6.682660553827353232606249464576887340097692917E+282", DecimalFraction.FromString("-44285801551092936826.77281816").Divide(DecimalFraction.FromString("6626971577.32023E-273"), new PrecisionContext(46, Rounding.HalfDown)).ToString());

  try { DecimalFraction.FromString("-68950102637348431.43396833130007970312E+263").Divide(DecimalFraction.FromString("-933674640E+131"), null); Assert.Fail("Should have failed"); } catch (ArithmeticException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }

  Assert.AreEqual("1.029084700041611065673740547831202559797971101832321754E+98", DecimalFraction.FromString("7.172").Divide(DecimalFraction.FromString("696.93E-100"), 44, new PrecisionContext(Rounding.Up)).ToString());

  Assert.AreEqual("7.49102233711089493078115", DecimalFraction.FromString("899344522890711").Divide(DecimalFraction.FromString("120056313066283.860885072"), new PrecisionContext(24, Rounding.Ceiling)).ToString());

  Assert.AreEqual("0.000001546174", DecimalFraction.FromString("3679786109463.391962").Divide(DecimalFraction.FromString("2379929733468976907"), -12, new PrecisionContext(Rounding.HalfDown)).ToString());

  Assert.AreEqual("-1E-7", DecimalFraction.FromString("-1539792356").Divide(DecimalFraction.FromString("33706848.30494E+219"), -7, new PrecisionContext(Rounding.Up)).ToString());

  Assert.AreEqual("-1.293010325460184E-204", DecimalFraction.FromString("557552636708580785.84698E-206").Divide(DecimalFraction.FromString("-4312050922796360.06823675745732"), new PrecisionContext(16, Rounding.Up)).ToString());

  Assert.AreEqual("0E-143", DecimalFraction.FromString("9207408048569.322241712652E+164").DivideToIntegerNaturalScale(DecimalFraction.FromString("730689581296609.50E+297"), new PrecisionContext(44, Rounding.Unnecessary)).ToString());

  Assert.AreEqual("-9.0914796E+348", DecimalFraction.FromString("-6165702626018050140.51601").Divide(DecimalFraction.FromString("678184.7213784967896463E-336"), new PrecisionContext(8, Rounding.Down)).ToString());

  Assert.AreEqual("110380845818880268", DecimalFraction.FromString("9051229357148182049").DivideToIntegerNaturalScale(DecimalFraction.FromString("82"), new PrecisionContext(28, Rounding.Unnecessary)).ToString());

  try { DecimalFraction.FromString("68058476942002866.0488373064133363869").Divide(DecimalFraction.FromString("9"), null); Assert.Fail("Should have failed"); } catch (ArithmeticException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }

  Assert.AreEqual("-1E+42", DecimalFraction.FromString("931.506995E-251").Divide(DecimalFraction.FromString("-811316224"), 42, new PrecisionContext(Rounding.Floor)).ToString());

  Assert.AreEqual("1129284646", DecimalFraction.FromString("81911532535203").DivideToIntegerNaturalScale(DecimalFraction.FromString("72534"), new PrecisionContext(17, Rounding.Unnecessary)).ToString());

  try { DecimalFraction.FromString("-361118181190.5506118238976E-179").Divide(DecimalFraction.FromString("71419.8"), null); Assert.Fail("Should have failed"); } catch (ArithmeticException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }

  Assert.AreEqual("1.26164117624046729903066733362210503E-96", DecimalFraction.FromString("-80134561E-13").Divide(DecimalFraction.FromString("-635161268585026338.18164671417324E+73"), new PrecisionContext(36, Rounding.Down)).ToString());

  Assert.AreEqual("0E-146", DecimalFraction.FromString("-933911795439320.3741E-144").DivideToIntegerNaturalScale(DecimalFraction.FromString("34614288180347.80"), new PrecisionContext(15, Rounding.Unnecessary)).ToString());

  try { DecimalFraction.FromString("-5407942140741.531763827360124895E+191").Divide(DecimalFraction.FromString("372.1E-223"), null); Assert.Fail("Should have failed"); } catch (ArithmeticException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }

  try { DecimalFraction.FromString("450").Divide(DecimalFraction.FromString("-3174093030837841698E+325"), null); Assert.Fail("Should have failed"); } catch (ArithmeticException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }

  Assert.AreEqual("-1.", DecimalFraction.FromString("-27103942307995869463E-8").Divide(DecimalFraction.FromString("23665694296.130978209715232E-328"), 26, new PrecisionContext(Rounding.Ceiling)).ToString());

  Assert.AreEqual("0E+41", DecimalFraction.FromString("2882158193366").Divide(DecimalFraction.FromString("-86931E-12"), 41, new PrecisionContext(Rounding.Ceiling)).ToString());

  Assert.AreEqual("-3.", DecimalFraction.FromString("6").Divide(DecimalFraction.FromString("-1933.67064274964649907867E-330"), 18, new PrecisionContext(Rounding.HalfUp)).ToString());

  Assert.AreEqual("0E-36", DecimalFraction.FromString("57014.3506530157313E-333").Divide(DecimalFraction.FromString("-2862748443692"), -36, new PrecisionContext(Rounding.HalfEven)).ToString());

  try { DecimalFraction.FromString("-64.16896322E-338").Divide(DecimalFraction.FromString("-4666506809"), null); Assert.Fail("Should have failed"); } catch (ArithmeticException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }

  try { DecimalFraction.FromString("89344411054432").DivideToIntegerNaturalScale(DecimalFraction.FromString("-941215451.9E-257"), new PrecisionContext(48, Rounding.Unnecessary)); Assert.Fail("Should have failed"); } catch (ArithmeticException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }

  try { DecimalFraction.FromString("9301871154011781113E-209").Divide(DecimalFraction.FromString("-2630"), 6, new PrecisionContext(Rounding.Unnecessary)); Assert.Fail("Should have failed"); } catch (ArithmeticException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }

  try { DecimalFraction.FromString("-1853267575867.157").DivideToIntegerNaturalScale(DecimalFraction.FromString("-5818942372396.221482093098516E-260"), new PrecisionContext(23, Rounding.Unnecessary)); Assert.Fail("Should have failed"); } catch (ArithmeticException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }

  Assert.AreEqual("0.25004485497883062670264953010785511113356", DecimalFraction.FromString("43764685676").Divide(DecimalFraction.FromString("175027339313.60123"), -41, new PrecisionContext(Rounding.Ceiling)).ToString());

  try { DecimalFraction.FromString("194877710421.987786487969386E-31").Divide(DecimalFraction.FromString("44441563497882731854E+156"), null); Assert.Fail("Should have failed"); } catch (ArithmeticException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }

  try { DecimalFraction.FromString("24178375749521875723E-223").Divide(DecimalFraction.FromString("-524134531102926005.405171499506E+162"), null); Assert.Fail("Should have failed"); } catch (ArithmeticException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }

  try { DecimalFraction.FromString("1.594319396E-134").Divide(DecimalFraction.FromString("-12105354798256981420"), null); Assert.Fail("Should have failed"); } catch (ArithmeticException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }

  try { DecimalFraction.FromString("980").Divide(DecimalFraction.FromString("-48327380527705.4657661394E+32"), null); Assert.Fail("Should have failed"); } catch (ArithmeticException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }

  try { DecimalFraction.FromString("2863794895545E-314").Divide(DecimalFraction.FromString("8214858.13593055435514821985"), null); Assert.Fail("Should have failed"); } catch (ArithmeticException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }

  try { DecimalFraction.FromString("-2832536E+113").Divide(DecimalFraction.FromString("-4451372009506570.704973841930912E+5"), null); Assert.Fail("Should have failed"); } catch (ArithmeticException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }

  Assert.AreEqual("-4.388315643671309908135264627857854185229833848734210388385135489281408878872058283978E+87", DecimalFraction.FromString("16744934833120984347.46254276698E+73").Divide(DecimalFraction.FromString("-38158"), 3, new PrecisionContext(Rounding.Up)).ToString());

  try { DecimalFraction.FromString("2596620").Divide(DecimalFraction.FromString("-799544355.071628862237252368E+168"), null); Assert.Fail("Should have failed"); } catch (ArithmeticException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }

  try { DecimalFraction.FromString("-18165584358.3674662970150700719E-3").DivideToIntegerNaturalScale(DecimalFraction.FromString("-9711E-115"), new PrecisionContext(49, Rounding.Unnecessary)); Assert.Fail("Should have failed"); } catch (ArithmeticException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }

  try { DecimalFraction.FromString("1105411E+99").Divide(DecimalFraction.FromString("-77304201E+93"), null); Assert.Fail("Should have failed"); } catch (ArithmeticException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }

  try { DecimalFraction.FromString("62346159830E-233").Divide(DecimalFraction.FromString("8.27104257839E+263"), null); Assert.Fail("Should have failed"); } catch (ArithmeticException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }

  Assert.AreEqual("1.230334603241E+57", DecimalFraction.FromString("-2304E+63").Divide(DecimalFraction.FromString("-1872661302"), 45, new PrecisionContext(Rounding.Up)).ToString());

  Assert.AreEqual("-4.8135910761782798064594037843739467671816E+258", DecimalFraction.FromString("-696.75910818E+266").Divide(DecimalFraction.FromString("14474829647"), new PrecisionContext(41, Rounding.Up)).ToString());

  try { DecimalFraction.FromString("512.8444608213307267E-250").Divide(DecimalFraction.FromString("5535892"), null); Assert.Fail("Should have failed"); } catch (ArithmeticException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }

  try { DecimalFraction.FromString("-73809.0187194194074325218E+302").Divide(DecimalFraction.FromString("-9593130498E+283"), null); Assert.Fail("Should have failed"); } catch (ArithmeticException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }

  Assert.AreEqual("0E+36", DecimalFraction.FromString("-687.93391470670E-345").Divide(DecimalFraction.FromString("6141170960E+120"), 36, new PrecisionContext(Rounding.HalfEven)).ToString());

  try { DecimalFraction.FromString("56700319893118806.018699E+84").Divide(DecimalFraction.FromString("-9.50874397140904E+311"), null); Assert.Fail("Should have failed"); } catch (ArithmeticException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }

  Assert.AreEqual("0E-421", DecimalFraction.FromString("-9055746479E-312").DivideToIntegerNaturalScale(DecimalFraction.FromString("97322E+109"), new PrecisionContext(36, Rounding.Unnecessary)).ToString());

  try { DecimalFraction.FromString("706740812.59913741787E+38").DivideToIntegerNaturalScale(DecimalFraction.FromString("6778708666436826E-264"), new PrecisionContext(23, Rounding.Unnecessary)); Assert.Fail("Should have failed"); } catch (ArithmeticException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }

  Assert.AreEqual("0E-277", DecimalFraction.FromString("1.1479E-263").DivideToIntegerNaturalScale(DecimalFraction.FromString("7118282661206.54631224953E+21"), new PrecisionContext(10, Rounding.Unnecessary)).ToString());

  try { DecimalFraction.FromString("3900332998340395").Divide(DecimalFraction.FromString("-729.86326634547094495479E-265"), null); Assert.Fail("Should have failed"); } catch (ArithmeticException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }

  Assert.AreEqual("0E-145", DecimalFraction.FromString("-1962417047408081.193224759087E-133").DivideToIntegerNaturalScale(DecimalFraction.FromString("-222808"), new PrecisionContext(10, Rounding.Unnecessary)).ToString());

  try { DecimalFraction.FromString("-91373").Divide(DecimalFraction.FromString("895603795857952797.611921E+179"), null); Assert.Fail("Should have failed"); } catch (ArithmeticException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }

  try { DecimalFraction.FromString("4621").DivideToIntegerNaturalScale(DecimalFraction.FromString("6484554893019.8E-321"), new PrecisionContext(13, Rounding.Unnecessary)); Assert.Fail("Should have failed"); } catch (ArithmeticException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }

  Assert.AreEqual("0E-187", DecimalFraction.FromString("30038465E-187").DivideToIntegerNaturalScale(DecimalFraction.FromString("-720033965480650897"), new PrecisionContext(17, Rounding.Unnecessary)).ToString());

  Assert.AreEqual("-7657047.3228195992368216123318813979862930835837616", DecimalFraction.FromString("-4171668352993774933").Divide(DecimalFraction.FromString("544814231533"), new PrecisionContext(50, Rounding.HalfEven)).ToString());

  Assert.AreEqual("-6.24499826838410674108520420768095896263432393623113E+57", DecimalFraction.FromString("9498148780876").Divide(DecimalFraction.FromString("-15209209630947817591E-64"), 7, new PrecisionContext(Rounding.HalfEven)).ToString());

  try { DecimalFraction.FromString("2756356493").Divide(DecimalFraction.FromString("-29082487137063683.60861E+246"), new PrecisionContext(31, Rounding.Unnecessary)); Assert.Fail("Should have failed"); } catch (ArithmeticException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }

  Assert.AreEqual("0E-47", DecimalFraction.FromString("-52442848.328660E-259").Divide(DecimalFraction.FromString("-47814379792676731812E+201"), -47, new PrecisionContext(Rounding.Floor)).ToString());

  Assert.AreEqual("8.9261475128932379668311101E-326", DecimalFraction.FromString("-470.35863885544").Divide(DecimalFraction.FromString("-526944729712384453.02979E+310"), new PrecisionContext(26, Rounding.Up)).ToString());

  Assert.AreEqual("-5.271206695447558890047630040180725E+264", DecimalFraction.FromString("210848267817902355.601905201607229E+248").DivideToIntegerNaturalScale(DecimalFraction.FromString("-4"), new PrecisionContext(34, Rounding.Unnecessary)).ToString());

  try { DecimalFraction.FromString("-709781022918.7673").Divide(DecimalFraction.FromString("3E+336"), null); Assert.Fail("Should have failed"); } catch (ArithmeticException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }

  Assert.AreEqual("0E-260", DecimalFraction.FromString("4817478758.0989241").DivideToIntegerNaturalScale(DecimalFraction.FromString("-16445934305.753761705814415E+268"), new PrecisionContext(51, Rounding.Unnecessary)).ToString());

  try { DecimalFraction.FromString("53478641436567709.1854586").Divide(DecimalFraction.FromString("30430173E-253"), null); Assert.Fail("Should have failed"); } catch (ArithmeticException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }

  Assert.AreEqual("-5.98503285513352963276430295161949806991118074085581E+189", DecimalFraction.FromString("115196E+189").Divide(DecimalFraction.FromString("-19247.346303403026"), new PrecisionContext(51, Rounding.Down)).ToString());

  try { DecimalFraction.FromString("488120102169295064E-284").Divide(DecimalFraction.FromString("-65426.9"), null); Assert.Fail("Should have failed"); } catch (ArithmeticException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }

  try { DecimalFraction.FromString("607991466450E+217").Divide(DecimalFraction.FromString("-39467954426316305872.04918096928149341394E-265"), null); Assert.Fail("Should have failed"); } catch (ArithmeticException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }

  try { DecimalFraction.FromString("-838316021466").Divide(DecimalFraction.FromString("707264876E-181"), null); Assert.Fail("Should have failed"); } catch (ArithmeticException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }

  try { DecimalFraction.FromString("7870").Divide(DecimalFraction.FromString("-5330269E+256"), new PrecisionContext(11, Rounding.Unnecessary)); Assert.Fail("Should have failed"); } catch (ArithmeticException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }

  try { DecimalFraction.FromString("585331888461").Divide(DecimalFraction.FromString("-819741322707228E+49"), 35, new PrecisionContext(Rounding.Unnecessary)); Assert.Fail("Should have failed"); } catch (ArithmeticException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }

  Assert.AreEqual("0E+19", DecimalFraction.FromString("96601").DivideToIntegerNaturalScale(DecimalFraction.FromString("-9320796029315785.9796330216021360528"), new PrecisionContext(23, Rounding.Unnecessary)).ToString());

  Assert.AreEqual("-8.97157693191301019215E+356", DecimalFraction.FromString("-85727E+228").Divide(DecimalFraction.FromString("9555399307234210355.840952018616347060E-143"), new PrecisionContext(21, Rounding.Up)).ToString());

  Assert.AreEqual("0E-8", DecimalFraction.FromString("73E-8").DivideToIntegerNaturalScale(DecimalFraction.FromString("-67889136"), new PrecisionContext(24, Rounding.Unnecessary)).ToString());

  try { DecimalFraction.FromString("-755.8E-297").Divide(DecimalFraction.FromString("-5551804"), null); Assert.Fail("Should have failed"); } catch (ArithmeticException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }

  try { DecimalFraction.FromString("-985266E+217").DivideToIntegerNaturalScale(DecimalFraction.FromString("-10841153583325826347.224253208174E-116"), new PrecisionContext(41, Rounding.Unnecessary)); Assert.Fail("Should have failed"); } catch (ArithmeticException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }

  try { DecimalFraction.FromString("62E+38").Divide(DecimalFraction.FromString("-8007115179080810.262326"), new PrecisionContext(8, Rounding.Unnecessary)); Assert.Fail("Should have failed"); } catch (ArithmeticException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }

  Assert.AreEqual("1447467089844539611862222747215659804252446844414444819439757003037462031724603442456969287883901451231859601754978062774215322308471144110698616267296658791765102936213297333783327708403644.954438069524130948363145460681741478", DecimalFraction.FromString("6433267480814056304.921649").Divide(DecimalFraction.FromString("44445E-175"), -36, new PrecisionContext(Rounding.HalfEven)).ToString());

  try { DecimalFraction.FromString("82828370985.53326458980E+214").Divide(DecimalFraction.FromString("581044353658670011E+291"), null); Assert.Fail("Should have failed"); } catch (ArithmeticException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }

  try { DecimalFraction.FromString("844444296950381322.54314E-23").Divide(DecimalFraction.FromString("48175434750301E-56"), new PrecisionContext(20, Rounding.Unnecessary)); Assert.Fail("Should have failed"); } catch (ArithmeticException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }

  try { DecimalFraction.FromString("-167472967626672044.434637903802").Divide(DecimalFraction.FromString("108392829"), null); Assert.Fail("Should have failed"); } catch (ArithmeticException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }

  try { DecimalFraction.FromString("43736187113304556590.58696458656542470544").Divide(DecimalFraction.FromString("33164982503904E+171"), null); Assert.Fail("Should have failed"); } catch (ArithmeticException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }

  Assert.AreEqual(".98097444918785602775725607595880188920789851786", DecimalFraction.FromString("7869").Divide(DecimalFraction.FromString("7197810193411588E-298"), -47, new PrecisionContext(Rounding.Floor)).ToString());

  Assert.AreEqual("2.06235140626057719382959871631622011E-272", DecimalFraction.FromString("-930230859376E-265").Divide(DecimalFraction.FromString("-4510535190812509571.5664"), new PrecisionContext(36, Rounding.HalfDown)).ToString());

  try { DecimalFraction.FromString("80214209380612782469E+331").Divide(DecimalFraction.FromString("-97128350434253684854.89516"), null); Assert.Fail("Should have failed"); } catch (ArithmeticException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }

  try { DecimalFraction.FromString("8233928240505213").Divide(DecimalFraction.FromString("-91567082"), new PrecisionContext(51, Rounding.Unnecessary)); Assert.Fail("Should have failed"); } catch (ArithmeticException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }

  try { DecimalFraction.FromString("4596849550.774007").Divide(DecimalFraction.FromString("6176399097760"), null); Assert.Fail("Should have failed"); } catch (ArithmeticException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }

  try { DecimalFraction.FromString("-1966686.897875725441635E+221").DivideToIntegerNaturalScale(DecimalFraction.FromString("-535282876116868724"), new PrecisionContext(28, Rounding.Unnecessary)); Assert.Fail("Should have failed"); } catch (ArithmeticException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }

  Assert.AreEqual("0E-178", DecimalFraction.FromString("-6961").DivideToIntegerNaturalScale(DecimalFraction.FromString("-1.7927823852203783E+194"), new PrecisionContext(25, Rounding.Unnecessary)).ToString());

  Assert.AreEqual("0E-170", DecimalFraction.FromString("98621443.8040899093607496493").DivideToIntegerNaturalScale(DecimalFraction.FromString("-54926890795595505E+151"), new PrecisionContext(38, Rounding.Unnecessary)).ToString());

  try { DecimalFraction.FromString("-2369006E+27").DivideToIntegerNaturalScale(DecimalFraction.FromString("693465.2792474552189401204E-96"), new PrecisionContext(23, Rounding.Unnecessary)); Assert.Fail("Should have failed"); } catch (ArithmeticException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }

  try { DecimalFraction.FromString("52925949778.2009192466631692").DivideToIntegerNaturalScale(DecimalFraction.FromString("73520926823E-147"), new PrecisionContext(18, Rounding.Unnecessary)); Assert.Fail("Should have failed"); } catch (ArithmeticException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }

  try { DecimalFraction.FromString("-7633787.7391400723653E+55").Divide(DecimalFraction.FromString("-1954002961162293991E+139"), null); Assert.Fail("Should have failed"); } catch (ArithmeticException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }

  try { DecimalFraction.FromString("6670757772E-137").Divide(DecimalFraction.FromString("-25987273481897928E-328"), null); Assert.Fail("Should have failed"); } catch (ArithmeticException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }

  Assert.AreEqual("-7111.00000000000000000000", DecimalFraction.FromString("33777909962590.50120968205938547775").DivideToIntegerNaturalScale(DecimalFraction.FromString("-4749774353"), new PrecisionContext(26, Rounding.Unnecessary)).ToString());

  try { DecimalFraction.FromString("-337897947217265556E+114").DivideToIntegerNaturalScale(DecimalFraction.FromString("383616937938E+26"), new PrecisionContext(45, Rounding.Unnecessary)); Assert.Fail("Should have failed"); } catch (ArithmeticException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }

  try { DecimalFraction.FromString("811084309030769228E+22").Divide(DecimalFraction.FromString("-287688421866344E+177"), null); Assert.Fail("Should have failed"); } catch (ArithmeticException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }

  Assert.AreEqual("1589", DecimalFraction.FromString("-15375").DivideToIntegerNaturalScale(DecimalFraction.FromString("-9.67106532903307206991"), new PrecisionContext(6, Rounding.Unnecessary)).ToString());

  try { DecimalFraction.FromString("244474439E-128").Divide(DecimalFraction.FromString("8437402195605517670"), null); Assert.Fail("Should have failed"); } catch (ArithmeticException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }

  try { DecimalFraction.FromString("-65348610019552903E+268").Divide(DecimalFraction.FromString("-94768574014891"), null); Assert.Fail("Should have failed"); } catch (ArithmeticException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }

  Assert.AreEqual("-181", DecimalFraction.FromString("-7203082863401").DivideToIntegerNaturalScale(DecimalFraction.FromString("39770251278.2457980938534"), new PrecisionContext(46, Rounding.Unnecessary)).ToString());

  Assert.AreEqual("0E-182", DecimalFraction.FromString("441383417959965E-141").DivideToIntegerNaturalScale(DecimalFraction.FromString("8790881363537316.08507103E+49"), new PrecisionContext(23, Rounding.Unnecessary)).ToString());

  Assert.AreEqual("8.246242792690274246321118537928704261212422141100244159010121913407024914307E+83", DecimalFraction.FromString("66880201808E+86").Divide(DecimalFraction.FromString("8110384752106.09713004259940518151"), 8, new PrecisionContext(Rounding.HalfDown)).ToString());

  try { DecimalFraction.FromString("3294222617760372E+273").Divide(DecimalFraction.FromString("245387447344"), null); Assert.Fail("Should have failed"); } catch (ArithmeticException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }

  Assert.AreEqual("-1E+9", DecimalFraction.FromString("-3744497146328885463.2861367").Divide(DecimalFraction.FromString("4268082102.25598248731603196"), 9, new PrecisionContext(Rounding.Floor)).ToString());

  try { DecimalFraction.FromString("-8314815473E+86").Divide(DecimalFraction.FromString("87033948310"), null); Assert.Fail("Should have failed"); } catch (ArithmeticException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }

  try { DecimalFraction.FromString("-875284001").Divide(DecimalFraction.FromString("-346.5763532222312"), null); Assert.Fail("Should have failed"); } catch (ArithmeticException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }

  try { DecimalFraction.FromString("1849179559946929").Divide(DecimalFraction.FromString("-83127597.76"), null); Assert.Fail("Should have failed"); } catch (ArithmeticException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }

  try { DecimalFraction.FromString("67104548543616240660E+177").Divide(DecimalFraction.FromString("-205830.34932E+282"), null); Assert.Fail("Should have failed"); } catch (ArithmeticException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }

  try { DecimalFraction.FromString("1075363036").DivideToIntegerNaturalScale(DecimalFraction.FromString("-1.136697052603835675E-30"), new PrecisionContext(23, Rounding.Unnecessary)); Assert.Fail("Should have failed"); } catch (ArithmeticException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }

  Assert.AreEqual("-1.271521410051950E-42", DecimalFraction.FromString("9500663500216.70168E-35").Divide(DecimalFraction.FromString("-74718863757304223868"), new PrecisionContext(16, Rounding.HalfUp)).ToString());

  Assert.AreEqual("-5.955926146515783204288266E+276", DecimalFraction.FromString("-10E+279").Divide(DecimalFraction.FromString("1679"), new PrecisionContext(25, Rounding.Down)).ToString());

  Assert.AreEqual("1E+47", DecimalFraction.FromString("-8936325148723.75413099744E-155").Divide(DecimalFraction.FromString("-196050334"), 47, new PrecisionContext(Rounding.Ceiling)).ToString());

  Assert.AreEqual("-4.3159320947474915845049076004245111033378786346889E-66", DecimalFraction.FromString("236805305109326857.01081E+73").Divide(DecimalFraction.FromString("-5486770.873840206126E+149"), new PrecisionContext(50, Rounding.Down)).ToString());

  try { DecimalFraction.FromString("8764154").Divide(DecimalFraction.FromString("-58879505.7448464446572400313E+273"), null); Assert.Fail("Should have failed"); } catch (ArithmeticException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }

  try { DecimalFraction.FromString("690858977725.11930E-130").Divide(DecimalFraction.FromString("-34612437741353074408.235198557248998445E-7"), null); Assert.Fail("Should have failed"); } catch (ArithmeticException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }

  Assert.AreEqual("0E+19", DecimalFraction.FromString("-4").Divide(DecimalFraction.FromString("96"), 19, new PrecisionContext(Rounding.HalfEven)).ToString());

  try { DecimalFraction.FromString("80914").Divide(DecimalFraction.FromString("-7444537792535655E+128"), null); Assert.Fail("Should have failed"); } catch (ArithmeticException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }

  Assert.AreEqual("5.3561715184858927979852711229811E-17", DecimalFraction.FromString("-489").Divide(DecimalFraction.FromString("-9129655357605739431"), new PrecisionContext(32, Rounding.Ceiling)).ToString());

  Assert.AreEqual("-866812993", DecimalFraction.FromString("-859472820841491").DivideToIntegerNaturalScale(DecimalFraction.FromString("991532"), new PrecisionContext(30, Rounding.Unnecessary)).ToString());

  try { DecimalFraction.FromString("244.57055588551159078542E+16").Divide(DecimalFraction.FromString("-594206679765786816E-12"), null); Assert.Fail("Should have failed"); } catch (ArithmeticException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }

  Assert.AreEqual("13333333333333333333333333333333333333333333333333333333333333333333333333333333333333333333333333333333333333333333333333333333333333.33333333333333333333333333333", DecimalFraction.FromString("-8E+133").Divide(DecimalFraction.FromString("-6"), -29, new PrecisionContext(Rounding.HalfDown)).ToString());

  Assert.AreEqual("0", DecimalFraction.FromString("30310").DivideToIntegerNaturalScale(DecimalFraction.FromString("-5560771953"), new PrecisionContext(50, Rounding.Unnecessary)).ToString());

  try { DecimalFraction.FromString("48593123.340608").Divide(DecimalFraction.FromString("-78742398.6236117567411588246E-278"), null); Assert.Fail("Should have failed"); } catch (ArithmeticException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }

  Assert.AreEqual("-13748386841", DecimalFraction.FromString("9940083686099").DivideToIntegerNaturalScale(DecimalFraction.FromString("-723"), new PrecisionContext(43, Rounding.Unnecessary)).ToString());

  try { DecimalFraction.FromString("1754250660495").DivideToIntegerNaturalScale(DecimalFraction.FromString("8369459812166078.050709852515299E-258"), new PrecisionContext(28, Rounding.Unnecessary)); Assert.Fail("Should have failed"); } catch (ArithmeticException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }

  try { DecimalFraction.FromString("445540.80814223505179202").DivideToIntegerNaturalScale(DecimalFraction.FromString("-51466666469195902E-205"), new PrecisionContext(11, Rounding.Unnecessary)); Assert.Fail("Should have failed"); } catch (ArithmeticException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }

  try { DecimalFraction.FromString("-3890705.7841233").Divide(DecimalFraction.FromString("7601454734E+179"), null); Assert.Fail("Should have failed"); } catch (ArithmeticException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }

  try { DecimalFraction.FromString("7158336806323E-340").Divide(DecimalFraction.FromString("447534636549712011"), null); Assert.Fail("Should have failed"); } catch (ArithmeticException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }

  Assert.AreEqual("-1.8654595436458E+230", DecimalFraction.FromString("-9484119510780198.060897824592404326E+229").Divide(DecimalFraction.FromString("508406603782183"), new PrecisionContext(14, Rounding.HalfDown)).ToString());

  Assert.AreEqual("8.", DecimalFraction.FromString("-79828558.39407197701948070325E+221").Divide(DecimalFraction.FromString("-8.90E-140"), 6, new PrecisionContext(Rounding.HalfUp)).ToString());

  try { DecimalFraction.FromString("10").Divide(DecimalFraction.FromString("-750063.6137365464782181"), null); Assert.Fail("Should have failed"); } catch (ArithmeticException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }

  try { DecimalFraction.FromString("3765517974015841137E-96").Divide(DecimalFraction.FromString("11849E+208"), null); Assert.Fail("Should have failed"); } catch (ArithmeticException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }

  try { DecimalFraction.FromString("-56472918392188014722.05514998587760").Divide(DecimalFraction.FromString("826176E+141"), null); Assert.Fail("Should have failed"); } catch (ArithmeticException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }

  Assert.AreEqual("5.3130729E+503", DecimalFraction.FromString("-10626.1458E+333").Divide(DecimalFraction.FromString("-2E-167"), new PrecisionContext(41, Rounding.Up)).ToString());

  try { DecimalFraction.FromString("-6104516773338920431.319794391265E-232").Divide(DecimalFraction.FromString("88501780765893814.85792434134173"), null); Assert.Fail("Should have failed"); } catch (ArithmeticException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }

  try { DecimalFraction.FromString("-44766548892692600").Divide(DecimalFraction.FromString("-5166250025.759E+177"), null); Assert.Fail("Should have failed"); } catch (ArithmeticException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }

  try { DecimalFraction.FromString("960918768").Divide(DecimalFraction.FromString("-432997E-15"), null); Assert.Fail("Should have failed"); } catch (ArithmeticException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }

  try { DecimalFraction.FromString("-2881449067768519233.4374027465748E-225").Divide(DecimalFraction.FromString("3.3702101117216602E+29"), null); Assert.Fail("Should have failed"); } catch (ArithmeticException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }

  try { DecimalFraction.FromString("-8536722661785382E-308").Divide(DecimalFraction.FromString("-9876424915616791049"), null); Assert.Fail("Should have failed"); } catch (ArithmeticException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }

  try { DecimalFraction.FromString("-8742367").Divide(DecimalFraction.FromString("7405076517839634.0"), null); Assert.Fail("Should have failed"); } catch (ArithmeticException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }

  try { DecimalFraction.FromString("-7749797767051.3064162693E+116").Divide(DecimalFraction.FromString("71510921524E+202"), new PrecisionContext(6, Rounding.Unnecessary)); Assert.Fail("Should have failed"); } catch (ArithmeticException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }

  Assert.AreEqual("0E-185", DecimalFraction.FromString("-3440473557E-166").DivideToIntegerNaturalScale(DecimalFraction.FromString("-93290022200532462553E+19"), new PrecisionContext(43, Rounding.Unnecessary)).ToString());

  Assert.AreEqual("0E-254", DecimalFraction.FromString("58430407").DivideToIntegerNaturalScale(DecimalFraction.FromString("857290216.51532086341277595E+271"), new PrecisionContext(3, Rounding.Unnecessary)).ToString());

  Assert.AreEqual("9.314748208124558778796308275510677528E+210", DecimalFraction.FromString("738705276E+205").Divide(DecimalFraction.FromString("793.0491082471586194433"), new PrecisionContext(37, Rounding.Ceiling)).ToString());

  try { DecimalFraction.FromString("-875953308725E-211").Divide(DecimalFraction.FromString("14.904893170E+60"), null); Assert.Fail("Should have failed"); } catch (ArithmeticException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }

  Assert.AreEqual("0E-233", DecimalFraction.FromString("9062264451E+77").DivideToIntegerNaturalScale(DecimalFraction.FromString("-4175423426622991.83021773103548236772E+330"), new PrecisionContext(14, Rounding.Unnecessary)).ToString());

  Assert.AreEqual("0E+36", DecimalFraction.FromString("-11927.61E-45").Divide(DecimalFraction.FromString("-41694151.79"), 36, new PrecisionContext(Rounding.Floor)).ToString());

  try { DecimalFraction.FromString("82054").Divide(DecimalFraction.FromString("47923"), null); Assert.Fail("Should have failed"); } catch (ArithmeticException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }

  Assert.AreEqual("1.878192886539191579996843596674026354667E+226", DecimalFraction.FromString("5633734803889595924.9224725E-21").Divide(DecimalFraction.FromString("2999550708697692E-244"), new PrecisionContext(40, Rounding.Ceiling)).ToString());

  Assert.AreEqual("6.66490403297034E+369", DecimalFraction.FromString("655739E+102").Divide(DecimalFraction.FromString("98386863E-270"), new PrecisionContext(15, Rounding.HalfDown)).ToString());

  try { DecimalFraction.FromString("-35703607822842365259.525949286527E-349").Divide(DecimalFraction.FromString("2115842066632664824E+223"), null); Assert.Fail("Should have failed"); } catch (ArithmeticException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }

  Assert.AreEqual("8.26903525232E-217", DecimalFraction.FromString("5704353665538500437E-137").Divide(DecimalFraction.FromString("689845126E+89"), new PrecisionContext(12, Rounding.HalfDown)).ToString());

  try { DecimalFraction.FromString("2535").DivideToIntegerNaturalScale(DecimalFraction.FromString("-915446E-190"), new PrecisionContext(36, Rounding.Unnecessary)); Assert.Fail("Should have failed"); } catch (ArithmeticException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }

  Assert.AreEqual("0E-134", DecimalFraction.FromString("4247876123712743496.60673348159985979448").DivideToIntegerNaturalScale(DecimalFraction.FromString("-1784E+114"), new PrecisionContext(5, Rounding.Unnecessary)).ToString());

  Assert.AreEqual("-1243290641668958", DecimalFraction.FromString("-11224316016829611E+5").DivideToIntegerNaturalScale(DecimalFraction.FromString("902791"), new PrecisionContext(26, Rounding.Unnecessary)).ToString());

  try { DecimalFraction.FromString("247").Divide(DecimalFraction.FromString("709474513E-336"), null); Assert.Fail("Should have failed"); } catch (ArithmeticException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }

  try { DecimalFraction.FromString("-249499226533319.56396818527233").Divide(DecimalFraction.FromString("496507199511164"), new PrecisionContext(42, Rounding.Unnecessary)); Assert.Fail("Should have failed"); } catch (ArithmeticException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }

  try { DecimalFraction.FromString("8.69104223324633").Divide(DecimalFraction.FromString("559588758313561.03640479"), null); Assert.Fail("Should have failed"); } catch (ArithmeticException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }

  try { DecimalFraction.FromString("-92E+136").Divide(DecimalFraction.FromString("-70882758080445002216.80042038489162808"), null); Assert.Fail("Should have failed"); } catch (ArithmeticException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }

  Assert.AreEqual("-5.7034836131263785966177659950079431492784797692393397141585561850024061122757455317432250666541962345432046745714607594410283397801779765052556107826109643097999649698567047479708857378632190188995934485799339593502453282542365653029052098237659E+267", DecimalFraction.FromString("-34388E+271").Divide(DecimalFraction.FromString("60292975.89434141122"), 23, new PrecisionContext(Rounding.Floor)).ToString());

  try { DecimalFraction.FromString("23435E+252").Divide(DecimalFraction.FromString("-1112467607244399.31631062489271676745"), null); Assert.Fail("Should have failed"); } catch (ArithmeticException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }

  Assert.AreEqual("-1E-17", DecimalFraction.FromString("-20959457984E+88").Divide(DecimalFraction.FromString("381.700845E+158"), -17, new PrecisionContext(Rounding.Floor)).ToString());

  try { DecimalFraction.FromString("48778559E+150").DivideToIntegerNaturalScale(DecimalFraction.FromString("1774.5018171824932210045E-3"), new PrecisionContext(32, Rounding.Unnecessary)); Assert.Fail("Should have failed"); } catch (ArithmeticException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }

  try { DecimalFraction.FromString("-822286.2920916877").Divide(DecimalFraction.FromString("-9952720632.003022906567603"), null); Assert.Fail("Should have failed"); } catch (ArithmeticException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }

  Assert.AreEqual("0E-90", DecimalFraction.FromString("-46444554E-65").DivideToIntegerNaturalScale(DecimalFraction.FromString("-775.86599532751718E+39"), new PrecisionContext(30, Rounding.Unnecessary)).ToString());

  Assert.AreEqual("215186.715241741367378372017", DecimalFraction.FromString("-184697770306").Divide(DecimalFraction.FromString("-858314"), new PrecisionContext(27, Rounding.Down)).ToString());

  Assert.AreEqual("0E-261", DecimalFraction.FromString("68023624").DivideToIntegerNaturalScale(DecimalFraction.FromString("881008335765698754E+261"), new PrecisionContext(49, Rounding.Unnecessary)).ToString());

  try { DecimalFraction.FromString("2072440.06434201002343").Divide(DecimalFraction.FromString("-77014929638020E+147"), null); Assert.Fail("Should have failed"); } catch (ArithmeticException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }

  try { DecimalFraction.FromString("-208912017462.22826032724168956E-323").Divide(DecimalFraction.FromString("30464107.84110"), null); Assert.Fail("Should have failed"); } catch (ArithmeticException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }

  Assert.AreEqual("-.08231517168764776508464179665261390726734438780", DecimalFraction.FromString("-99023575431687428.706116625726354815E+265").Divide(DecimalFraction.FromString("138234224129.9324551344285604"), -47, new PrecisionContext(Rounding.HalfDown)).ToString());

  Assert.AreEqual("0E-27", DecimalFraction.FromString("841728.872938107063").DivideToIntegerNaturalScale(DecimalFraction.FromString("-9E+15"), new PrecisionContext(18, Rounding.Unnecessary)).ToString());

  try { DecimalFraction.FromString("23518885406465295").Divide(DecimalFraction.FromString("30123.38"), null); Assert.Fail("Should have failed"); } catch (ArithmeticException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }

  Assert.AreEqual("0E-269", DecimalFraction.FromString("5.9E-271").DivideToIntegerNaturalScale(DecimalFraction.FromString("-928320712599399.740"), new PrecisionContext(13, Rounding.Unnecessary)).ToString());

  try { DecimalFraction.FromString("-6").Divide(DecimalFraction.FromString("-93032.667706275"), null); Assert.Fail("Should have failed"); } catch (ArithmeticException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }

  try { DecimalFraction.FromString("-9051078928912323105.889162497125506E-236").Divide(DecimalFraction.FromString("186021991100185"), null); Assert.Fail("Should have failed"); } catch (ArithmeticException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }

  try { DecimalFraction.FromString("634.0848669E+167").Divide(DecimalFraction.FromString("35.38332155047962840341"), null); Assert.Fail("Should have failed"); } catch (ArithmeticException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }

  try { DecimalFraction.FromString("5887234169.89964510").Divide(DecimalFraction.FromString("-306516008874.55688751737128245108E-150"), null); Assert.Fail("Should have failed"); } catch (ArithmeticException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }

  try { DecimalFraction.FromString("667771059752877196.98E-103").Divide(DecimalFraction.FromString("310614170E-139"), null); Assert.Fail("Should have failed"); } catch (ArithmeticException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }

  try { DecimalFraction.FromString("-67931529963.47015723672286294").Divide(DecimalFraction.FromString("410961.672040"), null); Assert.Fail("Should have failed"); } catch (ArithmeticException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }

  Assert.AreEqual("0.0000", DecimalFraction.FromString("4.0585").DivideToIntegerNaturalScale(DecimalFraction.FromString("407435"), new PrecisionContext(52, Rounding.Unnecessary)).ToString());

  Assert.AreEqual("0E-107", DecimalFraction.FromString("8").DivideToIntegerNaturalScale(DecimalFraction.FromString("-5E+107"), new PrecisionContext(10, Rounding.Unnecessary)).ToString());

  try { DecimalFraction.FromString("-35046E-4").Divide(DecimalFraction.FromString("297.08462012E+51"), null); Assert.Fail("Should have failed"); } catch (ArithmeticException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }

  Assert.AreEqual("7.730032908459620863771684757385232300496371E+306", DecimalFraction.FromString("-76317.402521604830911").Divide(DecimalFraction.FromString("-987284315932.01008155696361482810E-314"), new PrecisionContext(43, Rounding.Up)).ToString());

  Assert.AreEqual("0E-461", DecimalFraction.FromString("-654228199956E-296").DivideToIntegerNaturalScale(DecimalFraction.FromString("-74731229386218.3975511879261563E+181"), new PrecisionContext(49, Rounding.Unnecessary)).ToString());

  Assert.AreEqual("-6.41675E-209", DecimalFraction.FromString("513.34E-209").Divide(DecimalFraction.FromString("-80"), null).ToString());

  try { DecimalFraction.FromString("883789670324").Divide(DecimalFraction.FromString("667061997442.34E-152"), null); Assert.Fail("Should have failed"); } catch (ArithmeticException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }

  try { DecimalFraction.FromString("-28061.603921").Divide(DecimalFraction.FromString("-2046647E-223"), null); Assert.Fail("Should have failed"); } catch (ArithmeticException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }

  Assert.AreEqual("-0.0364787", DecimalFraction.FromString("28181672795299").Divide(DecimalFraction.FromString("-772551819831695.76368889497454657"), new PrecisionContext(6, Rounding.HalfUp)).ToString());

  try { DecimalFraction.FromString("809392.548556444419458113").Divide(DecimalFraction.FromString("589.15639575554"), null); Assert.Fail("Should have failed"); } catch (ArithmeticException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }

  try { DecimalFraction.FromString("-616529593073737").DivideToIntegerNaturalScale(DecimalFraction.FromString("-88083969051784724564E-343"), new PrecisionContext(35, Rounding.Unnecessary)); Assert.Fail("Should have failed"); } catch (ArithmeticException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }

  Assert.AreEqual("-812.8385614", DecimalFraction.FromString("-812.8385614715570470").Divide(DecimalFraction.FromString("1"), new PrecisionContext(10, Rounding.Down)).ToString());

  try { DecimalFraction.FromString("49456368E+41").Divide(DecimalFraction.FromString("-78436766242.159"), null); Assert.Fail("Should have failed"); } catch (ArithmeticException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }

  try { DecimalFraction.FromString("-47492992536514781438.7746072506").Divide(DecimalFraction.FromString("1.57608637817899781644"), null); Assert.Fail("Should have failed"); } catch (ArithmeticException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }

  Assert.AreEqual("0E+2", DecimalFraction.FromString("-63353016457886667742E-263").Divide(DecimalFraction.FromString("-738412E+151"), 2, new PrecisionContext(Rounding.HalfDown)).ToString());

  try { DecimalFraction.FromString("-7212.555461491E-187").Divide(DecimalFraction.FromString("816966"), null); Assert.Fail("Should have failed"); } catch (ArithmeticException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }

  try { DecimalFraction.FromString("847272157398E-6").Divide(DecimalFraction.FromString("-491443636031232.20997801961128783E+187"), null); Assert.Fail("Should have failed"); } catch (ArithmeticException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }

  try { DecimalFraction.FromString("47084975140408907.20729762455E+133").Divide(DecimalFraction.FromString("7729200E+212"), null); Assert.Fail("Should have failed"); } catch (ArithmeticException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }

  try { DecimalFraction.FromString("758982450004").Divide(DecimalFraction.FromString("-6401E+312"), null); Assert.Fail("Should have failed"); } catch (ArithmeticException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }

  Assert.AreEqual("-2.7900927666839957403009074280342531222061E-17", DecimalFraction.FromString("-20").Divide(DecimalFraction.FromString("716822044012889561.15711959"), new PrecisionContext(41, Rounding.HalfDown)).ToString());

  try { DecimalFraction.FromString("195993").DivideToIntegerNaturalScale(DecimalFraction.FromString("8435808326144778318E-78"), new PrecisionContext(44, Rounding.Unnecessary)); Assert.Fail("Should have failed"); } catch (ArithmeticException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }

  try { DecimalFraction.FromString("-2722138138458783.6919326062646554568E+285").Divide(DecimalFraction.FromString("4923593389671.3598488130468602"), null); Assert.Fail("Should have failed"); } catch (ArithmeticException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }

  Assert.AreEqual("0E-29", DecimalFraction.FromString("-5525611132249.9597225034E+25").DivideToIntegerNaturalScale(DecimalFraction.FromString("2E+44"), new PrecisionContext(33, Rounding.Unnecessary)).ToString());

  Assert.AreEqual("-504.0000", DecimalFraction.FromString("-3533672006979167.5308").DivideToIntegerNaturalScale(DecimalFraction.FromString("7010610980226"), new PrecisionContext(28, Rounding.Unnecessary)).ToString());

  Assert.AreEqual("0.02823477746093814323405637796", DecimalFraction.FromString("25545734748").Divide(DecimalFraction.FromString("904761327881.6047832173"), -29, new PrecisionContext(Rounding.Ceiling)).ToString());

  Assert.AreEqual("8.5988380580364865007976310978589025820195205470227E-59", DecimalFraction.FromString("-7606746220334.04359045319656611").Divide(DecimalFraction.FromString("-8846248957119E+58"), new PrecisionContext(50, Rounding.HalfDown)).ToString());

  Assert.AreEqual("0E-272", DecimalFraction.FromString("-75540340122E-209").DivideToIntegerNaturalScale(DecimalFraction.FromString("-37095800E+63"), new PrecisionContext(46, Rounding.Unnecessary)).ToString());

  try { DecimalFraction.FromString("-34459563249743634342").Divide(DecimalFraction.FromString("-1.0833E-50"), null); Assert.Fail("Should have failed"); } catch (ArithmeticException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }

  try { DecimalFraction.FromString("-6937046437034923").Divide(DecimalFraction.FromString("-91235"), null); Assert.Fail("Should have failed"); } catch (ArithmeticException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }

  Assert.AreEqual("-7.0584273275345028757E-163", DecimalFraction.FromString("-39159123457560203E-160").Divide(DecimalFraction.FromString("5547853883088489740.798270722200"), new PrecisionContext(20, Rounding.HalfDown)).ToString());

  try { DecimalFraction.FromString("-70").Divide(DecimalFraction.FromString("7549985807607808903.07762E-41"), null); Assert.Fail("Should have failed"); } catch (ArithmeticException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }

  try { DecimalFraction.FromString("265175879.674464384173E+203").Divide(DecimalFraction.FromString("1850008587.85975"), null); Assert.Fail("Should have failed"); } catch (ArithmeticException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }

  try { DecimalFraction.FromString("-345").Divide(DecimalFraction.FromString("465798569234.5225020"), null); Assert.Fail("Should have failed"); } catch (ArithmeticException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }

  Assert.AreEqual("73150745209904691016377760388567851794155084509311437770753200489061245583294932442310641594171190592028259351444269509620948782512727495294265357079.09750988450", DecimalFraction.FromString("68019470.12612793200875934E+156").Divide(DecimalFraction.FromString("929853413399239.3184603633882660"), -11, new PrecisionContext(Rounding.HalfEven)).ToString());

  try { DecimalFraction.FromString("-8394558").DivideToIntegerNaturalScale(DecimalFraction.FromString("-706621095382329078E-144"), new PrecisionContext(14, Rounding.Unnecessary)); Assert.Fail("Should have failed"); } catch (ArithmeticException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }

  Assert.AreEqual("0E-630", DecimalFraction.FromString("-349500328442.86800E-323").DivideToIntegerNaturalScale(DecimalFraction.FromString("80210E+302"), new PrecisionContext(18, Rounding.Unnecessary)).ToString());

  try { DecimalFraction.FromString("-595653402426443626").DivideToIntegerNaturalScale(DecimalFraction.FromString("-94824.960342413060509664"), new PrecisionContext(7, Rounding.Unnecessary)); Assert.Fail("Should have failed"); } catch (ArithmeticException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }

  try { DecimalFraction.FromString("-8719957738724853795E+160").Divide(DecimalFraction.FromString("35.69010582252048"), null); Assert.Fail("Should have failed"); } catch (ArithmeticException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }

  try { DecimalFraction.FromString("-572525996897579653").Divide(DecimalFraction.FromString("-6600602259201.88714E-134"), null); Assert.Fail("Should have failed"); } catch (ArithmeticException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }

  Assert.AreEqual("1.66292469E+163", DecimalFraction.FromString("-78447657").Divide(DecimalFraction.FromString("-4717451E-162"), new PrecisionContext(9, Rounding.Ceiling)).ToString());

  Assert.AreEqual("4.", DecimalFraction.FromString("12886178426478413.73022E+275").Divide(DecimalFraction.FromString("3204"), 22, new PrecisionContext(Rounding.HalfDown)).ToString());

  Assert.AreEqual("0E-323", DecimalFraction.FromString("-910738129511.666479772325074866E-63").DivideToIntegerNaturalScale(DecimalFraction.FromString("1395E+242"), new PrecisionContext(9, Rounding.Unnecessary)).ToString());

  try { DecimalFraction.FromString("-8623606950512722195.9").Divide(DecimalFraction.FromString("26"), null); Assert.Fail("Should have failed"); } catch (ArithmeticException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }

  Assert.AreEqual("1.104955891453606922007510077052564E-522", DecimalFraction.FromString("-8293705E-287").Divide(DecimalFraction.FromString("-7505915E+235"), new PrecisionContext(34, Rounding.Down)).ToString());

  try { DecimalFraction.FromString("81660644162.431391753292479931E+191").DivideToIntegerNaturalScale(DecimalFraction.FromString("-184830230.228636093257017"), new PrecisionContext(6, Rounding.Unnecessary)); Assert.Fail("Should have failed"); } catch (ArithmeticException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }

  try { DecimalFraction.FromString("-61897091914E+251").DivideToIntegerNaturalScale(DecimalFraction.FromString("-99519432.64386099906"), new PrecisionContext(17, Rounding.Unnecessary)); Assert.Fail("Should have failed"); } catch (ArithmeticException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }

  try { DecimalFraction.FromString("68").Divide(DecimalFraction.FromString("831228257314120697E-235"), null); Assert.Fail("Should have failed"); } catch (ArithmeticException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }

  try { DecimalFraction.FromString("-37359253493426.839584E+349").Divide(DecimalFraction.FromString("5980749885"), null); Assert.Fail("Should have failed"); } catch (ArithmeticException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }

  Assert.AreEqual("-1E+32", DecimalFraction.FromString("2819751738").Divide(DecimalFraction.FromString("-380712663242199"), 32, new PrecisionContext(Rounding.Floor)).ToString());

  try { DecimalFraction.FromString("-173148928487154.9447E-190").Divide(DecimalFraction.FromString("-437732.4166875673550207E+188"), null); Assert.Fail("Should have failed"); } catch (ArithmeticException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }

  Assert.AreEqual("-0.0000523547568562099303900073156685654806041", DecimalFraction.FromString("314").Divide(DecimalFraction.FromString("-5997544.805"), -43, new PrecisionContext(Rounding.Ceiling)).ToString());

  Assert.AreEqual("0E-263", DecimalFraction.FromString("7124000798873218285.018E-260").DivideToIntegerNaturalScale(DecimalFraction.FromString("8777964263053"), new PrecisionContext(23, Rounding.Unnecessary)).ToString());

  Assert.AreEqual("6.", DecimalFraction.FromString("-509918197829173111E+344").Divide(DecimalFraction.FromString("-76129"), 22, new PrecisionContext(Rounding.HalfUp)).ToString());

  try { DecimalFraction.FromString("227698755.1E+166").Divide(DecimalFraction.FromString("-1475679E-111"), null); Assert.Fail("Should have failed"); } catch (ArithmeticException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }

  Assert.AreEqual("0E-334", DecimalFraction.FromString("-678.9697740E-260").DivideToIntegerNaturalScale(DecimalFraction.FromString("4.2505312791440E+80"), new PrecisionContext(35, Rounding.Unnecessary)).ToString());

  Assert.AreEqual("-.535828005917172979037513893965868304", DecimalFraction.FromString("1").Divide(DecimalFraction.FromString("-1343209E-277"), -36, new PrecisionContext(Rounding.Down)).ToString());

  Assert.AreEqual("-4.0961767762799263E-138", DecimalFraction.FromString("-2482042086821.3960449951496398").Divide(DecimalFraction.FromString("605.941154980020624E+147"), new PrecisionContext(17, Rounding.Up)).ToString());

  try { DecimalFraction.FromString("5710940650054556").Divide(DecimalFraction.FromString("542154445632783746.0835E+87"), null); Assert.Fail("Should have failed"); } catch (ArithmeticException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }

  Assert.AreEqual("0E-289", DecimalFraction.FromString("-839114113623E-289").DivideToIntegerNaturalScale(DecimalFraction.FromString("291361698007552814"), new PrecisionContext(14, Rounding.Unnecessary)).ToString());

  try { DecimalFraction.FromString("7.949578417").Divide(DecimalFraction.FromString("41294830"), null); Assert.Fail("Should have failed"); } catch (ArithmeticException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }

  Assert.AreEqual("1.380757236831E+171", DecimalFraction.FromString("-4.142271710493").DivideToIntegerNaturalScale(DecimalFraction.FromString("-3E-171"), new PrecisionContext(23, Rounding.Unnecessary)).ToString());

  Assert.AreEqual("-137666820151", DecimalFraction.FromString("826000920909").DivideToIntegerNaturalScale(DecimalFraction.FromString("-6"), new PrecisionContext(33, Rounding.Unnecessary)).ToString());

  Assert.AreEqual("0E-11", DecimalFraction.FromString("-333413923.7881792692").Divide(DecimalFraction.FromString("627340730866763120E+96"), -11, new PrecisionContext(Rounding.Ceiling)).ToString());

  Assert.AreEqual("0E+13", DecimalFraction.FromString("-9454401689E-109").Divide(DecimalFraction.FromString("-93471156621449069209.647411"), 13, new PrecisionContext(Rounding.Down)).ToString());

  try { DecimalFraction.FromString("59E-299").Divide(DecimalFraction.FromString("101750323"), null); Assert.Fail("Should have failed"); } catch (ArithmeticException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }

  Assert.AreEqual("50.860640287240420269305100904290274025", DecimalFraction.FromString("-3737224208328815526").Divide(DecimalFraction.FromString("-73479692493497482"), new PrecisionContext(38, Rounding.HalfEven)).ToString());

  try { DecimalFraction.FromString("-7188021105858618").Divide(DecimalFraction.FromString("-9510018423639421245.3361E-50"), new PrecisionContext(49, Rounding.Unnecessary)); Assert.Fail("Should have failed"); } catch (ArithmeticException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }

  Assert.AreEqual("-1.47472106107E+287", DecimalFraction.FromString("8304E+296").Divide(DecimalFraction.FromString("-5630895373520.17497013125747"), new PrecisionContext(12, Rounding.HalfDown)).ToString());

  Assert.AreEqual("-1.7080299235915815E-207", DecimalFraction.FromString("-900898162759479").Divide(DecimalFraction.FromString("5274487E+215"), new PrecisionContext(17, Rounding.Ceiling)).ToString());

  Assert.AreEqual("1.075648506817710007447028696112214542898119E+67", DecimalFraction.FromString("-72521150405212.8522E+41").Divide(DecimalFraction.FromString("-67420862805607E-26"), new PrecisionContext(43, Rounding.HalfEven)).ToString());

  try { DecimalFraction.FromString("-980E+23").Divide(DecimalFraction.FromString("25372843982297571962.2151069162855"), null); Assert.Fail("Should have failed"); } catch (ArithmeticException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }

  try { DecimalFraction.FromString("510213511009465068E-122").Divide(DecimalFraction.FromString("835122284.36131795"), null); Assert.Fail("Should have failed"); } catch (ArithmeticException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }

  Assert.AreEqual("-1.66797821280820348794238353032281264E+632", DecimalFraction.FromString("-3E+331").Divide(DecimalFraction.FromString("179858464395E-312"), new PrecisionContext(36, Rounding.HalfUp)).ToString());

  Assert.AreEqual("-.23719028145297089247053163338", DecimalFraction.FromString("-7788854681643755719").Divide(DecimalFraction.FromString("8314E-279"), -29, new PrecisionContext(Rounding.Down)).ToString());

  Assert.AreEqual("-0.000130374", DecimalFraction.FromString("79").Divide(DecimalFraction.FromString("-605953"), -9, new PrecisionContext(Rounding.Up)).ToString());

  try { DecimalFraction.FromString("-62028345317557E-125").Divide(DecimalFraction.FromString("-96060778052930281098"), null); Assert.Fail("Should have failed"); } catch (ArithmeticException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }

  Assert.AreEqual("-2.45732807E+298", DecimalFraction.FromString("-737198421E+290").Divide(DecimalFraction.FromString("3"), null).ToString());

  try { DecimalFraction.FromString("-59127.4146E-209").Divide(DecimalFraction.FromString("-7833960183E+198"), null); Assert.Fail("Should have failed"); } catch (ArithmeticException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }

  Assert.AreEqual("2.4478920745452197145891579124506836699098206130E-161", DecimalFraction.FromString("9604570035.87953274605965484209").Divide(DecimalFraction.FromString("392360845306626.2130116795343231425E+156"), new PrecisionContext(47, Rounding.Down)).ToString());

  try { DecimalFraction.FromString("-49245048784.36167800E-130").Divide(DecimalFraction.FromString("-1113753E-213"), null); Assert.Fail("Should have failed"); } catch (ArithmeticException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }

  try { DecimalFraction.FromString("454.6102326157675400").DivideToIntegerNaturalScale(DecimalFraction.FromString("39E-41"), new PrecisionContext(26, Rounding.Unnecessary)); Assert.Fail("Should have failed"); } catch (ArithmeticException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }

  try { DecimalFraction.FromString("95875523415796032.5899").Divide(DecimalFraction.FromString("-71481607.731"), -44, new PrecisionContext(Rounding.Unnecessary)); Assert.Fail("Should have failed"); } catch (ArithmeticException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }

  Assert.AreEqual("0", DecimalFraction.FromString("-457901").DivideToIntegerNaturalScale(DecimalFraction.FromString("-8512562754821"), new PrecisionContext(37, Rounding.Unnecessary)).ToString());

  try { DecimalFraction.FromString("54E+60").Divide(DecimalFraction.FromString("385834151488064"), null); Assert.Fail("Should have failed"); } catch (ArithmeticException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }

  Assert.AreEqual("0E-204", DecimalFraction.FromString("346980.368710E-198").DivideToIntegerNaturalScale(DecimalFraction.FromString("-31072262892537"), new PrecisionContext(22, Rounding.Unnecessary)).ToString());

  try { DecimalFraction.FromString("201098692216576498E+203").Divide(DecimalFraction.FromString("-91134023689817.9363E-281"), null); Assert.Fail("Should have failed"); } catch (ArithmeticException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }

  try { DecimalFraction.FromString("-61488282318608852408.96535277757783E-84").Divide(DecimalFraction.FromString("-79E-199"), null); Assert.Fail("Should have failed"); } catch (ArithmeticException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }

  try { DecimalFraction.FromString("925205443.1E+121").Divide(DecimalFraction.FromString("9993602E+126"), null); Assert.Fail("Should have failed"); } catch (ArithmeticException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }

  Assert.AreEqual("0E-334", DecimalFraction.FromString("32375909492.305780466187E-322").DivideToIntegerNaturalScale(DecimalFraction.FromString("1552"), new PrecisionContext(48, Rounding.Unnecessary)).ToString());

  try { DecimalFraction.FromString("195472727064.399213538432627").Divide(DecimalFraction.FromString("-35233462387053"), null); Assert.Fail("Should have failed"); } catch (ArithmeticException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }

  Assert.AreEqual("6.17E+191", DecimalFraction.FromString("4361.774").Divide(DecimalFraction.FromString("7064E-192"), new PrecisionContext(3, Rounding.HalfEven)).ToString());

  Assert.AreEqual("0E-219", DecimalFraction.FromString("-96684739586.5E-1").DivideToIntegerNaturalScale(DecimalFraction.FromString("2928399161555001.7409250E+224"), new PrecisionContext(22, Rounding.Unnecessary)).ToString());

  try { DecimalFraction.FromString("7198511330246836654").Divide(DecimalFraction.FromString("1113383549284125.3276"), null); Assert.Fail("Should have failed"); } catch (ArithmeticException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }

  Assert.AreEqual("-2530832856030442318300506528470787641158136154124043609461347884580589587334314743142352967650378924284478637591252589.3582", DecimalFraction.FromString("-10811450738121373.5E+121").Divide(DecimalFraction.FromString("42718944130822233685"), -4, new PrecisionContext(Rounding.Up)).ToString());

  Assert.AreEqual("1.086987314630753579372061513385894094007E-330", DecimalFraction.FromString("-759332281524001586E-85").Divide(DecimalFraction.FromString("-69.85659090069E+261"), new PrecisionContext(40, Rounding.HalfUp)).ToString());

  Assert.AreEqual("0E-296", DecimalFraction.FromString("-8105848807").DivideToIntegerNaturalScale(DecimalFraction.FromString("-27091628442E+296"), new PrecisionContext(17, Rounding.Unnecessary)).ToString());

  try { DecimalFraction.FromString("-59").Divide(DecimalFraction.FromString("-993152E-238"), null); Assert.Fail("Should have failed"); } catch (ArithmeticException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }

  Assert.AreEqual("-9.2444194525201983594198444473046488489E-25", DecimalFraction.FromString("5163686125848847465E-297").Divide(DecimalFraction.FromString("-558573326575E-266"), new PrecisionContext(38, Rounding.Ceiling)).ToString());

  try { DecimalFraction.FromString("-592.87379201798").Divide(DecimalFraction.FromString("862"), null); Assert.Fail("Should have failed"); } catch (ArithmeticException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }

  Assert.AreEqual("0E-27", DecimalFraction.FromString("-49905787790010").Divide(DecimalFraction.FromString("-228138693.1E+186"), -27, new PrecisionContext(Rounding.Floor)).ToString());

  Assert.AreEqual("-1.4293391342200064052606650239921905835E-359", DecimalFraction.FromString("-99445005137623790E-177").Divide(DecimalFraction.FromString("69574114887640821.4849714074976291528E+182"), new PrecisionContext(38, Rounding.Floor)).ToString());

  try { DecimalFraction.FromString("-7050545264660812").Divide(DecimalFraction.FromString("-91"), null); Assert.Fail("Should have failed"); } catch (ArithmeticException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }

  try { DecimalFraction.FromString("4261196136E-107").Divide(DecimalFraction.FromString("-5587958166142930073"), null); Assert.Fail("Should have failed"); } catch (ArithmeticException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }

  try { DecimalFraction.FromString("2177873155985").Divide(DecimalFraction.FromString("38320.959757257335"), null); Assert.Fail("Should have failed"); } catch (ArithmeticException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }

  try { DecimalFraction.FromString("-6966205343").Divide(DecimalFraction.FromString("22058734686522431.1544572181685430E-310"), null); Assert.Fail("Should have failed"); } catch (ArithmeticException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }

  Assert.AreEqual("0E-17", DecimalFraction.FromString("-6.236872E-11").DivideToIntegerNaturalScale(DecimalFraction.FromString("-515763120567"), new PrecisionContext(48, Rounding.Unnecessary)).ToString());

  Assert.AreEqual("0E-184", DecimalFraction.FromString("57481089279325670.03405325592789317").DivideToIntegerNaturalScale(DecimalFraction.FromString("167534308751434340.4E+168"), new PrecisionContext(4, Rounding.Unnecessary)).ToString());

  try { DecimalFraction.FromString("-6080238326114886.5807829530014798").Divide(DecimalFraction.FromString("4382112991776743.7724491636514607"), null); Assert.Fail("Should have failed"); } catch (ArithmeticException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }

  Assert.AreEqual("0E-30", DecimalFraction.FromString("81185285995658.7539151730709442E-165").Divide(DecimalFraction.FromString("-52358353114095762E-80"), -30, new PrecisionContext(Rounding.Down)).ToString());

  Assert.AreEqual("4.44561272466523826342718582559474725807443E-7", DecimalFraction.FromString("30488058161").Divide(DecimalFraction.FromString("68580103687047547.44569427"), new PrecisionContext(42, Rounding.Up)).ToString());

  try { DecimalFraction.FromString("6852125921158948E+166").Divide(DecimalFraction.FromString("-859576846440249.312220024"), null); Assert.Fail("Should have failed"); } catch (ArithmeticException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }

  try { DecimalFraction.FromString("-99.528338003E-239").Divide(DecimalFraction.FromString("322055690624740772E-222"), null); Assert.Fail("Should have failed"); } catch (ArithmeticException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }

  try { DecimalFraction.FromString("-6612005E-291").Divide(DecimalFraction.FromString("850954E-254"), null); Assert.Fail("Should have failed"); } catch (ArithmeticException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }

  try { DecimalFraction.FromString("-1866E+93").Divide(DecimalFraction.FromString("-838616"), null); Assert.Fail("Should have failed"); } catch (ArithmeticException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }

  try { DecimalFraction.FromString("-1").Divide(DecimalFraction.FromString("14392665097929.038763814138E-183"), null); Assert.Fail("Should have failed"); } catch (ArithmeticException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }

  Assert.AreEqual("0E-128", DecimalFraction.FromString("6255645.683856011353644E+144").DivideToIntegerNaturalScale(DecimalFraction.FromString("4277E+257"), new PrecisionContext(3, Rounding.Unnecessary)).ToString());

  try { DecimalFraction.FromString("-49497488214996857949E-283").Divide(DecimalFraction.FromString("-1.828507203107816E-271"), null); Assert.Fail("Should have failed"); } catch (ArithmeticException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }

  try { DecimalFraction.FromString("-41").Divide(DecimalFraction.FromString("-38021611855527.693294222053164"), null); Assert.Fail("Should have failed"); } catch (ArithmeticException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }

  try { DecimalFraction.FromString("64916509490617E-302").Divide(DecimalFraction.FromString("-2658524.985901233"), new PrecisionContext(27, Rounding.Unnecessary)); Assert.Fail("Should have failed"); } catch (ArithmeticException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }

  try { DecimalFraction.FromString("-51553107200639527").Divide(DecimalFraction.FromString("-201253070357"), 5, new PrecisionContext(Rounding.Unnecessary)); Assert.Fail("Should have failed"); } catch (ArithmeticException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }

  try { DecimalFraction.FromString("72284829545982535.77E+345").Divide(DecimalFraction.FromString("-4499867442E-94"), null); Assert.Fail("Should have failed"); } catch (ArithmeticException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }

  Assert.AreEqual("211427", DecimalFraction.FromString("-107682478250924719").DivideToIntegerNaturalScale(DecimalFraction.FromString("-509310730904.121635696027070"), new PrecisionContext(44, Rounding.Unnecessary)).ToString());

  Assert.AreEqual("0E-124", DecimalFraction.FromString("-88617058928020488.42E-122").DivideToIntegerNaturalScale(DecimalFraction.FromString("-172915224007542"), new PrecisionContext(29, Rounding.Unnecessary)).ToString());

  Assert.AreEqual("-206.0000000000000", DecimalFraction.FromString("94309556583212565.2072374249007").DivideToIntegerNaturalScale(DecimalFraction.FromString("-456259850813049"), new PrecisionContext(18, Rounding.Unnecessary)).ToString());

  Assert.AreEqual("0E-297", DecimalFraction.FromString("-73497.047457615527371E-300").DivideToIntegerNaturalScale(DecimalFraction.FromString("9403959774849.001351242421338471"), new PrecisionContext(10, Rounding.Unnecessary)).ToString());

  Assert.AreEqual("-2.057387119199338974853E+22", DecimalFraction.FromString("773317.99357898125051642E+29").DivideToIntegerNaturalScale(DecimalFraction.FromString("-3758738384052.52961484422539901122"), new PrecisionContext(52, Rounding.Unnecessary)).ToString());

  Assert.AreEqual("-4.519749165652840292796539677258359673931126268507735817667609382798203294E+103", DecimalFraction.FromString("27168212234739223").Divide(DecimalFraction.FromString("-6011E-91"), 31, new PrecisionContext(Rounding.HalfUp)).ToString());

  try { DecimalFraction.FromString("892460456048.022350019515158").Divide(DecimalFraction.FromString("-9060136714E-43"), new PrecisionContext(35, Rounding.Unnecessary)); Assert.Fail("Should have failed"); } catch (ArithmeticException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }

  try { DecimalFraction.FromString("17285503665E+60").DivideToIntegerNaturalScale(DecimalFraction.FromString("42580064.430920E-248"), new PrecisionContext(28, Rounding.Unnecessary)); Assert.Fail("Should have failed"); } catch (ArithmeticException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }

  try { DecimalFraction.FromString("42773871145.40609675852965516").Divide(DecimalFraction.FromString("18169601017481413.522285571199"), null); Assert.Fail("Should have failed"); } catch (ArithmeticException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }

  try { DecimalFraction.FromString("6323652E+32").Divide(DecimalFraction.FromString("-856767879752263565E+118"), null); Assert.Fail("Should have failed"); } catch (ArithmeticException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }

  try { DecimalFraction.FromString("4097245371399313168E-247").Divide(DecimalFraction.FromString("6046.794253191E+222"), null); Assert.Fail("Should have failed"); } catch (ArithmeticException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }
...
[TestMethod]
    public void TestSubtractNonFinite(){
      ...
      try { CBORObject.Subtract(CBORObject.FromObject(Double.NaN), CBORObject.FromObject(0.04503661680757691d)).AsDecimalFraction(); Assert.Fail("Should have failed");} catch (OverflowException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }
      try { CBORObject.Subtract(CBORObject.FromObject(Double.NaN), CBORObject.FromObject(DecimalFraction.FromString("961.056025725133"))).AsDecimalFraction(); Assert.Fail("Should have failed");} catch (OverflowException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }
      try { CBORObject.Subtract(CBORObject.FromObject(Double.NaN), CBORObject.FromObject(-2.66673f)).AsDecimalFraction(); Assert.Fail("Should have failed");} catch (OverflowException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }
      try { CBORObject.Subtract(CBORObject.FromObject(Double.NaN), CBORObject.FromObject(-3249200021658530613L)).AsDecimalFraction(); Assert.Fail("Should have failed");} catch (OverflowException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }
      try { CBORObject.Subtract(CBORObject.FromObject(Double.PositiveInfinity), CBORObject.FromObject(-3082676751896642153L)).AsDecimalFraction(); Assert.Fail("Should have failed");} catch (OverflowException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }
      try { CBORObject.Subtract(CBORObject.FromObject(Double.PositiveInfinity), CBORObject.FromObject(0.37447542485458996d)).AsDecimalFraction(); Assert.Fail("Should have failed");} catch (OverflowException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }
      try { CBORObject.Subtract(CBORObject.FromObject(Double.PositiveInfinity), CBORObject.FromObject(DecimalFraction.FromString("6695270"))).AsDecimalFraction(); Assert.Fail("Should have failed");} catch (OverflowException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }
      try { CBORObject.Subtract(CBORObject.FromObject(Double.PositiveInfinity), CBORObject.FromObject(8.645616f)).AsDecimalFraction(); Assert.Fail("Should have failed");} catch (OverflowException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }
      try { CBORObject.Subtract(CBORObject.FromObject(Double.PositiveInfinity), CBORObject.FromObject(10.918599534632621d)).AsDecimalFraction(); Assert.Fail("Should have failed");} catch (OverflowException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }
      try { CBORObject.Subtract(CBORObject.FromObject(Double.NegativeInfinity), CBORObject.FromObject(1.1195766122143437E-7d)).AsDecimalFraction(); Assert.Fail("Should have failed");} catch (OverflowException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }
      try { CBORObject.Subtract(CBORObject.FromObject(Double.NegativeInfinity), CBORObject.FromObject(-27.678854f)).AsDecimalFraction(); Assert.Fail("Should have failed");} catch (OverflowException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }
      try { CBORObject.Subtract(CBORObject.FromObject(Double.NegativeInfinity), CBORObject.FromObject(DecimalFraction.FromString("51444344646435.890"))).AsDecimalFraction(); Assert.Fail("Should have failed");} catch (OverflowException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }
      try { CBORObject.Subtract(CBORObject.FromObject(Double.NegativeInfinity), CBORObject.FromObject(DecimalFraction.FromString("-795755897.41124405443"))).AsDecimalFraction(); Assert.Fail("Should have failed");} catch (OverflowException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }
      try { CBORObject.Subtract(CBORObject.FromObject(Double.NegativeInfinity), CBORObject.FromObject(DecimalFraction.FromString("282349190160173.8945458982215192141"))).AsDecimalFraction(); Assert.Fail("Should have failed");} catch (OverflowException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }
      ...
      try { CBORObject.Subtract(CBORObject.FromObject(Single.NaN), CBORObject.FromObject(BigInteger.Parse("3037587108614072", NumberStyles.AllowLeadingSign, CultureInfo.InvariantCulture))).AsDecimalFraction(); Assert.Fail("Should have failed");} catch (OverflowException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }
      ...
      try { CBORObject.Subtract(CBORObject.FromObject(Single.NegativeInfinity), CBORObject.FromObject(BigInteger.Parse("06842884252556766213171069781", NumberStyles.AllowLeadingSign, CultureInfo.InvariantCulture))).AsDecimalFraction(); Assert.Fail("Should have failed");} catch (OverflowException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }
      ...
      try { CBORObject.Subtract(CBORObject.FromObject(Single.NegativeInfinity), CBORObject.FromObject(BigInteger.Parse("300921783316", NumberStyles.AllowLeadingSign, CultureInfo.InvariantCulture))).AsDecimalFraction(); Assert.Fail("Should have failed");} catch (OverflowException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }
      try { CBORObject.Subtract(CBORObject.FromObject(Single.NegativeInfinity), CBORObject.FromObject(BigInteger.Parse("-5806763724610384900094490266237212718", NumberStyles.AllowLeadingSign, CultureInfo.InvariantCulture))).AsDecimalFraction(); Assert.Fail("Should have failed");} catch (OverflowException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }
    }
    /// <summary>
    /// </summary>
    /// <returns>
      ...
      for(int i=0;i<1000;i++){
        ...
        for(int j=0;j<100;j++){
          if(j==0 || r.NextValue(2)==0){
            ...
            control+=x;
            mbi.Add(x);
            Assert.AreEqual(control,mbi.ToBigInteger());
          } else {
...
[TestMethod]
    public void TestDoubleToOther() {
      ...
      try { dbl1.AsInt16(); Assert.Fail("Should have failed");} catch (OverflowException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }
      try { dbl1.AsByte(); Assert.Fail("Should have failed");} catch (OverflowException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }
      ...
      try { dbl2.AsInt16(); Assert.Fail("Should have failed");} catch (OverflowException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }
      try { dbl2.AsByte(); Assert.Fail("Should have failed");} catch (OverflowException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }
