...
[TestFixture]
  public class CBORObjectMathTest{
    ...
    public void CBORMultiplyTest() {
      ...
      try { CBORObject.Multiply(CBORObject.FromObject(Double.NaN), CBORObject.FromObject(BigInteger.fromString("-11455275312320262539482205058"))).AsDecimalFraction(); Assert.Fail("Should have failed");} catch (OverflowException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }
      ...
      try { CBORObject.Multiply(CBORObject.FromObject(Double.PositiveInfinity), CBORObject.FromObject(BigInteger.fromString("0694747557297"))).AsDecimalFraction(); Assert.Fail("Should have failed");} catch (OverflowException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }
      ...
      try { CBORObject.Multiply(CBORObject.FromObject(Single.PositiveInfinity), CBORObject.FromObject(BigInteger.fromString("-57698063111489"))).AsDecimalFraction(); Assert.Fail("Should have failed");} catch (OverflowException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }
      ...
      try { CBORObject.Multiply(CBORObject.FromObject(Single.NegativeInfinity), CBORObject.FromObject(BigInteger.fromString("6741304989218497671449227825882685277187"))).AsDecimalFraction(); Assert.Fail("Should have failed");} catch (OverflowException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }
      try { CBORObject.Multiply(CBORObject.FromObject(Single.NegativeInfinity), CBORObject.FromObject(BigInteger.fromString("16890648775547279842225596545"))).AsDecimalFraction(); Assert.Fail("Should have failed");} catch (OverflowException) { } catch (Exception ex) { Assert.Fail(ex.ToString()); }
