...
namespace Test
{
	...
	public class CBORObjectMathTest
	{
		...
		public void CBORAdditionTest()
		{
			...
			Assert.Throws(typeof(OverflowException),()=>CBORObject.Addition(CBORObject.FromObject(Double.NaN),CBORObject.FromObject(3.5023837f)).AsDecimalFraction());
			Assert.Throws(typeof(OverflowException),()=>CBORObject.Addition(CBORObject.FromObject(Double.NaN),CBORObject.FromObject(3.812574964908644E-6d)).AsDecimalFraction());
			Assert.Throws(typeof(OverflowException),()=>CBORObject.Addition(CBORObject.FromObject(Double.NaN),CBORObject.FromObject(23.474629887387266d)).AsDecimalFraction());
			Assert.Throws(typeof(OverflowException),()=>CBORObject.Addition(CBORObject.FromObject(Double.NaN),CBORObject.FromObject(-166.82784f)).AsDecimalFraction());
			Assert.Throws(typeof(OverflowException),()=>CBORObject.Addition(CBORObject.FromObject(Double.NaN),CBORObject.FromObject(5.993239296979466E-10d)).AsDecimalFraction());
			Assert.Throws(typeof(OverflowException),()=>CBORObject.Addition(CBORObject.FromObject(Double.PositiveInfinity),CBORObject.FromObject(BigInteger.Parse("-043703874024659752541",NumberStyles.AllowLeadingSign,CultureInfo.InvariantCulture))).AsDecimalFraction());
			Assert.Throws(typeof(OverflowException),()=>CBORObject.Addition(CBORObject.FromObject(Double.PositiveInfinity),CBORObject.FromObject(0.23853742f)).AsDecimalFraction());
			Assert.Throws(typeof(OverflowException),()=>CBORObject.Addition(CBORObject.FromObject(Double.PositiveInfinity),CBORObject.FromObject(-164.26022f)).AsDecimalFraction());
			Assert.Throws(typeof(OverflowException),()=>CBORObject.Addition(CBORObject.FromObject(Double.PositiveInfinity),CBORObject.FromObject(BigInteger.Parse("-3454197004716216037476684",NumberStyles.AllowLeadingSign,CultureInfo.InvariantCulture))).AsDecimalFraction());
			Assert.Throws(typeof(OverflowException),()=>CBORObject.Addition(CBORObject.FromObject(Double.PositiveInfinity),CBORObject.FromObject(3.6649623f)).AsDecimalFraction());
			Assert.Throws(typeof(OverflowException),()=>CBORObject.Addition(CBORObject.FromObject(Double.NegativeInfinity),CBORObject.FromObject(4.920178f)).AsDecimalFraction());
			Assert.Throws(typeof(OverflowException),()=>CBORObject.Addition(CBORObject.FromObject(Double.NegativeInfinity),CBORObject.FromObject(DecimalFraction.FromString("-2775394107351658213.29237024329"))).AsDecimalFraction());
			Assert.Throws(typeof(OverflowException),()=>CBORObject.Addition(CBORObject.FromObject(Double.NegativeInfinity),CBORObject.FromObject(DecimalFraction.FromString("5354394.3316793E-16"))).AsDecimalFraction());
			Assert.Throws(typeof(OverflowException),()=>CBORObject.Addition(CBORObject.FromObject(Double.NegativeInfinity),CBORObject.FromObject(BigInteger.Parse("35",NumberStyles.AllowLeadingSign,CultureInfo.InvariantCulture))).AsDecimalFraction());
			Assert.Throws(typeof(OverflowException),()=>CBORObject.Addition(CBORObject.FromObject(Double.NegativeInfinity),CBORObject.FromObject(BigInteger.Parse("-724734631380034337",NumberStyles.AllowLeadingSign,CultureInfo.InvariantCulture))).AsDecimalFraction());
			Assert.Throws(typeof(OverflowException),()=>CBORObject.Addition(CBORObject.FromObject(Single.NaN),CBORObject.FromObject(-1.6585551286059796E-6d)).AsDecimalFraction());
			Assert.Throws(typeof(OverflowException),()=>CBORObject.Addition(CBORObject.FromObject(Single.NaN),CBORObject.FromObject(DecimalFraction.FromString("4470484868626699E-12"))).AsDecimalFraction());
			Assert.Throws(typeof(OverflowException),()=>CBORObject.Addition(CBORObject.FromObject(Single.NaN),CBORObject.FromObject(51.165462f)).AsDecimalFraction());
			Assert.Throws(typeof(OverflowException),()=>CBORObject.Addition(CBORObject.FromObject(Single.NaN),CBORObject.FromObject(-8526307050682317212L)).AsDecimalFraction());
			Assert.Throws(typeof(OverflowException),()=>CBORObject.Addition(CBORObject.FromObject(Single.NaN),CBORObject.FromObject(-5178277071860853800L)).AsDecimalFraction());
			Assert.Throws(typeof(OverflowException),()=>CBORObject.Addition(CBORObject.FromObject(Single.PositiveInfinity),CBORObject.FromObject(-4.501634965667704E-11d)).AsDecimalFraction());
			Assert.Throws(typeof(OverflowException),()=>CBORObject.Addition(CBORObject.FromObject(Single.PositiveInfinity),CBORObject.FromObject(DecimalFraction.FromString("-087829913964415877"))).AsDecimalFraction());
			Assert.Throws(typeof(OverflowException),()=>CBORObject.Addition(CBORObject.FromObject(Single.PositiveInfinity),CBORObject.FromObject(DecimalFraction.FromString("914.9E-19"))).AsDecimalFraction());
			Assert.Throws(typeof(OverflowException),()=>CBORObject.Addition(CBORObject.FromObject(Single.PositiveInfinity),CBORObject.FromObject(-0.10745481f)).AsDecimalFraction());
			Assert.Throws(typeof(OverflowException),()=>CBORObject.Addition(CBORObject.FromObject(Single.PositiveInfinity),CBORObject.FromObject(3624504802515453345L)).AsDecimalFraction());
			Assert.Throws(typeof(OverflowException),()=>CBORObject.Addition(CBORObject.FromObject(Single.NegativeInfinity),CBORObject.FromObject(8200506367764127039L)).AsDecimalFraction());
			Assert.Throws(typeof(OverflowException),()=>CBORObject.Addition(CBORObject.FromObject(Single.NegativeInfinity),CBORObject.FromObject(BigInteger.Parse("-3594433687266085256412604739746153",NumberStyles.AllowLeadingSign,CultureInfo.InvariantCulture))).AsDecimalFraction());
			Assert.Throws(typeof(OverflowException),()=>CBORObject.Addition(CBORObject.FromObject(Single.NegativeInfinity),CBORObject.FromObject(BigInteger.Parse("-75230249292446971480280879652518",NumberStyles.AllowLeadingSign,CultureInfo.InvariantCulture))).AsDecimalFraction());
			Assert.Throws(typeof(OverflowException),()=>CBORObject.Addition(CBORObject.FromObject(Single.NegativeInfinity),CBORObject.FromObject(1.9599492372504113E-13d)).AsDecimalFraction());
			Assert.Throws(typeof(OverflowException),()=>CBORObject.Addition(CBORObject.FromObject(Single.NegativeInfinity),CBORObject.FromObject(322.3261f)).AsDecimalFraction());
		}
		...
		public void CBORSubtractTest(){
			...
			Assert.Throws(typeof(OverflowException),()=>CBORObject.Subtract(CBORObject.FromObject(Double.NaN),CBORObject.FromObject(99.74439f)).AsDecimalFraction());
			Assert.Throws(typeof(OverflowException),()=>CBORObject.Subtract(CBORObject.FromObject(Double.NaN),CBORObject.FromObject(0.04503661680757691d)).AsDecimalFraction());
			Assert.Throws(typeof(OverflowException),()=>CBORObject.Subtract(CBORObject.FromObject(Double.NaN),CBORObject.FromObject(DecimalFraction.FromString("961.056025725133"))).AsDecimalFraction());
			Assert.Throws(typeof(OverflowException),()=>CBORObject.Subtract(CBORObject.FromObject(Double.NaN),CBORObject.FromObject(-2.66673f)).AsDecimalFraction());
			Assert.Throws(typeof(OverflowException),()=>CBORObject.Subtract(CBORObject.FromObject(Double.NaN),CBORObject.FromObject(-3249200021658530613L)).AsDecimalFraction());
			Assert.Throws(typeof(OverflowException),()=>CBORObject.Subtract(CBORObject.FromObject(Double.PositiveInfinity),CBORObject.FromObject(-3082676751896642153L)).AsDecimalFraction());
			Assert.Throws(typeof(OverflowException),()=>CBORObject.Subtract(CBORObject.FromObject(Double.PositiveInfinity),CBORObject.FromObject(0.37447542485458996d)).AsDecimalFraction());
			Assert.Throws(typeof(OverflowException),()=>CBORObject.Subtract(CBORObject.FromObject(Double.PositiveInfinity),CBORObject.FromObject(DecimalFraction.FromString("6695270"))).AsDecimalFraction());
			Assert.Throws(typeof(OverflowException),()=>CBORObject.Subtract(CBORObject.FromObject(Double.PositiveInfinity),CBORObject.FromObject(8.645616f)).AsDecimalFraction());
			Assert.Throws(typeof(OverflowException),()=>CBORObject.Subtract(CBORObject.FromObject(Double.PositiveInfinity),CBORObject.FromObject(10.918599534632621d)).AsDecimalFraction());
			Assert.Throws(typeof(OverflowException),()=>CBORObject.Subtract(CBORObject.FromObject(Double.NegativeInfinity),CBORObject.FromObject(1.1195766122143437E-7d)).AsDecimalFraction());
			Assert.Throws(typeof(OverflowException),()=>CBORObject.Subtract(CBORObject.FromObject(Double.NegativeInfinity),CBORObject.FromObject(-27.678854f)).AsDecimalFraction());
			Assert.Throws(typeof(OverflowException),()=>CBORObject.Subtract(CBORObject.FromObject(Double.NegativeInfinity),CBORObject.FromObject(DecimalFraction.FromString("51444344646435.890"))).AsDecimalFraction());
			Assert.Throws(typeof(OverflowException),()=>CBORObject.Subtract(CBORObject.FromObject(Double.NegativeInfinity),CBORObject.FromObject(DecimalFraction.FromString("-795755897.41124405443"))).AsDecimalFraction());
			Assert.Throws(typeof(OverflowException),()=>CBORObject.Subtract(CBORObject.FromObject(Double.NegativeInfinity),CBORObject.FromObject(DecimalFraction.FromString("282349190160173.8945458982215192141"))).AsDecimalFraction());
			Assert.Throws(typeof(OverflowException),()=>CBORObject.Subtract(CBORObject.FromObject(Single.NaN),CBORObject.FromObject(-4742894673080640195L)).AsDecimalFraction());
			Assert.Throws(typeof(OverflowException),()=>CBORObject.Subtract(CBORObject.FromObject(Single.NaN),CBORObject.FromObject(-8.057984695058738E-10d)).AsDecimalFraction());
			Assert.Throws(typeof(OverflowException),()=>CBORObject.Subtract(CBORObject.FromObject(Single.NaN),CBORObject.FromObject(-6832707275063219586L)).AsDecimalFraction());
			Assert.Throws(typeof(OverflowException),()=>CBORObject.Subtract(CBORObject.FromObject(Single.NaN),CBORObject.FromObject(BigInteger.Parse("3037587108614072",NumberStyles.AllowLeadingSign,CultureInfo.InvariantCulture))).AsDecimalFraction());
			Assert.Throws(typeof(OverflowException),()=>CBORObject.Subtract(CBORObject.FromObject(Single.NaN),CBORObject.FromObject(DecimalFraction.FromString("-21687"))).AsDecimalFraction());
			Assert.Throws(typeof(OverflowException),()=>CBORObject.Subtract(CBORObject.FromObject(Single.PositiveInfinity),CBORObject.FromObject(21.02954f)).AsDecimalFraction());
			Assert.Throws(typeof(OverflowException),()=>CBORObject.Subtract(CBORObject.FromObject(Single.PositiveInfinity),CBORObject.FromObject(-280.74258f)).AsDecimalFraction());
			Assert.Throws(typeof(OverflowException),()=>CBORObject.Subtract(CBORObject.FromObject(Single.PositiveInfinity),CBORObject.FromObject(3.295564645540288E-15d)).AsDecimalFraction());
			Assert.Throws(typeof(OverflowException),()=>CBORObject.Subtract(CBORObject.FromObject(Single.PositiveInfinity),CBORObject.FromObject(-1.8643148756498468E-14d)).AsDecimalFraction());
			Assert.Throws(typeof(OverflowException),()=>CBORObject.Subtract(CBORObject.FromObject(Single.PositiveInfinity),CBORObject.FromObject(DecimalFraction.FromString("56E-9"))).AsDecimalFraction());
			Assert.Throws(typeof(OverflowException),()=>CBORObject.Subtract(CBORObject.FromObject(Single.NegativeInfinity),CBORObject.FromObject(BigInteger.Parse("06842884252556766213171069781",NumberStyles.AllowLeadingSign,CultureInfo.InvariantCulture))).AsDecimalFraction());
			Assert.Throws(typeof(OverflowException),()=>CBORObject.Subtract(CBORObject.FromObject(Single.NegativeInfinity),CBORObject.FromObject(-6381263349646471084L)).AsDecimalFraction());
			Assert.Throws(typeof(OverflowException),()=>CBORObject.Subtract(CBORObject.FromObject(Single.NegativeInfinity),CBORObject.FromObject(9127378784365184230L)).AsDecimalFraction());
			Assert.Throws(typeof(OverflowException),()=>CBORObject.Subtract(CBORObject.FromObject(Single.NegativeInfinity),CBORObject.FromObject(BigInteger.Parse("300921783316",NumberStyles.AllowLeadingSign,CultureInfo.InvariantCulture))).AsDecimalFraction());
			Assert.Throws(typeof(OverflowException),()=>CBORObject.Subtract(CBORObject.FromObject(Single.NegativeInfinity),CBORObject.FromObject(BigInteger.Parse("-5806763724610384900094490266237212718",NumberStyles.AllowLeadingSign,CultureInfo.InvariantCulture))).AsDecimalFraction());
		}
	}
