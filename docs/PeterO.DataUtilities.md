...
* <code>[ToLowerCaseAscii(string)](#ToLowerCaseAscii_string)</code> - Returns a string with the basic uppercase letters A to Z (U+0041 to U+005A) converted to the corresponding basic lowercase letters.
* <code>[ToUpperCaseAscii(string)](#ToUpperCaseAscii_string)</code> - Returns a string with the basic lowercase letters A to Z (U+0061 to U+007A) converted to the corresponding basic uppercase letters.
