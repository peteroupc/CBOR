## PeterO.Cbor.CBORObject
 ...
 <b>To and from other objects:</b> The  `CBORObject.FromObject` CBORObject.FromObject method converts many kinds of objects to a CBOR object, including numbers, strings, and arrays and maps of numbers and strings. Methods like AsDouble, AsByte, and AsString convert a CBOR object to different types of object. The  `CBORObject.ToObject` CBORObject.ToObject method converts a CBOR object to an object of a given type; for example, a CBOR array to a native  `List` List (or  `ArrayList` ArrayList in Java), or a CBOR integer to an  `int` int or  `long` long .
 ...
 Another consideration is that two values that are otherwise equal may have different tags. To strip the tags from a CBOR object before comparing, use the  `Untag` Untag method.
...
### IsFalse
 ...
 `true` true If this value is a CBOR false value; otherwise, .  `false` false .
...
### IsFinite
 ...
 `true` true If this CBOR object represents a finite number; otherwise, .  `false` false .
...
### IsIntegral
 ...
 `true` true If this object represents an integer number, that is, a number without a fractional part; otherwise, .  `false` false .
...
### IsNegative
 ...
 `true` true If this object is a negative number; otherwise, .  `false` false .
...
### IsNull
 ...
 `true` true If this value is a CBOR null value; otherwise, .  `false` false .
...
### IsTagged
 ...
 `true` true If this data item has at least one tag; otherwise, .  `false` false .
...
### IsTrue
 ...
 `true` true If this value is a CBOR true value; otherwise, .  `false` false .
...
### IsUndefined
 ...
 `true` true If this value is a CBOR undefined value; otherwise, .  `false` false .
...
### IsZero
 ...
 `true` true If this object's value equals 0; otherwise, .  `false` false .
...
The CBOR object referred to by key in this map. Returns  `null` null if an item with the given key doesn't exist.
...
### Abs
 ...
 Gets this object's absolute value.  <b>Return Value:</b>
...
### Add
 ...
 NOTE: This method can't be used to add a tag to an existing CBOR object. To create a CBOR object with a given tag, call the  `CBORObject.FromObjectAndTag` CBORObject.FromObjectAndTag method and pass the CBOR object and the desired tag number to that method.
...
### Addition
 ...
 Finds the sum of two CBOR numbers.  <b>Parameters:</b>
...
### AsBoolean
 ...
 Returns false if this object is False, Null, or Undefined; otherwise,true.  <b>Return Value:</b>
...
### AsByte
 ...
 Converts this object to a byte (0 to 255). Floating point values are truncated to an integer.  <b>Return Value:</b>
...
### AsDecimal
 ...
 Converts this object to a .NET decimal.  <b>Return Value:</b>
...
### AsDouble
 ...
 Converts this object to a 64-bit floating point number.  <b>Return Value:</b>
...
### AsEDecimal
 ...
 Converts this object to a decimal number.  <b>Return Value:</b>
 ...
 * System.InvalidOperationException:
This object's type is not a number type, including if this object is CBORObject.Null. To check the CBOR object for null before conversion, use the following idiom (originally written in C# for the .NET version):  `(cbor == null || cbor.IsNull) ? null : cbor.AsEDecimal()` (cbor == null || cbor.IsNull) ? null : cbor.AsEDecimal() .
...
### AsEFloat
 ...
 Converts this object to an arbitrary-precision binary floating point number.  <b>Return Value:</b>
 ...
 * System.InvalidOperationException:
This object's type is not a number type, including if this object is CBORObject.Null. To check the CBOR object for null before conversion, use the following idiom (originally written in C# for the .NET version):  `(cbor == null || cbor.IsNull) ? null : cbor.AsEFloat()` (cbor == null || cbor.IsNull) ? null : cbor.AsEFloat() .
...
### AsEInteger
 ...
 Converts this object to an arbitrary-precision integer. Fractional values are truncated to an integer.  <b>Return Value:</b>
 ...
 * System.InvalidOperationException:
This object's type is not a number type, including if this object is CBORObject.Null. To check the CBOR object for null before conversion, use the following idiom (originally written in C# for the .NET version):  `(cbor == null || cbor.IsNull) ? null : cbor.AsEInteger()` (cbor == null || cbor.IsNull) ? null : cbor.AsEInteger() .
...
### AsERational
 ...
 Converts this object to a rational number.  <b>Return Value:</b>
 ...
 * System.InvalidOperationException:
This object's type is not a number type, including if this object is CBORObject.Null. To check the CBOR object for null before conversion, use the following idiom (originally written in C# for the .NET version):  `(cbor == null || cbor.IsNull) ? null : cbor.AsERational()` (cbor == null || cbor.IsNull) ? null : cbor.AsERational() .
...
### AsInt16
 ...
 Converts this object to a 16-bit signed integer. Floating point values are truncated to an integer.  <b>Return Value:</b>
...
CBORObject obj = CBORObject.FromInt32(99999); if(obj.IsIntegral && obj.CanTruncatedIntFitInInt32()) { // Not an Int32; handle the error Console.WriteLine("Not a 32-bit integer."); } else { Console.WriteLine("The value is " + obj.AsInt32()); }
...
CBORObject obj = CBORObject.FromInt64(99999); if(obj.IsIntegral && obj.CanTruncatedIntFitInInt64()) { // Not an Int64; handle the error Console.WriteLine("Not a 64-bit integer."); } else { Console.WriteLine("The value is " + obj.AsInt64()); }
...
### AsSByte
 ...
 Converts this object to an 8-bit signed integer.  <b>Return Value:</b>
...
### AsSingle
 ...
 Converts this object to a 32-bit floating point number.  <b>Return Value:</b>
...
### AsString
 ...
 Gets the value of this object as a text string.  <b>Return Value:</b>
 ...
 * System.InvalidOperationException:
This object's type is not a string, including if this object is CBORObject.Null. To check the CBOR object for null before conversion, use the following idiom (originally written in C# for the .NET version):  `(cbor == null || cbor.IsNull) ? null : cbor.AsString()` (cbor == null || cbor.IsNull) ? null : cbor.AsString() .
...
### AsUInt16
 ...
 Converts this object to a 16-bit unsigned integer. The return value will be truncated as necessary.  <b>Return Value:</b>
...
### AsUInt32
 ...
 Converts this object to a 32-bit unsigned integer. The return value will be truncated as necessary.  <b>Return Value:</b>
...
### AsUInt64
 ...
 Converts this object to a 64-bit unsigned integer. Non-integer values are truncated to an integer.  <b>Return Value:</b>
...
### CanFitInDouble
 ...
 Returns whether this object's value can be converted to a 64-bit floating point number without its value being rounded to another numerical value.  <b>Return Value:</b>
...
### CanFitInInt32
 ...
 Returns whether this object's numerical value is an integer, is -(2^31) or greater, and is less than 2^31.  <b>Return Value:</b>

 `true` true if this object's numerical value is an integer, is -(2^31) or greater, and is less than 2^31; otherwise,  `false` false .
...
### CanFitInInt64
 ...
 Returns whether this object's numerical value is an integer, is -(2^63) or greater, and is less than 2^63.  <b>Return Value:</b>

 `true` true if this object's numerical value is an integer, is -(2^63) or greater, and is less than 2^63; otherwise,  `false` false .
...
### CanFitInSingle
 ...
 Returns whether this object's value can be converted to a 32-bit floating point number without its value being rounded to another numerical value.  <b>Return Value:</b>
...
### CanTruncatedIntFitInInt32
 ...
 Returns whether this object's value, truncated to an integer, would be -(2^31) or greater, and less than 2^31.  <b>Return Value:</b>

 `true` true if this object's value, truncated to an integer, would be -(2^31) or greater, and less than 2^31; otherwise,  `false` false .
...
### CanTruncatedIntFitInInt64
 ...
 Returns whether this object's value, truncated to an integer, would be -(2^63) or greater, and less than 2^63.  <b>Return Value:</b>

 `true` true if this object's value, truncated to an integer, would be -(2^63) or greater, and less than 2^63; otherwise,  `false` false .
...
### Clear
 ...
 Removes all items from this CBOR array or all keys and values from this CBOR map.  <b>Exceptions:</b>
...
### CompareToIgnoreTags
 ...
 Compares this object and another CBOR object, ignoring the tags they have, if any. See the CompareTo method for more information on the comparison function.  <b>Parameters:</b>
...
### ContainsKey
 ...
 Determines whether a value of the given key exists in this object.  <b>Parameters:</b>
...
<b>Return Value:</b>
 ...
 `true` true if the given key is found, or false if the given key is not found or this object is not a map.
 ...
 * <i>key</i>: An object that serves as the key. If this is  `null` null , checks for  `CBORObject.Null` CBORObject.Null .
 ...
 * <i>key</i>: A string that serves as the key. If this is  `null` null , checks for  `CBORObject.Null` CBORObject.Null .

<b>Return Value:</b>

 `true` true if the given key (as a CBOR object) is found, or false if the given key is not found or this object is not a map.
...
### Divide
 ...
 Divides a CBORObject object by the value of a CBORObject object.  <b>Parameters:</b>
...
### Equals
 ...
 Determines whether this object and another object are equal and have the same type. Not-a-number values can be considered equal by this method.  <b>Parameters:</b>
...
### Equals
 ...
 Compares the equality of two CBOR objects. Not-a-number values can be considered equal by this method.  <b>Parameters:</b>
...
### FromJSONString
 ...
 Generates a CBOR object from a text string in JavaScript Object Notation (JSON) format, using the specified options to control the decoding process. Note that if a CBOR object is converted to JSON with  `ToJSONString` ToJSONString , then the JSON is converted back to CBOR with this method, the new CBOR object will not necessarily be the same as the old CBOR object, especially if the old CBOR object uses data types not supported in JSON, such as integers in map keys.
...
### FromObject
 ...
 Returns the CBOR true value or false value, depending on "value".  <b>Parameters:</b>
...
### FromObject
 ...
 Generates a CBOR object from a byte (0 to 255).  <b>Parameters:</b>
...
### FromObject
 ...
 The following example encodes a text string to a UTF-8 byte array, then uses the array to create a CBOR byte string object. It is not recommended to use  `Encoding.UTF8.GetBytes` Encoding.UTF8.GetBytes in .NET, or the  `getBytes()` getBytes() method in Java to do this. For instance,  `getBytes()` getBytes() encodes text strings in a default (so not fixed) character encoding, which can be undesirable. Instead, use the  `DataUtilities.GetUtf8Bytes` DataUtilities.GetUtf8Bytes method to convert text strings to UTF-8.
...
/* true does character replacement of invalid UTF-8; false throws an exception on invalid UTF-8 */ byte[] bytes = DataUtilities.GetUtf8Bytes( textString, true); CBORObject cbor = CBORObject.FromBytes(bytes);
...
### FromObject
 ...
 Generates a CBOR object from a 64-bit floating-point number.  <b>Parameters:</b>
...
### FromObject
 ...
 Generates a CBOR object from a 32-bit floating-point number.  <b>Parameters:</b>
...
### FromObject
 ...
 Generates a CBOR object from a 32-bit signed integer.  <b>Parameters:</b>
...
### FromObject
 ...
 Generates a CBOR object from an array of 32-bit integers.  <b>Parameters:</b>
...
### FromObject
 ...
 Generates a CBOR object from a 64-bit signed integer.  <b>Parameters:</b>
...
### FromObject
 ...
 Generates a CBOR object from an array of 64-bit integers.  <b>Parameters:</b>
...
### FromObject
 ...
 Generates a CBORObject from an arbitrary object. See the overload of this method that takes CBORTypeMapper and PODOptions arguments.  <b>Parameters:</b>

 * <i>obj</i>: The parameter  <i>obj</i>
 is an arbitrary object. <b>NOTE:</b> For security reasons, whenever possible, an application should not base this parameter on user input or other externally supplied data unless the application limits this parameter's inputs to types specially handled by this method (such as  `int` int or  `String` String ) and/or to plain-old-data types (POCO or POJO types) within the control of the application. If the plain-old-data type references other data types, those types should likewise meet either criterion above.
...
### FromObject
  ...
  *  `null` null is converted to  `CBORObject.Null` CBORObject.Null .

  * A  `CBORObject` CBORObject is returned as itself.
  ...
  * A  `char` char is converted to an integer (from 0 through 65535), and returns a CBOR object of that integer. (This is a change in version 4.0 from previous versions, which converted  `char` char , except surrogate code points from 0xd800 through 0xdfff, into single-character text strings.)

  * A  `bool` bool (  `boolean` boolean in Java) is converted to  `CBORObject.True` CBORObject.True or  `CBORObject.False` CBORObject.False .

  * A  `byte` byte is converted to a CBOR integer from 0 through 255.

  * A primitive integer type (  `int` int ,  `short` short ,  `long` long , as well as  `sbyte` sbyte ,  `ushort` ushort ,  `uint` uint , and  `ulong` ulong in .NET) is converted to the corresponding CBOR integer.

  * A primitive floating-point type (  `float` float ,  `double` double , as well as  `decimal` decimal in .NET) is converted to the corresponding CBOR number.

  * A  `String` String is converted to a CBOR text string. To create a CBOR byte string object from  `String` String , see the example given in **M:PeterO.Cbor.CBORObject.FromObject(System.Byte[])** .

  * A number of type  `EDecimal` EDecimal ,  `EFloat` EFloat ,  `EInteger` EInteger , and  `ERational` ERational in the <a href="https://www.nuget.org/packages/PeterO.Numbers">  `PeterO.Numbers` PeterO.Numbers </a> library (in .NET) or the <a href="https://github.com/peteroupc/numbers-java">  `com.github.peteroupc/numbers` com.github.peteroupc/numbers </a> artifact (in Java) is converted to the corresponding CBOR number.

  * An array other than  `byte[]` byte[] is converted to a CBOR array. In the .NET version, a multidimensional array is converted to an array of arrays.

  * A  `byte[]` byte[] (1-dimensional byte array) is converted to a CBOR byte string; the byte array is copied to a new byte array in this process. (This method can't be used to decode CBOR data from a byte array; for that, use the <b>DecodeFromBytes</b> method instead.)
  ...
  * An enumeration (  `Enum` Enum ) object is converted to its <i> underlying value </i> in the .NET version, or the result of its  `ordinal()` ordinal() method in the Java version.

  * An object of type  `DateTime` DateTime ,  `Uri` Uri , or  `Guid` Guid (  `Date` Date ,  `URI` URI , or  `UUID` UUID , respectively, in Java) will be converted to a tagged CBOR object of the appropriate kind.  `DateTime` DateTime /  `Date` Date will be converted to a tag-0 string following the date format used in the Atom syndication format.
  ...
  * Then, the method returns a CBOR map with each eligible getter's name or property name as each key, and with the corresponding value returned by that getter as that key's value. Before adding a key-value pair to the map, the key's name is adjusted according to the rules described in the [PeterO.Cbor.PODOptions](PeterO.Cbor.PODOptions.md) documentation. Note that for security reasons, certain types are not supported even if they contain eligible getters.
  ...
  <b>REMARK:</b> .NET enumeration (  `Enum` Enum ) constants could also have been converted to text strings with  `ToString()` ToString() , but that method will return multiple names if the given Enum object is a combination of Enum objects (e.g. if the object is  `FileAccess.Read | FileAccess.Write` FileAccess.Read | FileAccess.Write ). More generally, if Enums are converted to text strings, constants from Enum types with the  `Flags` Flags attribute, and constants from the same Enum type that share an underlying value, should not be passed to this method.
 ...
 * <i>obj</i>: An arbitrary object to convert to a CBOR object. <b>NOTE:</b> For security reasons, whenever possible, an application should not base this parameter on user input or other externally supplied data unless the application limits this parameter's inputs to types specially handled by this method (such as  `int` int or  `String` String ) and/or to plain-old-data types (POCO or POJO types) within the control of the application. If the plain-old-data type references other data types, those types should likewise meet either criterion above.
...
### FromObject
 ...
 Generates a CBOR object from a CBOR object.  <b>Parameters:</b>
...
### FromObject
 ...
 Generates a CBOR object from an array of CBOR objects.  <b>Parameters:</b>
...
### FromObject
 ...
 Generates a CBOR object from a decimal number.  <b>Parameters:</b>
...
### FromObject
 ...
 Generates a CBOR object from an arbitrary-precision binary floating-point number.  <b>Parameters:</b>
...
### FromObject
 ...
 Generates a CBOR object from an arbitrary-precision integer.  <b>Parameters:</b>
...
### FromObject
 ...
 Generates a CBOR object from a rational number.  <b>Parameters:</b>
...
### FromObject
 ...
 Converts a signed 8-bit integer to a CBOR object.  <b>Parameters:</b>
...
### FromObject
 ...
 Generates a CBOR object from a 16-bit signed integer.  <b>Parameters:</b>
...
### FromObject
 ...
 Generates a CBOR object from a text string.  <b>Parameters:</b>
...
### FromObject
 ...
 Converts a .NET decimal to a CBOR object.  <b>Parameters:</b>
...
### FromObject
 ...
 Converts a 32-bit unsigned integer to a CBOR object.  <b>Parameters:</b>
...
### FromObject
 ...
 Converts a 64-bit unsigned integer to a CBOR object.  <b>Parameters:</b>
...
### FromObject
 ...
 Converts a 16-bit unsigned integer to a CBOR object.  <b>Parameters:</b>
...
### FromObjectAndTag
 ...
 Generates a CBOR object from an arbitrary object and gives the resulting object a tag.  <b>Parameters:</b>
...
### FromSimpleValue
 ...
 Creates a CBOR object from a simple value number.  <b>Parameters:</b>
...
### GetAllTags
 ...
 Gets a list of all tags, from outermost to innermost.  <b>Return Value:</b>
...
### GetByteString
 ...
 Gets the backing byte array used in this CBOR object, if this object is a byte string, without copying the data to a new byte array. Any changes in the returned array's contents will be reflected in this CBOR object. Note, though, that the array's length can't be changed.  <b>Return Value:</b>
...
### GetOrDefault
 ...
 Gets the value of a CBOR object by integer index in this array or by CBOR object key in this map, or a default value if that value is not found.  <b>Parameters:</b>
...
### HasMostOuterTag
 ...
 Returns whether this object has an outermost tag and that tag is of the given number.  <b>Parameters:</b>

 * <i>tagValue</i>: The tag number.

<b>Return Value:</b>

 `true` true if this object has an outermost tag and that tag is of the given number; otherwise,  `false` false .
...
### HasTag
 ...
 Returns whether this object has a tag of the given number.  <b>Parameters:</b>

 * <i>tagValue</i>: The tag value to search for.

<b>Return Value:</b>

 `true` true if this object has a tag of the given number; otherwise,  `false` false .
...
### Insert
 ...
 Inserts an object at the specified position in this CBOR array.  <b>Parameters:</b>
...
### IsInfinity
 ...
 Gets a value indicating whether this CBOR object represents infinity.  <b>Return Value:</b>

 `true` true if this CBOR object represents infinity; otherwise,  `false` false .
...
### IsNaN
 ...
 Gets a value indicating whether this CBOR object represents a not-a-number value (as opposed to whether this object's type is not a number type).  <b>Return Value:</b>

 `true` true if this CBOR object represents a not-a-number value (as opposed to whether this object's type is not a number type); otherwise,  `false` false .
...
### IsNegativeInfinity
 ...
 Gets a value indicating whether this CBOR object represents negative infinity.  <b>Return Value:</b>

 `true` true if this CBOR object represents negative infinity; otherwise,  `false` false .
...
### IsPositiveInfinity
 ...
 Gets a value indicating whether this CBOR object represents positive infinity.  <b>Return Value:</b>

 `true` true if this CBOR object represents positive infinity; otherwise,  `false` false .
...
### Multiply
 ...
 Multiplies two CBOR numbers.  <b>Parameters:</b>
...
### Negate
 ...
 Gets this object's value with the sign reversed.  <b>Return Value:</b>
...
### NewArray
 ...
 Creates a new empty CBOR array.  <b>Return Value:</b>
...
### NewMap
 ...
 Creates a new empty CBOR map.  <b>Return Value:</b>
...
### Operator `+`
 ...
 Adds two CBOR objects and returns their result.  <b>Parameters:</b>
...
### Operator `%`
 ...
 Finds the remainder that results when a CBORObject object is divided by the value of a CBORObject object.  <b>Parameters:</b>
...
### Operator `*`
 ...
 Multiplies a CBORObject object by the value of a CBORObject object.  <b>Parameters:</b>
...
### Operator `-`
 ...
 Subtracts a CBORObject object from a CBORObject object.  <b>Parameters:</b>
...
### Read
 ...
 Reads an object in CBOR format from a data stream, using the specified options to control the decoding process. This method will read from the stream until the end of the CBOR object is reached or an error occurs, whichever happens first.  <b>Parameters:</b>
...
### Remove
 ...
 If this object is an array, removes the first instance of the specified item (once converted to a CBOR object) from the array. If this object is a map, removes the item with the given key (once converted to a CBOR object) from the map.  <b>Parameters:</b>

 * <i>obj</i>: The item or key (once converted to a CBOR object) to remove.

<b>Return Value:</b>

 `true` true if the item was removed; otherwise,  `false` false .
...
### Remove
 ...
 If this object is an array, removes the first instance of the specified item from the array. If this object is a map, removes the item with the given key from the map.  <b>Parameters:</b>
...
### RemoveAt
 ...
 Removes the item at the given index of this CBOR array.  <b>Parameters:</b>
...
The parameter  <i>key</i>
 ...
 is less than 0, is the size of this array or greater, or is not a 32-bit signed integer (  `int` int ).
...
### Subtract
 ...
 Finds the difference between two CBOR number objects.  <b>Parameters:</b>
...
### ToJSONString
  ...
  * If the CBOR object contains CBOR maps, or is a CBOR map itself, the keys to the map are written out to the JSON string in an undefined order. Map keys other than untagged text strings are converted to JSON strings before writing them out (for example,  `22("Test")` 22("Test") is converted to  `"Test"` "Test" and  `true` true is converted to  `"true"` "true" ). If, after such conversion, two or more map keys are identical, this method throws a CBORException.
 ...
 * <i>t</i>: The type, class, or interface that this method's return value will belong to. To express a generic type in Java, see the example. <b>Note:</b> For security reasons, an application should not base this parameter on user input or other externally supplied data. Whenever possible, this parameter should be either a type specially handled by this method (such as  `int` int or  `String` String ) or a plain-old-data type (POCO or POJO type) within the control of the application. If the plain-old-data type references other data types, those types should likewise meet either criterion above.
...
### ToObject
  ...
  * If the type is  `CBORObject` CBORObject , return this object.

  * If the given object is  `CBORObject.Null` CBORObject.Null (with or without tags), returns  `null` null .
  ...
  * If the type is  `object` object , return this object.

  * If the type is  `char` char , converts single-character CBOR text strings and CBOR integers from 0 through 65535 to a  `char` char object and returns that  `char` char object.

  * If the type is  `bool` bool (  `boolean` boolean in Java), returns the result of AsBoolean.

  * If the type is a primitive integer type (  `byte` byte ,  `int` int ,  `short` short ,  `long` long , as well as  `sbyte` sbyte ,  `ushort` ushort ,  `uint` uint , and  `ulong` ulong in .NET) or a primitive floating-point type (  `float` float ,  `double` double , as well as  `decimal` decimal in .NET), returns the result of the corresponding As* method.

  * If the type is  `String` String , returns the result of AsString.

  * If the type is  `EDecimal` EDecimal ,  `EFloat` EFloat ,  `EInteger` EInteger , or  `ERational` ERational in the <a href="https://www.nuget.org/packages/PeterO.Numbers">  `PeterO.Numbers` PeterO.Numbers </a> library (in .NET) or the <a href="https://github.com/peteroupc/numbers-java">  `com.github.peteroupc/numbers` com.github.peteroupc/numbers </a> artifact (in Java), returns the result of the corresponding As* method.

  * If the type is an enumeration (  `Enum` Enum ///) type this CBOR object is a text string or an integer, returns the appropriate enumerated constant. (For example, if  `MyEnum` MyEnum includes an entry for  `MyValue` MyValue , this method will return  `MyEnum.MyValue` MyEnum.MyValue if the CBOR object represents  `"MyValue"` "MyValue" or the underlying value for  `MyEnum.MyValue` MyEnum.MyValue .) <b>Note:</b> If an integer is converted to a .NET Enum constant, and that integer is shared by more than one constant of the same type, it is undefined which constant from among them is returned. (For example, if  `MyEnum.Zero = 0` MyEnum.Zero = 0 and  `MyEnum.Null = 0` MyEnum.Null = 0 , converting 0 to  `MyEnum` MyEnum may return either  `MyEnum.Zero` MyEnum.Zero or  `MyEnum.Null` MyEnum.Null .) As a result, .NET Enum types with constants that share an underlying value should not be passed to this method.

  * If the type is  `byte[]` byte[] (a one-dimensional byte array) and this CBOR object is a byte string, returns a byte array which this CBOR byte string's data will be copied to. (This method can't be used to encode CBOR data to a byte array; for that, use the EncodeToBytes method instead.)
  ...
  * both FromObject and ToObject will be better designed, in version 4.0, so that backward-compatible improvements are easier to make.
  ...
  Java offers no easy way to express a generic type, at least none as easy as C#'s  `typeof` typeof operator. The following example, written in Java, is a way to specify that the return value will be an ArrayList of String objects.
 ...
 * &lt;T&gt;: The type, class, or interface that this method's return value will belong to. <b>Note:</b> For security reasons, an application should not base this parameter on user input or other externally supplied data. Whenever possible, this parameter should be either a type specially handled by this method (such as  `int` int or  `String` String ) or a plain-old-data type (POCO or POJO type) within the control of the application. If the plain-old-data type references other data types, those types should likewise meet either criterion above.
...
### Untag
 ...
 Gets an object with the same value as this one but without the tags it has, if any. If this object is an array, map, or byte string, the data will not be copied to the returned object, so changes to the returned object will be reflected in this one.  <b>Return Value:</b>
...
### UntagOne
 ...
 Gets an object with the same value as this one but without this object's outermost tag, if any. If this object is an array, map, or byte string, the data will not be copied to the returned object, so changes to the returned object will be reflected in this one.  <b>Return Value:</b>
...
### Write
 ...
 Writes a Boolean value in CBOR format to a data stream.  <b>Parameters:</b>
...
### Write
 ...
 Writes a byte (0 to 255) in CBOR format to a data stream. If the value is less than 24, writes that byte. If the value is 25 to 255, writes the byte 24, then this byte's value.  <b>Parameters:</b>
...
### Write
 ...
 Writes a 64-bit floating-point number in CBOR format to a data stream.  <b>Parameters:</b>
...
### Write
 ...
 Writes a 32-bit floating-point number in CBOR format to a data stream.  <b>Parameters:</b>
...
### Write
 ...
 Writes a 32-bit signed integer in CBOR format to a data stream.  <b>Parameters:</b>
...
### Write
 ...
 Writes a 64-bit signed integer in CBOR format to a data stream.  <b>Parameters:</b>
...
### Write
 ...
 Writes a CBOR object to a CBOR data stream.  <b>Parameters:</b>
...
### Write
  ...
  * If the value is negative zero, infinity, or NaN, converts the number to a  `double` double and writes that  `double` double . If negative zero should not be written this way, use the Plus method to convert the value beforehand.
...
### Write
 ...
 Writes a big integer in CBOR format to a data stream.  <b>Parameters:</b>
...
### Write
 ...
 Writes a rational number in CBOR format to a data stream.  <b>Parameters:</b>
...
### Write
 ...
 Writes an 8-bit signed integer in CBOR format to a data stream.  <b>Parameters:</b>
...
### Write
 ...
 Writes a 16-bit signed integer in CBOR format to a data stream.  <b>Parameters:</b>
...
### Write
 ...
 Writes a string in CBOR format to a data stream, using the given options to control the encoding process.  <b>Parameters:</b>
...
### Write
 ...
 Writes a 32-bit unsigned integer in CBOR format to a data stream.  <b>Parameters:</b>
...
### Write
 ...
 Writes a 64-bit unsigned integer in CBOR format to a data stream.  <b>Parameters:</b>
...
### Write
 ...
 Writes a 16-bit unsigned integer in CBOR format to a data stream.  <b>Parameters:</b>
...
CBORObject.WriteValue(stream, 4, 3); /* array, length 3 */ CBORObject.Write("hello world", stream); /* item 1 */ CBORObject.Write(25, stream); /* item 2 */ CBORObject.Write(false, stream); // item 3 In the following example, a map consisting of two key-value pairs is written as CBOR to a data stream.
...
### WriteValue
 ...
 Writes a CBOR major type number and an integer 0 or greater associated with it to a data stream, where that integer is passed to this method as a 64-bit signed integer. This is a low-level method that is useful for implementing custom CBOR encoding methodologies. This method encodes the given major type and value in the shortest form allowed for the major type.  <b>Parameters:</b>
...
### WriteValue
 ...
 Writes a CBOR major type number and an integer 0 or greater associated with it to a data stream, where that integer is passed to this method as an arbitrary-precision integer. This is a low-level method that is useful for implementing custom CBOR encoding methodologies. This method encodes the given major type and value in the shortest form allowed for the major type.  <b>Parameters:</b>
...
### WriteValue
 ...
 Writes a CBOR major type number and an integer 0 or greater associated with it to a data stream, where that integer is passed to this method as a 32-bit unsigned integer. This is a low-level method that is useful for implementing custom CBOR encoding methodologies. This method encodes the given major type and value in the shortest form allowed for the major type.  <b>Parameters:</b>
...
### WriteValue
 ...
 Writes a CBOR major type number and an integer 0 or greater associated with it to a data stream, where that integer is passed to this method as a 64-bit unsigned integer. This is a low-level method that is useful for implementing custom CBOR encoding methodologies. This method encodes the given major type and value in the shortest form allowed for the major type.  <b>Parameters:</b>
