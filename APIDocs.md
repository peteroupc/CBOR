...
### GetSign
    ...
    public sealed int GetSign(
        PeterO.ExtendedDecimal value);
 ...
 * <i>value</i>: An ExtendedDecimal object.
...
### GetMantissa
    ...
    public sealed PeterO.BigInteger GetMantissa(
        PeterO.ExtendedDecimal value);
...
### GetExponent
    ...
    public sealed PeterO.BigInteger GetExponent(
        PeterO.ExtendedDecimal value);
...
### CreateShiftAccumulatorWithDigits

    public sealed PeterO.IShiftAccumulator CreateShiftAccumulatorWithDigits(
        PeterO.BigInteger bigint,
        int lastDigit,
        int olderDigits);
 ...
 * <i>lastDigit</i>: A 32-bit signed integer.

 * <i>olderDigits</i>: A 32-bit signed integer. (2).


<b>Returns:</b>

An IShiftAccumulator object.


### CreateShiftAccumulator

    public sealed PeterO.IShiftAccumulator CreateShiftAccumulator(
        PeterO.BigInteger bigint);
...
### HasTerminatingRadixExpansion

    public sealed bool HasTerminatingRadixExpansion(
...
### MultiplyByRadixPower

    public sealed PeterO.BigInteger MultiplyByRadixPower(
        PeterO.BigInteger bigint,
        PeterO.FastInteger power);
 ...
 * <i>bigint</i>: A BigInteger object. (2).

 * <i>power</i>: A FastInteger object.
...
### CreateNewWithFlags
    ...
    public sealed PeterO.ExtendedDecimal CreateNewWithFlags(
        PeterO.BigInteger mantissa,
        PeterO.BigInteger exponent,
        int flags);
 ...
 * <i>mantissa</i>: A BigInteger object.

 * <i>exponent</i>: A BigInteger object. (2).

 * <i>flags</i>: A 32-bit signed integer.
...
### GetArithmeticSupport

    public sealed int GetArithmeticSupport();
...
### ValueOf
    ...
    public sealed PeterO.ExtendedDecimal ValueOf(
        int val);
 ...
 * <i>val</i>: A 32-bit signed integer.
 ...
 * By calling the toString() method, which will always return distinct strings for distinct ExtendedFloat values. However, not all strings can be converted back to an ExtendedFloat without loss, especially if the string has a fractional part.
 ...
 * <i>value</i>: An ExtendedFloat object.
...
### HasTerminatingRadixExpansion
    ...
    public sealed bool HasTerminatingRadixExpansion(
        PeterO.BigInteger num,
        PeterO.BigInteger den);
 ...
 * <i>num</i>: A BigInteger object.

 * <i>den</i>: A BigInteger object. (2).
...
### CreateNewWithFlags
    ...
    public sealed PeterO.ExtendedFloat CreateNewWithFlags(
        PeterO.BigInteger mantissa,
        PeterO.BigInteger exponent,
        int flags);
...
### ValueOf
    ...
    public sealed PeterO.ExtendedFloat ValueOf(
        int val);
 ...
 * <i>thisValue</i>: A T object.

 * <i>divisor</i>: A T object. (2).
...
### CompareToWithContext
    ...
    public sealed T CompareToWithContext(
        T thisValue,
        T otherValue,
 ...
 * <i>otherValue</i>: A T object. (2).

 * <i>treatQuietNansAsSignaling</i>: A Boolean object.
...
### Multiply
    ...
    public PeterO.FastInteger Multiply(
        int val);
 ...
 * <i>val</i>: The integer to multiply by.
...
### Negate
    ...
    public PeterO.FastInteger Negate();
...
### Subtract
    ...
    public PeterO.FastInteger Subtract(
        PeterO.FastInteger val);
...
### SubtractInt
    ...
    public PeterO.FastInteger SubtractInt(
        int val);
...
### AddBig
    ...
    public PeterO.FastInteger AddBig(
        PeterO.BigInteger bigintVal);
 ...
 * <i>bigintVal</i>: The number to add.
...
### SubtractBig
    ...
    public PeterO.FastInteger SubtractBig(
        PeterO.BigInteger bigintVal);
...
### Remainder
    ...
    public PeterO.FastInteger Remainder(
        int divisor);


Sets this object's value to the remainder of the current value divided by the given integer.
...
### Divide
    ...
    public PeterO.FastInteger Divide(
        int divisor);
 ...
 * <i>divisor</i>: A 32-bit signed integer.
...
### AddInt
    ...
    public PeterO.FastInteger AddInt(
        int val);
...
True if this object's value is even; otherwise, false.
...
### Multiply
    ...
    public PeterO.MutableNumber Multiply(
        int multiplicand);
 ...
 * <i>multiplicand</i>: A 32-bit signed integer.
...
### SubtractInt
    ...
    public PeterO.MutableNumber SubtractInt(
        int other);
 ...
 * <i>other</i>: A 32-bit signed integer.
...
### Subtract
    ...
    public PeterO.MutableNumber Subtract(
        PeterO.MutableNumber other);
 ...
 * <i>other</i>: A MutableNumber object.
...
### Add
    ...
    public PeterO.MutableNumber Add(
        int augend);
 ...
 * <i>augend</i>: A 32-bit signed integer.
...
### DivideToExponent
    ...
    public sealed T DivideToExponent(
        T thisValue,
        T divisor,
        PeterO.BigInteger desiredExponent,
        PeterO.PrecisionContext ctx);
...
Initializes a new instance of the RedBlackTree class. Make an empty tree. Initialize to use DefaultIComparer for ordering.


### RedBlackTree Constructor

    public RedBlackTree(
        System.Collections.Generic.IComparer<T> c);


Initializes a new instance of the RedBlackTree class. Make an empty tree, using the supplied element comparator for ordering.


<b>Parameters:</b>

 * <i>c</i>: An IComparer object.
...
Implements collections.UpdatableCollection.clear. Time complexity: O(1). @see collections.UpdatableCollection#clear.
...
Implements collections.UpdatableCollection.take. Time complexity: O(log n). Takes the least element. @see collections.UpdatableCollection#take.
...
### AlwaysAdd
    ...
    public static PeterO.OccurrenceMode<T> AlwaysAdd = 0;


Always add the element even if it exists.


### AddIfMissing

    public static PeterO.OccurrenceMode<T> AddIfMissing = 1;


Add the element only if it exists.


### OverwriteIfExisting

    public static PeterO.OccurrenceMode<T> OverwriteIfExisting = 2;


Add the element and remove the existing element if any.
...
Initializes a new instance of the RBCell class. Make a new cell with given element, null links, and BLACK color. Normally only called to establish a new root.
...
### leftmost
    ...
    public PeterO.RBCell<T> leftmost();
...
### rightmost
    ...
    public PeterO.RBCell<T> rightmost();
...
### successor
    ...
    public PeterO.RBCell<T> successor();


Return the in-order successor, or null if no such.
...
### predecessor
    ...
    public PeterO.RBCell<T> predecessor();


Return the in-order predecessor, or null if no such.
...
### find
    ...
    public PeterO.RBCell<T> find(
        T element,
        System.Collections.Generic.IComparer<T> cmp);


Return node of current sub-tree containing element as element(), if it exists, else null. Uses IComparer  <i>cmp</i>
to find and to check equality.
...
Return number of nodes of current sub-tree containing element. Uses IComparer  <i>cmp</i>
 to find and to check equality.
