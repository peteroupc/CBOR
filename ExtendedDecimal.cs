...
namespace PeterO {
  ...
  public sealed class ExtendedDecimal : IComparable<ExtendedDecimal>, IEquatable<ExtendedDecimal> {
    ...
    /// <summary> </summary>
public BigInteger SignedMantissa{
    ...
    /// <summary> </summary>
    /// <param name='other'>A ExtendedDecimal object.</param>
    /// <returns></returns>
    ...
    /// <summary> </summary>
    /// <param name='value'>A ExtendedDecimal object.</param>
    /// <returns></returns>
    ...
    /// <returns></returns>
      public BigInteger RescaleByExponentDiff(BigInteger mantissa, BigInteger e1, BigInteger e2) {
        ...
        if (diff.CanFitInInt32()) {
          mantissa *= (BigInteger)(DecimalFraction.FindPowerOfTen(diff.AsInt32()));
        } else {
          mantissa *= (BigInteger)(DecimalFraction.FindPowerOfTenFromBig(diff.AsBigInteger()));
        }
        return mantissa;
      }
      ...
      public BigInteger MultiplyByRadixPower(BigInteger bigint, FastInteger power) {
        ...
        if(bigint.CompareTo(BigInteger.One)!=0){
          if (power.CanFitInInt32()) {
            bigint *= (BigInteger)(DecimalFraction.FindPowerOfTen(power.AsInt32()));
          } else {
            bigint *= (BigInteger)(DecimalFraction.FindPowerOfTenFromBig(power.AsBigInteger()));
          }
          return bigint;
        } else {
          if (power.CanFitInInt32()) {
...
public ExtendedDecimal ValueOf(int val){
    ...
    private string ToStringInternal(int mode) {
      ...
      if((this.flags&BigNumberFlags.FlagSignalingNaN)!=0){
        ...
        return negative ?
          "-sNaN"+BigInteger.Abs(this.mantissa).ToString() :
          "sNaN"+BigInteger.Abs(this.mantissa).ToString();
      }
      if((this.flags&BigNumberFlags.FlagQuietNaN)!=0){
        ...
        return negative ?
          "-NaN"+BigInteger.Abs(this.mantissa).ToString() :
          "NaN"+BigInteger.Abs(this.mantissa).ToString();
      }
      String mantissaString = BigInteger.Abs(this.mantissa).ToString();
...
public DecimalFraction ToDecimalFraction(){
      ...
      return new DecimalFraction(this.SignedMantissa,exponent);
    }
    ...
    public BigInteger ToBigInteger() {
      ...
      if (sign == 0) {
        BigInteger bigmantissa = this.SignedMantissa;
        return bigmantissa;
      } else if (sign > 0) {
        BigInteger bigmantissa = this.SignedMantissa;
        bigmantissa *= (BigInteger)(DecimalFraction.FindPowerOfTenFromBig(this.Exponent));
        return bigmantissa;
      } else {
        BigInteger bigmantissa = this.SignedMantissa;
        BigInteger bigexponent = this.Exponent;
        bigexponent = -bigexponent;
        bigmantissa /= (BigInteger)(DecimalFraction.FindPowerOfTenFromBig(bigexponent));
        return bigmantissa;
      }
    }
    ...
    public static ExtendedDecimal FromSingle(float flt) {
      ...
      if (fpExponent == 0) {
        ...
        BigInteger bigmantissa = (BigInteger)fpMantissa;
        bigmantissa *= (BigInteger)(DecimalFraction.FindPowerOfFive(-fpExponent));
        if (neg) bigmantissa = -(BigInteger)bigmantissa;
    ...
    public static ExtendedDecimal FromBigFloat(BigFloat bigfloat) {
      ...
      if (bigintExp.IsZero) {
        ...
        bigmantissa *= (BigInteger)(DecimalFraction.FindPowerOfFiveFromBig(negbigintExp));
...
public bool IsNegative{
    ...
    /// <summary> </summary>
    /// <param name='divisor'>A ExtendedDecimal object.</param>
    /// <returns></returns>
    ...
    /// the result.</summary>
    /// <param name='decfrac'>A ExtendedDecimal object.</param>
    ...
    /// <param name='otherValue'>A ExtendedDecimal object.</param>
    /// <param name='ctx'>A precision context object to control the precision
    /// and exponent range of the result. The rounding mode from this context
    /// is ignored. No flags will be set from this operation even if HasFlags
    /// of the context is true.</param>
    ...
    /// <param name='first'>A ExtendedDecimal object.</param>
    /// <param name='second'>A ExtendedDecimal object.</param>
    /// <param name='ctx'>A PrecisionContext object.</param>
...
public ExtendedDecimal CompareToSignal(
    ...
    /// <summary> </summary>
    /// <param name='op'>An ExtendedDecimal object.</param>
    /// <param name='augend'>An ExtendedDecimal object.</param>
    /// <param name='ctx'>A PrecisionContext object.</param>
    /// <returns></returns>
public ExtendedDecimal MultiplyAndSubtract(
      ExtendedDecimal op, ExtendedDecimal augend, PrecisionContext ctx) {
      if((augend)==null)throw new ArgumentNullException("decfrac");
