...
namespace PeterO {
  ...
  public class PrecisionContext {
    ...
    /// minimum and
    /// maximum exponent. If false, converted exponents can have any
    /// exponent and
    ...
    /// ignoring
    /// the decimal point and exponent. For example, if precision is 3, a
    /// converted
    ...
    /// Exponent
    /// property will not be higher than EMax + 1 - Precision. If a
    /// number&apos;s
    ...
    /// number&apos;s mantissa to account for the adjustment. If
    /// HasExponentRange is
    ...
    /// <summary>Signals that the result&apos;s exponent, before rounding,
    /// is lower
    /// than the lowest exponent allowed, and the result was rounded to a
    /// different
    ...
    /// according to this precision context. If HasFlags is false, this
    /// value will
    /// be 0. This value is a combination of bit fields. To retrieve a
    /// particular
...
int exponentMaxSmall) {
      if (exponentMinSmall > exponentMaxSmall) {
        throw new ArgumentException("exponentMinSmall (" +
          Convert.ToString(
(int)exponentMinSmall,
System.Globalization.CultureInfo.InvariantCulture) +
          ") is more than " + Convert.ToString((int)exponentMaxSmall,
          System.Globalization.CultureInfo.InvariantCulture));
      }
      PrecisionContext pc = this.Copy();
...
BigInteger exponentMax) {
    ...
    /// <summary>Copies this PrecisionContext with HasFlags set to false and
    /// a Flags
    /// value of 0.</summary>
    /// <returns>A PrecisionContext object.</returns>
...
System.Globalization.CultureInfo.InvariantCulture) +
    ...
    /// <summary>Precision context for the IEEE-754-2008 binary16 format, 11
    /// bits
    ...
    /// <summary>Precision context for the IEEE-754-2008 binary32 format, 24
    /// bits
    /// precision. The default rounding mode is HalfEven.</summary>
    #if CODE_ANALYSIS
    [System.Diagnostics.CodeAnalysis.SuppressMessage(
    ...
    /// <summary>Precision context for the IEEE-754-2008 binary64 format, 53
    /// bits
    /// precision. The default rounding mode is HalfEven.</summary>
    #if CODE_ANALYSIS
    [System.Diagnostics.CodeAnalysis.SuppressMessage(
